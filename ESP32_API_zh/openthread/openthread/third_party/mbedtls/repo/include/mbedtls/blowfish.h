...
#define MBEDTLS_ERR_BLOWFISH_BAD_INPUT_DATA -0x0016 /**<输入数据错误。*/

#define MBEDTLS_ERR_BLOWFISH_INVALID_INPUT_LENGTH -0x0018 /**<数据输入长度无效。*/

/* MBEDTLS_ERROR_BLOWFISH_HW_ACCEL_FAILED已弃用，不应使用。
 */
#define MBEDTLS_ERR_BLOWFISH_HW_ACCEL_FAILED                   -0x0017  /**<Blowfish硬件加速器失败。*/
