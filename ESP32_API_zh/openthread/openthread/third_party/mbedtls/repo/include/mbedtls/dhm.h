 ...
 * DHM错误代码
 */
#define MBEDTLS_ERR_DHM_BAD_INPUT_DATA                    -0x3080  /**<输入参数错误。*/
#define MBEDTLS_ERR_DHM_READ_PARAMS_FAILED                -0x3100  /**<读取DHM参数失败。*/
#define MBEDTLS_ERR_DHM_MAKE_PARAMS_FAILED                -0x3180  /**<生成DHM参数失败。*/
#define MBEDTLS_ERR_DHM_READ_PUBLIC_FAILED                -0x3200  /**<读取公共值失败。*/
#define MBEDTLS_ERR_DHM_MAKE_PUBLIC_FAILED                -0x3280  /**<生成公共值失败。*/
#define MBEDTLS_ERR_DHM_CALC_SECRET_FAILED                -0x3300  /**<DHM机密计算失败。*/
#define MBEDTLS_ERR_DHM_INVALID_FORMAT                    -0x3380  /**<ASN.1数据格式不正确。*/
#define MBEDTLS_ERR_DHM_ALLOC_FAILED                      -0x3400  /**<内存分配失败。*/
#define MBEDTLS_ERR_DHM_FILE_IO_ERROR                     -0x3480  /**<读取或写入文件失败。*/

/* MBEDTLS_ERROR_DHM_HW_ACCEL_FAILED已弃用，不应使用。*/
#define MBEDTLS_ERR_DHM_HW_ACCEL_FAILED                   -0x3500  /**<DHM硬件加速器失败。*/

#define MBEDTLS_ERR_DHM_SET_GROUP_FAILED                  -0x3580  /**<设置模数和生成器失败。*/
