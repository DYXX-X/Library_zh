...
#define MBEDTLS_ERR_CAMELLIA_BAD_INPUT_DATA -0x0024 /**<输入数据错误。*/

#define MBEDTLS_ERR_CAMELLIA_INVALID_INPUT_LENGTH -0x0026 /**<数据输入长度无效。*/

/* MBEDTLS_ERROR_CAMELLIA_WW_ACCEL_FAILED已弃用，不应使用。
 */
#define MBEDTLS_ERR_CAMELLIA_HW_ACCEL_FAILED              -0x0027  /**＜Camellia硬件加速器失败。*/
