...
#define MBEDTLS_ERR_THREADING_FEATURE_UNAVAILABLE         -0x001A  /**<所选功能不可用。*/

#define MBEDTLS_ERR_THREADING_BAD_INPUT_DATA              -0x001C  /**<功能输入参数错误。*/
#define MBEDTLS_ERR_THREADING_MUTEX_ERROR                 -0x001E  /**<锁定/解锁/释放失败，错误代码为。*/
