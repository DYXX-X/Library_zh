...
#define MBEDTLS_ERR_CHACHA20_BAD_INPUT_DATA         -0x0051 /**<输入参数无效。*/

/* MBEDTLS_ERROR_CHACHA20_FEATURE_NAVAILABLE已弃用，不应使用。*/
#define MBEDTLS_ERR_CHACHA20_FEATURE_UNAVAILABLE    -0x0053 /**<功能不可用。例如，API的s部分未实现。*/

/* MBEDTLS_ERROR_CHACHA20_HW_ACCEL_FAILED已弃用，不应使用。
 */
#define MBEDTLS_ERR_CHACHA20_HW_ACCEL_FAILED        -0x0055  /**<Chacha20硬件加速器失败。*/
