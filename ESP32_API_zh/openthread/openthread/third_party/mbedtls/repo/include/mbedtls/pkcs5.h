...
#define MBEDTLS_ERR_PKCS5_BAD_INPUT_DATA                  -0x2f80  /**<功能输入参数错误。*/
#define MBEDTLS_ERR_PKCS5_INVALID_FORMAT                  -0x2f00  /**<意外ASN.1数据。*/
#define MBEDTLS_ERR_PKCS5_FEATURE_UNAVAILABLE             -0x2e80  /**<请求的加密或摘要alg不可用。*/
#define MBEDTLS_ERR_PKCS5_PASSWORD_MISMATCH               -0x2e00  /**<给定的私钥密码不允许正确解密。*/
