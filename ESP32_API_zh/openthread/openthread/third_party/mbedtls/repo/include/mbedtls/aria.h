...
#define MBEDTLS_ERR_ARIA_BAD_INPUT_DATA -0x005C /**<输入数据错误。*/

#define MBEDTLS_ERR_ARIA_INVALID_INPUT_LENGTH -0x005E /**<数据输入长度无效。*/

/* MBEDTLS_ERROR_ARIA_FEATURE_NAVAILABLE已弃用，不应使用。
 */
#define MBEDTLS_ERR_ARIA_FEATURE_UNAVAILABLE  -0x005A  /**<功能不可用。例如，不支持的ARIA密钥大小。*/

/* MBEDTLS_ERROR_ARIA_HW_ACCEL_FAILED已弃用，不应使用。*/
#define MBEDTLS_ERR_ARIA_HW_ACCEL_FAILED      -0x0058  /**<ARIA硬件加速器失败。*/
