...
#define MBEDTLS_ERR_ENTROPY_SOURCE_FAILED                 -0x003C  /**<临界熵源故障。*/
#define MBEDTLS_ERR_ENTROPY_MAX_SOURCES                   -0x003E  /**<无法添加更多源。*/
#define MBEDTLS_ERR_ENTROPY_NO_SOURCES_DEFINED            -0x0040  /**<未向投票添加任何来源。*/
#define MBEDTLS_ERR_ENTROPY_NO_STRONG_SOURCE              -0x003D  /**<未向投票中添加有力的来源。*/
#define MBEDTLS_ERR_ENTROPY_FILE_IO_ERROR                 -0x003F  /**<文件中的读/写错误。*/
