...
#define MBEDTLS_ERR_CCM_BAD_INPUT       -0x000D /**<函数的输入参数错误。*/
#define MBEDTLS_ERR_CCM_AUTH_FAILED     -0x000F /**<经过身份验证的解密失败。*/

/* MBEDTLS_ERROR_CCM_HW_ACCEL_FAILED已弃用，不应使用。*/
#define MBEDTLS_ERR_CCM_HW_ACCEL_FAILED -0x0011 /**<CCM硬件加速器失败。*/
