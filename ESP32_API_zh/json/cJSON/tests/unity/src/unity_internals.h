...
/* 如果尚未指定，请确定int的大小。我们不能使用sizeof（int），因为它在C程序的翻译阶段还没有定义。因此，如果可能，请从UINT_MAX推断它。*/
...
#endif
#else
/* 我们已经将flush定义为其他东西，因此请确保在此处声明它，以便它可以使用*/
...
#   if defined(__GNUC__) || defined(__ghs__) /* __GNUC__包括叮当声*/
