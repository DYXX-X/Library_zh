...
struct bt_mesh_light_lc_state {
    uint32_t mode : 1,              /* 默认值0*/
             occupancy_mode : 1,    /* 默认值1*/
             light_onoff : 1,
...
struct bt_mesh_light_lc_property_state {
    uint32_t time_occupancy_delay;         /* 0x003A号*/
    uint32_t time_fade_on;                 /* 0x0037位*/
    uint32_t time_run_on;                  /* 0x003C号*/
    uint32_t time_fade;                    /* 0x0036位*/
    uint32_t time_prolong;                 /* 0x003B（字节）*/
    uint32_t time_fade_standby_auto;       /* 2008年*/
    uint32_t time_fade_standby_manual;     /* 0x0039位*/

    uint16_t lightness_on;                 /* 0x002E*/
    uint16_t lightness_prolong;            /* 0x002F*/
    uint16_t lightness_standby;            /* 0x0030位*/
    ...
    float    regulator_kiu;                /* 0x0033，0.0~1000.0，默认值250.0*/
    float    regulator_kid;                /* 0x0032，0.0~1000.0，默认值25.0*/
    float    regulator_kpu;                /* 0x0035，0.0~1000.0，默认值80.0*/
    float    regulator_kpd;                /* 0x0034，0.0~1000.0，默认值80.0*/
    int8_t   regulator_accuracy;           /* 0x0031，0.0~100.0，默认值2.0*/
