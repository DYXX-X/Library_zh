...
BOOLEAN btsnd_hcic_auth_request (UINT16 handle);     /* 身份验证请求*/
...
BOOLEAN btsnd_hcic_rmt_features_req(UINT16 handle);      /* 远程功能请求*/
...
BOOLEAN btsnd_hcic_rmt_ver_req(UINT16 handle);           /* 远程版本信息请求*/
BOOLEAN btsnd_hcic_read_rmt_clk_offset(UINT16 handle);   /* 远程时钟偏移*/
BOOLEAN btsnd_hcic_read_lmp_handle(UINT16 handle);       /* 远程LMP手柄*/
...
BOOLEAN btsnd_hcic_exit_sniff_mode(UINT16 handle);       /* 退出嗅探模式*/
...
BOOLEAN btsnd_hcic_exit_park_mode(UINT16 handle);  /* 退出驻车模式*/
...
BOOLEAN btsnd_hcic_write_pin_type(UINT8 type);                   /* 写入PIN类型*/
BOOLEAN btsnd_hcic_write_auto_accept(UINT8 flag);                /* 写入自动接受*/
BOOLEAN btsnd_hcic_read_name (void);                             /* 读取本地名称*/
BOOLEAN btsnd_hcic_write_page_tout(UINT16 timeout);              /* 写入页面超时*/
BOOLEAN btsnd_hcic_write_scan_enable(UINT8 flag);                /* 写入扫描启用*/
BOOLEAN btsnd_hcic_write_pagescan_cfg(UINT16 interval,
                                      UINT16 window);            /* 写入页面扫描活动*/
...
BOOLEAN btsnd_hcic_write_auth_enable(UINT8 flag);                 /* 写入身份验证启用*/
BOOLEAN btsnd_hcic_write_dev_class(DEV_CLASS dev);                /* 写入设备类别*/
BOOLEAN btsnd_hcic_write_voice_settings(UINT16 flags);            /* 写入语音设置*/
...
BOOLEAN btsnd_hcic_read_tx_power(UINT16 handle, UINT8 type);     /* 读取Tx功率*/
...
BOOLEAN btsnd_hcic_get_link_quality (UINT16 handle);            /* 获取链接质量*/
BOOLEAN btsnd_hcic_read_rssi (UINT16 handle);                   /* 读取RSSI*/
BOOLEAN btsnd_hcic_enable_test_mode (void);                     /* 启用测试模式下的设备*/
BOOLEAN btsnd_hcic_write_pagescan_type(UINT8 type);             /* 写入页面扫描类型*/
BOOLEAN btsnd_hcic_write_inqscan_type(UINT8 type);              /* 写入查询扫描类型*/
BOOLEAN btsnd_hcic_write_inquiry_mode(UINT8 type);              /* 写入查询模式*/
...
/********************************************************************************
** BLE命令注意：“local_controller_id”用于传输，不计入HCI消息大小
*********************************************************************************/
