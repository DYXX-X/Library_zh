...
#define  ATTR_ID_IP_SUBNET                      0x0200 /* PAN配置文件（***）*/
...
#define  ATTR_ID_IMG_SUPPORTED_CAPABILITIES     0x0310 /* 成像配置文件*/
#define  ATTR_ID_SUPPORTED_FEATURES             0x0311 /* HFP, BIP */
#define  ATTR_ID_IMG_SUPPORTED_FUNCTIONS        0x0312 /* 成像配置文件*/
#define  ATTR_ID_IMG_TOT_DATA_CAPABILITY        0x0313 /* 成像配置文件*/
#define  ATTR_ID_SUPPORTED_REPOSITORIES         0x0314 /* 电话簿访问配置文件*/
#define  ATTR_ID_MAS_INSTANCE_ID                0x0315 /* MAP配置文件*/
#define  ATTR_ID_SUPPORTED_MSG_TYPE             0x0316 /* MAP配置文件*/
#define  ATTR_ID_MAP_SUPPORTED_FEATURES         0x0317 /* MAP配置文件*/
#define  ATTR_ID_PBAP_SUPPORTED_FEATURES        0x0317 /* PBAP配置文件*/
...
#define ATTR_ID_RUI_REF_PRINTING_SUPPORTED      0x0370  /* 布尔型*/
#define ATTR_ID_RUI_DIRECT_PRINTING_SUPPORTED   0x0372  /* 布尔型*/
...
/* 这些值用于HDP配置文件*/
#define  ATTR_ID_HDP_SUP_FEAT_LIST          0x0200  /* 支持的功能列表*/
#define  ATTR_ID_HDP_DATA_EXCH_SPEC         0x0301  /* 数据交换规范*/
#define  ATTR_ID_HDP_MCAP_SUP_PROC          0x0302  /* MCAP支持的程序*/
...
#define UUID_SERVCLASS_AV_REM_CTRL_TARGET       0X110C  /* 音频/视频控制配置文件*/
#define UUID_SERVCLASS_ADV_AUDIO_DISTRIBUTION   0X110D  /* 高级音频分发配置文件*/
#define UUID_SERVCLASS_AV_REMOTE_CONTROL        0X110E  /* 音频/视频控制配置文件*/
#define UUID_SERVCLASS_AV_REM_CTRL_CONTROL      0X110F  /* 音频/视频控制配置文件*/
...
#define UUID_SERVCLASS_PANU                     0X1115  /* PAN配置文件*/
#define UUID_SERVCLASS_NAP                      0X1116  /* PAN配置文件*/
#define UUID_SERVCLASS_GN                       0X1117  /* PAN配置文件*/
#define UUID_SERVCLASS_DIRECT_PRINTING          0X1118  /* BPP配置文件*/
#define UUID_SERVCLASS_REFERENCE_PRINTING       0X1119  /* BPP配置文件*/
#define UUID_SERVCLASS_IMAGING                  0X111A  /* 成像配置文件*/
#define UUID_SERVCLASS_IMAGING_RESPONDER        0X111B  /* 成像配置文件*/
#define UUID_SERVCLASS_IMAGING_AUTO_ARCHIVE     0X111C  /* 成像配置文件*/
#define UUID_SERVCLASS_IMAGING_REF_OBJECTS      0X111D  /* 成像配置文件*/
#define UUID_SERVCLASS_HF_HANDSFREE             0X111E  /* 免提模式*/
#define UUID_SERVCLASS_AG_HANDSFREE             0X111F  /* 免提模式*/
#define UUID_SERVCLASS_DIR_PRT_REF_OBJ_SERVICE  0X1120  /* BPP配置文件*/
#define UUID_SERVCLASS_REFLECTED_UI             0X1121  /* BPP配置文件*/
#define UUID_SERVCLASS_BASIC_PRINTING           0X1122  /* BPP配置文件*/
#define UUID_SERVCLASS_PRINTING_STATUS          0X1123  /* BPP配置文件*/
#define UUID_SERVCLASS_HUMAN_INTERFACE          0X1124  /* HID配置文件*/
#define UUID_SERVCLASS_CABLE_REPLACEMENT        0X1125  /* HCRP配置文件*/
#define UUID_SERVCLASS_HCRP_PRINT               0X1126  /* HCRP配置文件*/
#define UUID_SERVCLASS_HCRP_SCAN                0X1127  /* HCRP配置文件*/
#define UUID_SERVCLASS_COMMON_ISDN_ACCESS       0X1128  /* CAPI消息传输协议*/
#define UUID_SERVCLASS_VIDEO_CONFERENCING_GW    0X1129  /* 视频会议配置文件*/
#define UUID_SERVCLASS_UDI_MT                   0X112A  /* 无限制数字信息配置文件*/
#define UUID_SERVCLASS_UDI_TA                   0X112B  /* 无限制数字信息配置文件*/
#define UUID_SERVCLASS_VCP                      0X112C  /* 视频会议配置文件*/
#define UUID_SERVCLASS_SAP                      0X112D  /* SIM卡接入模式*/
#define UUID_SERVCLASS_PBAP_PCE                 0X112E  /* 电话簿访问-PCE*/
#define UUID_SERVCLASS_PBAP_PSE                 0X112F  /* 电话簿访问-PSE*/
#define UUID_SERVCLASS_PHONE_ACCESS             0x1130
#define UUID_SERVCLASS_HEADSET_HS               0x1131  /* 耳机-HS，来自HSP v1.2*/
#define UUID_SERVCLASS_PNP_INFORMATION          0X1200  /* 设备标识*/
...
#define UUID_SERVCLASS_UPNP_SERVICE             0X1205  /* UPNP_服务[ESDP]*/
#define UUID_SERVCLASS_UPNP_IP_SERVICE          0X1206  /* UPNP_IP_服务[ESDP]*/
...
#define UUID_SERVCLASS_VIDEO_SOURCE             0X1303  /* 视频分发配置文件（VDP）*/
#define UUID_SERVCLASS_VIDEO_SINK               0X1304  /* 视频分发配置文件（VDP）*/
#define UUID_SERVCLASS_VIDEO_DISTRIBUTION       0X1305  /* 视频分发配置文件（VDP）*/
#define UUID_SERVCLASS_HDP_PROFILE              0X1400  /* 健康设备配置文件（HDP）*/
#define UUID_SERVCLASS_HDP_SOURCE               0X1401  /* 健康设备配置文件（HDP）*/
#define UUID_SERVCLASS_HDP_SINK                 0X1402  /* 健康设备配置文件（HDP）*/
#define UUID_SERVCLASS_MAP_PROFILE              0X1134  /* MAP配置文件UUID*/
#define UUID_SERVCLASS_MESSAGE_ACCESS           0X1132  /* 消息访问服务UUID*/
#define UUID_SERVCLASS_MESSAGE_NOTIFICATION     0X1133  /* 消息通知服务UUID*/

#define UUID_SERVCLASS_GAP_SERVER               0x1800
#define UUID_SERVCLASS_GATT_SERVER              0x1801
#define UUID_SERVCLASS_IMMEDIATE_ALERT          0x1802      /* 即时警报*/
#define UUID_SERVCLASS_LINKLOSS                 0x1803      /* 链路丢失警报*/
#define UUID_SERVCLASS_TX_POWER                 0x1804      /* TX功率*/
#define UUID_SERVCLASS_CURRENT_TIME             0x1805      /* 链路丢失警报*/
#define UUID_SERVCLASS_DST_CHG                  0x1806      /* DST时间变化*/
#define UUID_SERVCLASS_REF_TIME_UPD             0x1807      /* 参考时间更新*/
#define UUID_SERVCLASS_THERMOMETER              0x1809      /* 温度计UUID*/
#define UUID_SERVCLASS_DEVICE_INFO              0x180A      /* 设备信息服务*/
#define UUID_SERVCLASS_NWA                      0x180B      /* 网络可用性*/
#define UUID_SERVCLASS_HEART_RATE               0x180D      /* 心率服务*/
#define UUID_SERVCLASS_PHALERT                  0x180E      /* 电话提醒服务*/
#define UUID_SERVCLASS_BATTERY                  0x180F     /* 电池服务*/
#define UUID_SERVCLASS_BPM                      0x1810      /*  血压服务*/
#define UUID_SERVCLASS_ALERT_NOTIFICATION       0x1811      /* 警报通知服务*/
#define UUID_SERVCLASS_LE_HID                   0x1812     /*  LE上的HID*/
#define UUID_SERVCLASS_SCAN_PARAM               0x1813      /* 扫描参数服务*/
#define UUID_SERVCLASS_GLUCOSE                  0x1808      /* 血糖仪服务*/
#define UUID_SERVCLASS_RSC                      0x1814      /* RUNNERS SPEED AND CADENCE SERVICE      */
#define UUID_SERVCLASS_CSC                      0x1816      /* 自行车速度和CADENCE服务*/

#define UUID_SERVCLASS_TEST_SERVER              0x9000      /* 测试组UUID*/

#if (BTM_WBS_INCLUDED == TRUE)
#define UUID_CODEC_CVSD                         0x0001   /* CVSD */
#define UUID_CODEC_MSBC                         0x0002   /* 毫秒BC*/
#endif
...
/* 语言编码常量*/
#define LANG_ID_CODE_ENGLISH            ((UINT16) 0x656e)   /* “恩”*/
#define LANG_ID_CHAR_ENCODE_UTF8        ((UINT16) 0x006a)   /* UTF-8 */

/* 常量仅用于显示目的。这些定义了移动属性值*/
