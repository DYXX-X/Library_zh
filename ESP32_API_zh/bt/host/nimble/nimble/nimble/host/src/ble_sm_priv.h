...
/**
 * |参数|大小（八位字节）|+-------------------------------+-------------------+|（代码=0x01/0x02[req/rsp]）|1||IO能力|1||OOB数据标志|1||AuthReq|1||最大加密密钥大小|1||发起方密钥分布|1||响应方密钥分布|1|
 */
...
/**
 * |参数|大小（八位字节）|+-------------------------------+-------------------+|（代码=0x07）|1||EDIV|2||RAND|8|
 */
...
/**
 * |参数|大小（八位字节）|+-------------------------------+-------------------+|（代码=0x09）|1||addr_type|1||address|6|
 */
...
/**
 * |参数|大小（八位字节）|+-------------------------------+-------------------+|（代码=0x0B）|1||authreq|1|
 */
...
/**
 * |参数|大小（八位字节）|+-------------------------------+-------------------+|（代码=0x0c）|1||公钥X|32||公钥Y|32|
 */
...
/**
 * |参数|大小（八位字节）|+-------------------------------+-------------------+|（代码=0x0d）|1||DHKey检查|16|
 */
...
struct ble_sm_keys {
    ...
    uint8_t addr_type;
    uint8_t key_size;
    uint8_t ltk[16];    /* 小endian。*/
    uint8_t irk[16];    /* 小endian。*/
    uint8_t csrk[16];   /* 小endian。*/
    uint8_t addr[6];    /* 小endian。*/
};
