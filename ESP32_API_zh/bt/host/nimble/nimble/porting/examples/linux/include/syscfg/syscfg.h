...
/* 被@apachemynewt-aging/targets/linux覆盖（由@apacheMynewt-core/sys/log/stub定义）*/
...
/* 被@apachemynewt-aging/targets/linux覆盖（由@apacheMynewt aging/taging/transport/socket定义）*/
