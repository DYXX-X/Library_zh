...
/* 被@apachemynewt-aging/targets/linux-blemesh覆盖（由@apacheMynewt-core/kernel/os定义）*/
...
/* 被@apachemynewt-aging/targets/linux-blemesh覆盖（由@apacheMynewt-core/sys/log/stub定义）*/
...
/* 被@apachemynewt agility/targets/linux_blemesh覆盖（由@apacheMynewt agiel/agility/host定义）*/
...
/* 被@apachemynewt aging/animic/host覆盖（由@apacheMynewt agick/animic/host定义）*/
...
/* 被@apachemynewt agility/targets/linux_blemesh覆盖（由@apacheMynewt agiel/agility/host/mesh定义）*/
...
/* 被@apachemynewt aging/animal/host/mesh覆盖（由@apacheMynewt agick/animal/host/mesh定义）*/
...
/* 从BLE_SVC_DIS_DEFAULT_READ_PERM复制的值*/
...
/* 被@apachemynewt agility/targets/linux_blemesh覆盖（由@apacheMynewt agiel/agility/transport/socket定义）*/
