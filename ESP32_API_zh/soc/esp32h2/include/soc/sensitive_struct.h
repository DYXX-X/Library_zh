...
typedef volatile struct sensitive_dev_s {
    ...
    union {
        struct {
            ...
            uint32_t reg_core_0_pif_pms_constrain_world_0_etm:    2;  /*core_0_pif_pms_constrat_world_0_system*/
            uint32_t reg_core_0_pif_pms_constrain_world_0_timergroup3:    2;  /*core_0_pif_pms_constration_world_0_敏感*/
