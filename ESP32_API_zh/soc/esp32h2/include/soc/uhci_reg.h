...
/* UHCI_UART_RX_BRK_of_EN:R/W；位位置：[12]；默认值：1’b0；*/
/*描述：如果该位设置为1，则当UART接收到NULL帧时，UHCI将结束有效载荷接收过程。*/
...
/* UHCI_CLK_EN:R/W；位位置：[11]；默认值：1’b0；*/
/*description:1‘b1：强制打开寄存器时钟。1’b0：仅当应用程序写入寄存器时才支持时钟。*/
#define UHCI_CLK_EN  (BIT(11))
#define UHCI_CLK_EN_M  (BIT(11))
#define UHCI_CLK_EN_V  0x1
#define UHCI_CLK_EN_S  11
/* UHCI_ENCODE_CRC_EN:R/W；位位置：[10]；默认值：1’b1；*/
/*description:设置此位以通过在有效负载末尾附加16位CCITT-CRC来启用数据完整性检查。*/
...
/* UHCI_LEN_EOF_EN:R/W；位位置：[9]；默认值：1’b1；*/
/*描述：如果该位设置为1，则当接收字节计数达到指定值时，UHCI解码器接收有效载荷数据结束。当UHCI_HEAD_EN为1时，该值是由UHCI数据包报头指示的有效载荷长度，当UHCI_LEAD_EN是0时，该数值是配置值。如果该位设置为0，则当接收到0xc0时，UHCI解码器接收有效载荷数据结束。*/
#define UHCI_LEN_EOF_EN  (BIT(9))
#define UHCI_LEN_EOF_EN_M  (BIT(9))
#define UHCI_LEN_EOF_EN_V  0x1
#define UHCI_LEN_EOF_EN_S  9
/* UHCI_UART_IDLE_EOF_EN:R/W；位位置：[8]；默认值：1’b0；*/
/*描述：如果此位设置为1，则当UART处于空闲状态时，UHCI将结束有效负载接收过程。*/
...
/* UHCI_APP_ctrl_INT_RAW:R/W；位位置：[8]；默认值：1’b0；*/
/*description:软控制int原始位。*/
...
/* UHCI_APP_CTRL0_INT_RAW:R/W；位位置：[7]；默认值：1’b0；*/
/*description:软控制int原始位。*/
...
/* UHCI_OUTLINK_EOF_ERR_INT_RAW:R/WTC/SS；位位置：[6]；默认值：1’b0；*/
/*description:这是中断原始位。当EOF中存在一些错误时触发*/
...
/* UHCI_SEND_A_Q_INT_RAW:R/WTC/SS；位位置：[5]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SEND_S_Q_INT_RAW:R/WTC/SS；位位置：[4]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_TX_HUNG_INT_RAW:R/WTC/SS；位位置：[3]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_RX_HUNG_INT_RAW:R/WTC/SS；位位置：[2]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_TX_START_INT_RAW:R/WTC/SS；位位置：[1]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_RX_START_INT_RAW:R/WTC/SS；位位置：[0]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_APP_ctrl_INT_ST:RO；位位置：[8]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_APP_CTRL0_INT_ST:RO；位位置：[7]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_OUTLINK_EOF_ERR_INT_ST:RO；位位置：[6]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SEND_A_Q_INT_ST:RO；位位置：[5]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SEND_S_Q_INT_ST:RO；位位置：[4]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_APP_ctrl_INT_ENA:R/W；位位置：[8]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_APP_CTRL0_INT_ENA:R/W；位位置：[7]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_OUTLINK_EOF_ERR_INT_ENA:R/W；位位置：[6]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SEND_A_Q_INT_ENA:R/W；位位置：[5]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SEND_S_Q_INT_ENA:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_APP_CTRL1_INT_CLR:WT；位位置：[8]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_APP_CTRL0_INT_CLR:WT；位位置：[7]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_OUTLINK_EOF_ERR_INT_CLR:WT；位位置：[6]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SEND_A_Q_INT_CLR:WT；位位置：[5]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SEND_S_Q_INT_CLR:WT；位位置：[4]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_TX_HUNG_INT_CLR:WT；位位置：[3]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_RX_HUNG_INT_CLR:WT；位位置：[2]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_TX_START_INT_CLR:WT；位位置：[1]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_RX_START_INT_CLR:WT；位位置：[0]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_SW_START:R/W/SC；位位置：[8]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_DECODE_STATE:RO；比特位置：[5:3]；默认值：3'b0；*/
/*描述：a*/
...
/* UHCI_RX_ERR_CAUSE:RO；位位置：[2:0]；默认值：3'b0；*/
/*描述：a*/
...
/* UHCI_ENCODE_STATE:RO；位位置：[2:0]；默认值：3'b0；*/
/*描述：a*/
...
/* UHCI_SINGLE_SEND_EN:R/W/SC；位位置：[3]；默认值：1’b0；*/
/*描述：a*/
...
/* UHCI_日期：R/W；位位置：[31:0]；默认值：32'h2007170；*/
/*描述：a*/
