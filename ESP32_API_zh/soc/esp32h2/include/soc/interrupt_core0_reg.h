...
/* 中断CORE0_MAC_INTR_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_MAC_NMI_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_PWR_INTR-MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_BB_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_BT_MAC_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_BT__BB_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_BT__BB_NMI_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_RWBT_IRQ_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_RWBLE_IRQ_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断_核心0_RWBT_NMI_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_RWBLE_NMI_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_I2C_MST_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_SLC0_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_SLC1_INTR_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_APB_CTRL_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_UHCI0_INTR-MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_GPIO_INTERRUPT_PRO_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_GPIO_INTERRUPT_PRO_NMI_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_SPI_INTR_1_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_SPI_INTR_2_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* interrut_CORE0_I2S1_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_art_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_art1_INTR_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_LEDC_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断_核心_ EFUSE_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CAN_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_USB_INTR-MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_RTC-CORE_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_RMT_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_I2C_EXT0_INTR-MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_TIMER_INT1_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_TIMER_INT2_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_TG_T0_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_TG_dt_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_TG1_T0_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_TG1_WDT_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CACHE_IA_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断_核心_系统_目标_内部_映射：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_systemtimer_TARGET1_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_systemtimer_TARGET2_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_SPI_MEM_REJECT_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断_核心_缓存_重载_映射：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断_核心_ ICACHE_SYNC_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_APB_ADC_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_DMA_CH0_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_DMA_CH1_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_DMA_CH2_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_RSA_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断_ CORE0_AES_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_SHA_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INTR_FROM_CPU_0_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INTR_FROM_CPU_1_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INTR_FROM_CPU_2_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INTR_FROM_CPU_3_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_ASSIST_DEBUG_INTR_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_DMA_APBPERI_PMS_MONITOR_VIOLATE_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE_0_IRAM0_PMS_MONITOR_VIOLATE_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE_0_DRAM0_PMS_MONITOR_VIOLATE_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE_0_PIF_PMS_MONITOR_VIOLATE_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE_0_PIF_PMS_MONITOR_VIOLATE_SIZE_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_BACKUP_PMS_VIOLATE_INTR_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CACHE_CORE0_ACS_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_TG3_T0_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_TG3_WDT_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_BLE_SEC_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_iee802154mac_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_iee802154bb_INT_MAP:R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_COEX_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_RTC_BLE_TMR_INT_MAP：R/W；位位置：[4:0]；默认值：5'd0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INT_ENABLE:R/W；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INT_TYPE：R/W；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INT_CLEAR:R/W；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INT_EIP_STATUS：RO；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* 中断_CORE0_CPU_PRI_0_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断_CORE0_CPU_PRI_1_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_2_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_3_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_4_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_5_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_6_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断_CORE0_CPU_PRI_7_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断_CORE0_CPU_PRI_8_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_9_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_10_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_11_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_12_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_13_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_14_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_15_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_16_MAP：R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断_CORE0_CPU_PRI_17_映射：R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_18_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_19_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断_CORE0_CPU_PRI_20_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_21_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_22_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* interrut_CORE0_CPU_PRI_23_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_24_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* interrut_CORE0_CPU_PRI_25_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_26_MAP：R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_27_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_28_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_29_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_30_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_PRI_31_MAP:R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* 中断CORE0_CPU_INT_THRESH：R/W；位位置：[3:0]；默认值：4'b0；*/
/*说明：*/
...
/* INTERRUPT_CORE0_trupt_DATE:R/W；位位置：[27:0]；默认值：28'h2011090；*/
/*说明：*/
