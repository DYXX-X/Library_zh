...
/* SYSTEM_WIFI_RST_EN:R/W；位位置：[31:0]；默认值：32'h0；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE0_ATTR:R/W；位位置：[1:0]；默认值：2'h3；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE1_ATTR:R/W；位位置：[1:0]；默认值：2'h3；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE2_ATTR:R/W；位位置：[1:0]；默认值：2'h3；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE3_ATTR:R/W；位位置：[1:0]；默认值：2'h3；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE1_ADDR_S:R/W；位位置：[31:0]；默认值：32'h400000；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE2_ADDR_S:R/W；位位置：[31:0]；默认值：32'h800000；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE3_ADDR_S:R/W；位位置：[31:0]；默认值：32'HC0000；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE0_SIZE:R/W；位位置：[12:0]；默认值：13'h400；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE1_SIZE:R/W；位位置：[12:0]；默认值：13'h400；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE2_SIZE:R/W；位位置：[12:0]；默认值：13'h400；*/
/*说明：*/
...
/* SYSCON_FLASH_ACE3_SIZE:R/W；位位置：[12:0]；默认值：13'h400；*/
/*说明：*/
...
/* SYSCON_retenten_LINK_ADDR:R/W；位位置：[26:0]；默认值：27'd0；*/
/*说明：*/
...
/* SYSCON_SRAM_CLKGATE_FORCE_ON:R/W；比特位置：[5:2]；默认值：~4'b0；*/
/*说明：*/
...
/* SYSCON_ROM_CLKGATE_FORCE_ON:R/W；位位置：[1:0]；默认值：~2'b0；*/
/*说明：*/
...
/* SYSCON_SRAM_POWER_DOWN：R/W；比特位置：[5:2]；默认值：4'b0；*/
/*说明：*/
...
/* SYSCON_ROM_POWER_DOWN：R/W；位位置：[1:0]；默认值：2’b0；*/
/*说明：*/
...
/* SYSCON_SRAM_POWER_UP:R/W；比特位置：[5:2]；默认值：~4'b0；*/
/*说明：*/
...
/* SYSCON_ROM_POWER_UP:R/W；位位置：[1:0]；默认值：~2'b0；*/
/*说明：*/
...
/* SYSCON_RND_DATA:RO；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_ENA:R/W；位位置：[31]；默认值：1’b0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_TO_MEM:R/W；位位置：[30]；默认值：1’b0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_START:WO；位位置：[29]；默认值：1’b0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_SIZE:R/W；位：[28:19]；默认值：10'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_TOUT_THRES:R/W；比特位置：[18:9]；默认值：10'd50；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_BURST_LIMIT:R/W；比特位置：[8:4]；默认值：5'd8；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_FLOW_ERR:RO；位位置：[2:1]；默认值：2'd0；*/
/*说明：*/
...
/* SYSCON_BACKUP_APB_START_ADDR:R/W；位位置：[31:0]；默认值：32'd0；*/
/*说明：*/
...
/* SYSCON_BACKUP_MEM_START_ADDR:R/W；位位置：[31:0]；默认值：32'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_ERR_INT_RAW:RO；位位置：[1]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_DONE_INT_RAW:RO；位位置：[0]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_ERR_INT_ST:RO；位位置：[1]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_DONE_INT_ST:RO；位位置：[0]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_ERR_INT_ENA:R/W；位位置：[1]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_DONE_INT_ENA:R/W；位位置：[0]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_ERR_INT_CLR:WO；位位置：[1]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_PERI_BACKUP_DONE_INT_CLR:WO；位位置：[0]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_DATE:R/W；位位置：[31:0]；默认值：32'h2007210；*/
/*description:版本控制*/
