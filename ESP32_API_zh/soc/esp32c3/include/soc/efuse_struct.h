...
typedef volatile struct efuse_dev_s {
    ...
    union {
        struct {
            ...
            uint32_t rpt4_reserved8:           1;                /*保留（用于四种备份方法）。*/
            ...
            uint32_t rpt4_reserved7:           5;                /*保留（用于四种备份方法）。*/
    ...
    union {
        struct {
            ...
            uint32_t rpt4_reserved5_err:              1;         /*保留。*/
    ...
    union {
        struct {
            ...
            uint32_t rpt4_reserved8_err:           1;            /*保留。*/
            ...
            uint32_t rpt4_reserved7_err:           5;            /*保留*/
