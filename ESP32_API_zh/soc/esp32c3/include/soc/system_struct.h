...
typedef volatile struct system_dev_s {
    union {
        struct {
            ...
            uint32_t reg_clk_en_dedicated_gpio     :    1;  /*reg_clk_en专用gpio*/
    ...
    union {
        struct {
            ...
            uint32_t reg_cpu_wait_mode_force_on    :    1;  /*reg_cpu_wait_mode强制开启*/
            uint32_t reg_cpu_waiti_delay_num       :    4;  /*等待时间限制数*/
            uint32_t reserved8                     :    24;  /*保留*/
        };
        uint32_t val;
    } cpu_per_conf;
    ...
    union {
        struct {
            ...
            uint32_t reg_uart_clk_en               :    1;  /*注册_开始_登录*/
            ...
            uint32_t reg_can_clk_en                :    1;  /*寄存器can_clk_en*/
            ...
            uint32_t reg_adc2_arb_clk_en           :    1;  /*寄存器_adc2_arb_clk_en*/
    ...
    union {
        struct {
            uint32_t reserved0                     :    1;  /*外围复位寄存器*/
            uint32_t reg_crypto_aes_clk_en         :    1;  /*注册密码*/
            uint32_t reg_crypto_sha_clk_en         :    1;  /*注册密码sha_clk_en*/
            uint32_t reg_crypto_rsa_clk_en         :    1;  /*reg_crypto_rsa_clk_en*/
            uint32_t reg_crypto_ds_clk_en          :    1;  /*注册密码*/
            uint32_t reg_crypto_hmac_clk_en        :    1;  /*reg_crypto-hmac_clk_en*/
    ...
    union {
        struct {
            ...
            uint32_t reg_rmt_rst                   :    1;  /*注册_注册_注册*/
            ...
            uint32_t reg_efuse_rst                 :    1;  /*寄存器_保险丝_测试*/
            ...
            uint32_t reg_can_rst                   :    1;  /*寄存器_第一个*/
            ...
            uint32_t reg_adc2_arb_rst              :    1;  /*寄存器_adc2_arb_rst*/
    ...
    union {
        struct {
            ...
            uint32_t reg_crypto_aes_rst            :    1;  /*注册密码aes_rst*/
            ...
            uint32_t reg_crypto_hmac_rst           :    1;  /*reg_crypto-hmac_rst*/
    ...
    union {
        struct {
            ...
            uint32_t reg_lpclk_sel_8m              :    1;  /*寄存器_寄存器_寄存器_8m*/
            uint32_t reg_lpclk_sel_xtal            :    1;  /*寄存器_寄存器_寄存器*/
            uint32_t reg_lpclk_sel_xtal32k         :    1;  /*寄存器_最大值_最大值32k*/
    ...
    union {
        struct {
            uint32_t reg_cpu_intr_from_cpu_2       :    1;  /*reg_cpu_intr_from_cpu2*/
            uint32_t reserved1                     :    31;  /*保留*/
        };
        uint32_t val;
    } cpu_intr_from_cpu_2;
    union {
        struct {
            uint32_t reg_cpu_intr_from_cpu_3       :    1;  /*reg_cpu_intr_from_cpu3*/
            uint32_t reserved1                     :    31;  /*保留*/
        };
        uint32_t val;
    } cpu_intr_from_cpu_3;
    ...
    union {
        struct {
            uint32_t reserved0                     :    8;  /*快速存储器crc寄存器*/
            ...
            uint32_t reg_rtc_mem_crc_finish        :    1;  /*reg_rtc_mem_crc_完成*/
        };
        uint32_t val;
    } rtc_fastmem_config;
    ...
    union {
        struct {
            uint32_t reg_redundant_eco_drive       :    1;  /*reg_冗余_驱动器*/
            uint32_t reg_redundant_eco_result      :    1;  /*寄存器_冗余_结果*/
            uint32_t reserved2                     :    30;  /*保留*/
        };
        uint32_t val;
    } redundant_eco_ctrl;
    ...
    union {
        struct {
            ...
            uint32_t reg_soc_clk_sel               :    2;  /*寄存器oc_clk_sel*/
    ...
    union {
        struct {
            uint32_t reg_comb_timing_err_cnt_lvt_site1:    16;  /*reg_comb_timeng_err_cnt_lvt_site1*/
            uint32_t reserved16                    :    16;  /*保留*/
        };
        uint32_t val;
    ...
    union {
        struct {
            uint32_t reg_comb_timing_err_cnt_hvt_site1:    16;  /*reg_comb_timeng_err_cnt_hvt_site1*/
            uint32_t reserved16                    :    16;  /*保留*/
        };
        uint32_t val;
    ...
    union {
        struct {
            uint32_t reg_comb_timing_err_cnt_lvt_site2:    16;  /*reg_comb_timeng_err_cnt_lvt_site2*/
            uint32_t reserved16                    :    16;  /*保留*/
        };
        uint32_t val;
    ...
    union {
        struct {
            uint32_t reg_comb_timing_err_cnt_hvt_site2:    16;  /*reg_comb_timeng_err_cnt_hvt_site2*/
            uint32_t reserved16                    :    16;  /*保留*/
        };
        uint32_t val;
    ...
    union {
        struct {
            uint32_t reg_comb_timing_err_cnt_lvt_site3:    16;  /*reg_comb_timeng_err_cnt_lvt_site3*/
            uint32_t reserved16                    :    16;  /*保留*/
        };
        uint32_t val;
    ...
    union {
        struct {
            uint32_t reg_comb_timing_err_cnt_nvt_site3:    16;  /*reg_comb_timeng_err_cnt_nvt_site3*/
            uint32_t reserved16                    :    16;  /*保留*/
        };
        uint32_t val;
    ...
    union {
        struct {
            uint32_t reg_comb_timing_err_cnt_hvt_site3:    16;  /*reg_comb_timeng_err_cnt_hvt_site3*/
            uint32_t reserved16                    :    16;  /*保留*/
        };
        uint32_t val;
    ...
    union {
        struct {
            uint32_t reg_system_reg_date           :    28;  /*注册系统注册日期*/
