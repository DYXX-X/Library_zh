...
/* SYSCON_QUICK_CLK_CHNG:R/W；位位置：[13]；默认值：1’b1；*/
/*说明：*/
...
/* SYSCON_PRE_DIV_CNT:R/W；位位置：[9:0]；默认值：10'0；*/
/*说明：*/
...
/* SYSCON_PLL_TICK_NUM:R/W；位位置：[7:0]；默认值：8'd79；*/
/*说明：*/
...
/* SYSCON_CK8M_TICK_NUM:R/W；位位置：[7:0]；默认值：8'd11；*/
/*说明：*/
...
/* SYSCON_SARADC_DATA_TO_I2S:R/W；位位置：[26]；默认值：1’b0；*/
...
/* SYSCON_SARADC_DATA_SAR_SEL:R/W；位位置：[25]；默认值：1’b0；*/
...
/* SYSCON_SARADC_SAR2_PATT_P_CLEAR:R/W；位位置：[24]；默认值：1'd0；*/
...
/* SYSCON_SARADC_SAR1_PATT_P_CLEAR:R/W；位位置：[23]；默认值：1'd0；*/
...
/* SYSCON_SARADC_SAR2_PATT_LEN:R/W；比特位置：[22:19]；默认值：4'd15；*/
/*说明：0~15表示长度1~16*/
...
/* SYSCON_SARADC_SAR1_PATT_LEN:R/W；比特位置：[18:15]；默认值：4'd15；*/
/*说明：0~15表示长度1~16*/
...
/* SYSCON_SARADC_SAR_CLK_DIV:R/W；比特位置：[14:7]；默认值：8'd4；*/
/*描述：SAR时钟分频器*/
...
/* SYSCON_SARADC_SAR_CLK_GATED:R/W；位位置：[6]；默认值：1’b1；*/
/*说明：*/
...
/* SYSCON_SARADC_SAR_SEL:R/W；位位置：[5]；默认值：1'd0；*/
...
/* SYSCON_SARADC_WORK_MODE：R/W；位位置：[4:3]；默认值：2'd0；*/
/*描述：0：单模式1：双模式2：交替模式*/
...
/* SYSCON_SARADC_SAR2_MUX:R/W；位位置：[2]；默认值：1'd0；*/
...
/* SYSCON_SARADC_START:R/W；位位置：[1]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_SARADC_START_FORCE:R/W；位位置：[0]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_SARADC_SAR2_INV:R/W；位位置：[10]；默认值：1'd0；*/
...
/* SYSCON_SARADC_SAR1_INV:R/W；位位置：[9]；默认值：1'd0；*/
...
/* SYSCON_SARADC_MAX_MEAS_NUM:R/W；位位置：[8:1]；默认值：8'd255；*/
/*description:最大转换数*/
...
/* SYSCON_SARADC_MEAS_NUM_LIMIT:R/W；位位置：[0]；默认值：1'd0；*/
/*说明：*/
...
/* SYSCON_SARADC_SAMPLE_CYCLE:R/W；位位置：[31:24]；默认值：8'd2；*/
/*描述：采样周期*/
...
/* SYSCON_SARADC_START_WAIT:R/W；比特位置：[23:16]；默认值：8'd8；*/
/*说明：*/
...
/* SYSCON_SARADC_STANDBY_WAIT:R/W；比特位置：[15:8]；默认值：8'd255；*/
/*说明：*/
...
/* SYSCON_SARADC_RSTB_WAIT:R/W；位位置：[7:0]；默认值：8'd8；*/
/*说明：*/
...
/* SYSCON_SARADC_SAR1_PATT_TAB1:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_SARADC_SAR1_PATT_TAB2:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_SARADC_SAR1_PATT_TAB3:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_SARADC_SAR1_PATT_TAB4:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_SARADC_SAR2_PATT_TAB1:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_SARADC_SAR2_PATT_TAB2:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_SARADC_SAR2_PATT_TAB3:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_SARADC_SAR2_PATT_TAB4:R/W；位位置：[31:0]；默认值：32'hf0f0f；*/
...
/* SYSCON_APLL_TICK_NUM:R/W；位位置：[7:0]；默认值：8'd99；*/
/*说明：*/
...
/* SYSCON_DATE:R/W；位位置：[31:0]；默认值：32'h16042000；*/
/*说明：*/
