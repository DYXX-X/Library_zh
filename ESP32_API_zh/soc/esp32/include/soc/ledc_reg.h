...
/* LEDC_CLK_EN:R/W；位位置：[31]；默认值：1'0；*/
/*description:此位为时钟门控控制信号。当软件配置LED_ PWM内部寄存器时。*/
#define LEDC_CLK_EN  (BIT(31))
#define LEDC_CLK_EN_M  (BIT(31))
#define LEDC_CLK_EN_V  0x1
#define LEDC_CLK_EN_S  31
/* LEDC_IDLE_LV_HSCH0:R/W；位位置：[3]；默认值：1’b0；*/
/*description:此位用于控制高速通道0关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH0:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道0的输出启用控制位*/
...
/* LEDC_TIMER_SEL_HSCH0:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，这两个位用于为高速通道选择其中一个。0。2’b00：选择hstimer0。2‘b01：选择hstimer1。2’b10：选择hs timer2。2’b11：选择hs Timer3。*/
...
/* LEDC_HPOINT_HSCH0:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当高速通道0选择的htimerx（x=[03]）达到reg_hpoint_hsch0[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_HSCH0:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道0选择的hstimerx（x=[03]）达到reg_lpoint_hsch0时，输出信号变为低。reg_lpoint_hsch0=（reg_hpoint_hsch0[19:0]+reg_duty_hsch0[24:4]）（1）reg_lpoint_hsch0=*/
...
/* LEDC_DUTY_START_HSCH0:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch0 reg_duty-cycle_hsch0和reg_duty_scale_hsch0时。这些寄存器在设置regdutystarthsch0之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_HSCH0:R/W；位位置：[30]；默认值：1’b1；*/
/*描述：此寄存器用于增加输出信号的占空比或降低高速通道0的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH0:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道0的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE_HSCH0:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道0的每个reg_duty_cycle_hsch0周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH0:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道0的增加或减少步长。*/
...
/* LEDC_DUTY-HSCH0:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道0的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH0  0x01FFFFFF
#define LEDC_DUTY_HSCH0_M  ((LEDC_DUTY_HSCH0_V)<<(LEDC_DUTY_HSCH0_S))
#define LEDC_DUTY_HSCH0_V  0x1FFFFFF
#define LEDC_DUTY_HSCH0_S  0
...
/* LEDC_IDLE_LV_HSCH1:R/W；位位置：[3]；默认值：1’b0；*/
/*description:此位用于控制高速通道1关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH1:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道1的输出启用控制位*/
...
/* led时钟_ SEL_HSCH1:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，这两个位用于为高速通道选择其中一个。1。2’b00：选择hstimer0。2’b01：选择hstimer1。2’b10：选择hsimer2。2’b11：选择hs timer3。*/
...
/* LEDC_HPOINT_HSCH1:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当高速通道1选择的htimerx（x=[03]）达到reg_hpoint_hsch1[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_HSCH1:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道1选择的hstimerx（x=[03]）达到reg_lpoint_hsch1时，输出信号变为低。reg_lpoint_hsch1=（reg_hpoint_hsch1[19:0]+reg_duty_hsch1[24:4]）（1）reg_lpoint_hsch1=（reg_hpoint_hch1[19:0]+reg_duty_hsch1[24:4]+1）（2）此寄存器中的至少四位表示小数部分，并确定何时选择（1）或（2）*/
...
/* LEDC_DUTY_START_HSCH1:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch1 reg_duty-cycle_hsch1和reg_duty_scale_hsch1时。这些寄存器在设置regdutystarthsch1之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_HSCH1:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低高速通道1的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH1:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道1的增加或减少次数。*/
...
/* LEDC_DUTY_CYCLE_sch1:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道1的每个reg_duty_cycle_hsch1周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH1:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道1的增加或减少步长。*/
...
/* LEDC_DUTY-HSCH1:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道1的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH1  0x01FFFFFF
#define LEDC_DUTY_HSCH1_M  ((LEDC_DUTY_HSCH1_V)<<(LEDC_DUTY_HSCH1_S))
#define LEDC_DUTY_HSCH1_V  0x1FFFFFF
#define LEDC_DUTY_HSCH1_S  0
...
/* LEDC_IDLE_LV_hch2:R/W；位位置：[3]；默认值：1’b0；*/
/*description:此位用于控制高速通道2关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH2:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道2的输出启用控制位*/
...
/* LEDC_TIMER_SEL_HSCH2:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，这两个位用于为高速通道选择其中一个。2’b00：选择hstimer0。2’b01：选择hstimer1。2’b10：选择hsimer2。2’b11：选择hs timer3。*/
...
/* LEDC_HPOINT_HSCH2:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当高速通道2选择的htimerx（x=[03]）达到reg_hpoint_hsch2[19:0]时，输出值变为高*/
...
/* LEDC_DUTY-hch2:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道2选择的hstimerx（x=[03]）达到reg_lpoint_hsch2时，输出信号变为低。reg_lpoint_hsch2=（reg_hpoint_hsch2[19:0]+reg_duty_hsch2[24:4]）（1）reg_lpoint_hsch2=*/
...
/* LEDC_DUTY_START_HSCH2:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch2 reg_duty-cycle_hsch2和reg_duty_scale_hsch2时。这些寄存器在设置regdutystarthsch2之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_HSCH2:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低高速通道2的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH2:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道2的增加或减少次数。*/
...
/* LEDC_DUTY_CYCLE_sch2:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道2的每个reg_duty_cycle_hsch2周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH2:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道2的增加或减少步长。*/
...
/* LEDC_DUTY-hch2:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道2的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH2  0x01FFFFFF
#define LEDC_DUTY_HSCH2_M  ((LEDC_DUTY_HSCH2_V)<<(LEDC_DUTY_HSCH2_S))
#define LEDC_DUTY_HSCH2_V  0x1FFFFFF
#define LEDC_DUTY_HSCH2_S  0
...
/* LEDC_IDLE_LV_sch3:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制高速通道3关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH3:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道3的输出启用控制位*/
...
/* led时间_ SEL_HSCH3:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，这两个位用于为高速通道选择其中一个。3.2’b00：选择hstimer0。2’b01：选择hstimer1。2’b10：选择hs timer2。2’b11：选择hs Timer3。*/
...
/* LEDC_HPOINT_HSCH3:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当高速通道3选择的htimerx（x=[03]）达到reg_hpoint_hsch3[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_HSCH3:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道3选择的hstimerx（x=[03]）达到reg_lpoint_hsch3时，输出信号变为低。reg_lpoint_hsch3=（reg_hpoint_hsch3[19:0]+reg_duty_hsch3[24:4]）（1）reg_lpoint_hsch3=*/
...
/* LEDC_DUTY_START_HSCH3:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch3 reg_duty-cycle_hsch3和reg_duty_scale_hsch3时。这些寄存器在设置regdutystarthsch3之前不会生效。硬件会自动清除此位。*/
...
/* LEDC_DUTY_INC_HSCH3:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低高速通道3的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH3:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道3的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE:HSCH3:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道3的每个reg_duty_cycle_hsch3周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH3:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道3的增加或减少步长。*/
...
/* LEDC_DUTY-HSCH3:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道3的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH3  0x01FFFFFF
#define LEDC_DUTY_HSCH3_M  ((LEDC_DUTY_HSCH3_V)<<(LEDC_DUTY_HSCH3_S))
#define LEDC_DUTY_HSCH3_V  0x1FFFFFF
#define LEDC_DUTY_HSCH3_S  0
...
/* LEDC_IDLE_LV_hch4:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制高速通道4关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH4:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道4的输出启用控制位*/
...
/* led时间_ SEL_HSCH4：R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，两个位用于为高速通道选择其中一个。2’b00：选择hstimer0。2’b01：选择hstimer1。2’b10：选择hs timer2。2’b11：选择hsimer3。*/
...
/* LEDC_HPOINT_HSCH4:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当高速通道4选择的htimerx（x=[03]）达到reg_hpoint_hsch4[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_HSCH4:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道4选择的hstimerx（x=[03]）达到reg_lpoint_hsch4时，输出信号变为低。reg_lpoint_hsch4=（reg_hpoint_hsch4[19:0]+reg_duty_hsch4[24:4]）（1）reg_lpoint_hsch4=（reg_hpoint_hsch4][19:0]+reg_duty_hsch4[24:4]+1）（2）此寄存器中的至少四位表示小数部分，并确定何时选择（1）或（2）*/
...
/* LEDC_DUTY_START_HSCH4:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch1 reg_duty-cycle_hsch1和reg_duty_scale_hsch1时。这些寄存器在设置regdutystarthsch1之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_HSCH4:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低高速通道4的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH4:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道1的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE:HSCH4:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道4的每个reg_duty_cycle_hsch4周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH4:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道4的增加或减少步长。*/
...
/* LEDC_DUTY-HSCH4:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道4的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH4  0x01FFFFFF
#define LEDC_DUTY_HSCH4_M  ((LEDC_DUTY_HSCH4_V)<<(LEDC_DUTY_HSCH4_S))
#define LEDC_DUTY_HSCH4_V  0x1FFFFFF
#define LEDC_DUTY_HSCH4_S  0
...
/* LEDC_IDLE_LV_HSCH5:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制高速通道5关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH5:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道5的输出启用控制位。*/
...
/* led时间_ SEL_HSCH5:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，这两个位用于为高速通道选择其中一个。5。2’00：选择hstimer0。2’b01：选择hstimer1。2’b10：选择hsimer2。2’b11：选择hs timer3。*/
...
/* LEDC_HPOINT_HSCH5:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当高速通道5选择的htimerx（x=[03]）达到reg_hpoint_hsch5[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_HSCH5:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道5选择的hstimerx（x=[03]）达到reg_lpoint_hsch5时，输出信号变为低。reg_lpoint_hsch5=（reg_hpoint_hsch5[19:0]+reg_duty_hsh5[24:4]）（1）reg_lpoint_hsch5=*/
...
/* LEDC_DUTY_START_HSCH5:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch5 reg_duty-cycle_hsch5和reg_duty_scale_hsch5时。这些寄存器在设置regdutystarthsch5之前不会生效。硬件会自动清除此位。*/
...
/* LEDC_DUTY_INC_hsh5:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低高速通道5的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH5:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道5的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE:HSCH5:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道5的每个reg_duty_cycle_hsch5周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH5:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道5的增加或减少步长。*/
...
/* LEDC_DUTY-HSCH5:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道5的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH5  0x01FFFFFF
#define LEDC_DUTY_HSCH5_M  ((LEDC_DUTY_HSCH5_V)<<(LEDC_DUTY_HSCH5_S))
#define LEDC_DUTY_HSCH5_V  0x1FFFFFF
#define LEDC_DUTY_HSCH5_S  0
...
/* LEDC_IDLE_LV_hch6:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制高速通道6关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH6:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道6的输出启用控制位*/
...
/* led时间_ SEL_HSCH6:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，这两个位用于为高速通道选择其中一个。6。2’00：选择hstimer0。2’b01：选择hstimer1。2’b10：选择hsimer2。2’b11：选择hs timer3。*/
...
/* LEDC_HPOINT_HSCH6:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当高速通道6选择的htimerx（x=[03]）达到reg_hpoint_hsch6[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_HSCH6:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道6选择的hstimerx（x=[03]）达到reg_lpoint_hsch6时，输出信号变为低。reg_lpoint_hsch6=（reg_hpoint_hsch6[19:0]+reg_duty_hsh6[24:4]）（1）reg_lpoint_hsch6=（reg_hpoint_hsch6][19:0]+reg_duty_hsch6[24:4]+1）（2）此寄存器中的至少四位表示小数部分，并确定何时选择（1）或（2）*/
...
/* LEDC_DUTY_START_HSCH6:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch1 reg_duty-cycle_hsch1和reg_duty_scale_hsch1时。这些寄存器在设置regdutystarthsch1之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_HSCH6:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低高速通道6的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH6:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道6的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE:HSCH6:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道6的每个reg_duty_cycle_hsch6周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH6:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道6的增加或减少步长。*/
...
/* LEDC_DUTY-HSCH6:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道6的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH6  0x01FFFFFF
#define LEDC_DUTY_HSCH6_M  ((LEDC_DUTY_HSCH6_V)<<(LEDC_DUTY_HSCH6_S))
#define LEDC_DUTY_HSCH6_V  0x1FFFFFF
#define LEDC_DUTY_HSCH6_S  0
...
/* LEDC_IDLE_LV_HSCH7:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制高速通道7关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_HSCH7:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是高速通道7的输出启用控制位。*/
...
/* LEDC_TIMER_SEL_HSCH7:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个高速计时器，这两个位用于为高速通道选择其中一个计时器7.2'b00:选择hstimer0.2'b01:选择hstimer1。2'b10:选择hstimer2。2'b11:选择hstimer3。*/
...
/* LEDC_HPOINT_HSCH7:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当高速通道7选择的htimerx（x=[03]）达到reg_hpoint_hsch7[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_HSCH7:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当高速通道7选择的hstimerx（x=[03]）达到reg_lpoint_hsch7时，输出信号变为低。reg_lpoint_hsch7=（reg_hpoint_hsch7[19:0]+reg_duty_hsh7[24:4]）（1）reg_lpoint_hsch7=（reg_hpoint_hsch7][19:0]+reg_duty_hsch7[24:4]+1）（2）此寄存器中的至少四位表示小数部分，并确定何时选择（1）或（2）*/
...
/* LEDC_DUTY_START_HSCH7:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch1 reg_duty-cycle_hsch1和reg_duty_scale_hsch1时。这些寄存器在设置regdutystarthsch1之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_HSCH7:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低高速通道6的输出信号占空比。*/
...
/* LEDC_DUTY_NUM_HSCH7:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制高速通道6的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE:HSCH7:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少高速通道7的每个reg_duty_cycle_hsch7周期的占空比。*/
...
/* LEDC_DUTY_SCALE_HSCH7:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制高速通道7的增加或减少步长。*/
...
/* LEDC_DUTY-HSCH7:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示高速通道7的输出信号的当前占空比。*/
#define LEDC_DUTY_HSCH7  0x01FFFFFF
#define LEDC_DUTY_HSCH7_M  ((LEDC_DUTY_HSCH7_V)<<(LEDC_DUTY_HSCH7_S))
#define LEDC_DUTY_HSCH7_V  0x1FFFFFF
#define LEDC_DUTY_HSCH7_S  0
...
/* LEDC_PARA_UP_LSCH0:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：此位用于更新低速通道0的寄存器LEDC_LSCHO_POINT和LEDC_LSH0_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH0:R/W；位位置：[3]；默认值：1’b0；*/
/*description:此位用于控制低速通道0关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH0:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道0的输出启用控制位。*/
...
/* LEDC_TIMER_SEL_LSCH0:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速计时器，这两个位用于为低速通道选择其中一个。0。2’b00：选择第一计时器0。2‘b01：选择第一时间1。2’b10：选择第二时间2。2’b11：选择第三时间3。*/
...
/* LEDC_HPOINT_LSCH0:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当低速通道0选择的lstimerx（x=[03]）达到reg_hpoint_lsch0[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH0:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道0选择的lstimerx（x=[03]）达到reg_lpoint_lsch0时，输出信号变为低。reg_lpoint_lsch0=（reg_hpoint_lsch0[19:0]+reg_duty_lsch0[24:4]）（1）reg_lpoint_lsch0=*/
...
/* LEDC_DUTY_START_LSCH0:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch1 reg_duty-cycle_hsch1和reg_duty_scale_hsch1时。这些寄存器在设置regdutystarthsch1之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_LSCH0:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道6的输出信号的工作比。*/
...
/* LEDC_DUTY_NUM_LSCH0:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道6的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE_LSCH0:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少低速通道0的每个reg_duty_cycle_lsch0周期的占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH0:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道0的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH0:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道0的输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH0  0x01FFFFFF
#define LEDC_DUTY_LSCH0_M  ((LEDC_DUTY_LSCH0_V)<<(LEDC_DUTY_LSCH0_S))
#define LEDC_DUTY_LSCH0_V  0x1FFFFFF
#define LEDC_DUTY_LSCH0_S  0
...
/* 发光二极管PARA_UP_LSCH1:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：此位用于更新低速通道1的寄存器LEDC_LSCH1_POINT和LEDC_LSH1_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH1:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制低速通道1关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH1:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道1的输出启用控制位。*/
...
/* 发光二极管计时器SEL_LSCH1:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速定时器，这两个位用于为低速信道选择其中一个。1。2’b00：seletc lstimer0。2’b01：选择lstimer1。2’b10：选择lstimer2。2’b11：选择lsimer3。*/
...
/* LEDC_HPOINT_LSCH1:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当低速通道1选择的lstimerx（x=[03]）达到reg_hpoint_lsch1[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH1:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道1选择的lstimerx（x=[03]）达到reg_lpoint_lsch1时，输出信号变为低。reg_lpoint_lsch1=（reg_hpoint_lsch1[19:0]+reg_duty_lsch1[24:4]）（1）reg_lpoint_lsch1=*/
...
/* LEDC_DUTY_START_LSCH1:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch1 reg_duty-cycle_hsch1和reg_duty_scale_hsch1时。这些寄存器在设置regdutystarthsch1之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_LSCH1:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道1的输出信号的。*/
...
/* LEDC_DUTY_NUM_LSCH1:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道1的增加或减少次数。*/
...
/* 指示灯DUTY_CYCLE_LSCH1:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少低速通道1的每个reg_duty_cycle_lsch1周期的占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH1:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道1的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH1:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道1输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH1  0x01FFFFFF
#define LEDC_DUTY_LSCH1_M  ((LEDC_DUTY_LSCH1_V)<<(LEDC_DUTY_LSCH1_S))
#define LEDC_DUTY_LSCH1_V  0x1FFFFFF
#define LEDC_DUTY_LSCH1_S  0
...
/* LEDC_PARA_UP_LSCH2:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：此位用于更新低速通道2的寄存器LEDC_LSCH2_HPOINT和LEDC_LSH2_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH2:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制低速通道2关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH2:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道2的输出启用控制位。*/
...
/* 发光二极管计时器SEL_LSCH2:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速定时器，这两个位用于为低速信道选择其中一个。2'b00:seletc lstimer0.2'b01:select lstimer1。2'b10:select lstimer2。2'b11:select lstimer3。*/
...
/* LEDC_HPOINT_LSCH2:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当低速通道2选择的lstimerx（x=[03]）达到reg_hpoint_lsch2[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH2:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道2选择的lstimerx（x=[03]）达到reg_lpoint_lsch2时，输出信号变为低。reg_lpoint_lsch2=（reg_hpoint_lsch2[19:0]+reg_duty_lsch2[24:4]）（1）reg_lpoint_lsch2=*/
...
/* LEDC_DUTY_START_LSCH2:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch2 reg_duty-cycle_hsch2和reg_duty_scale_hsch2时。这些寄存器在设置regdutystarthsch2之前不会生效。这个位会被硬件自动清除。*/
...
/* LEDC_DUTY_INC_LSCH2:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道2的输出信号的。*/
...
/* LEDC_DUTY_NUM_LSCH2:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道2的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE_LSCH2:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少低速通道2的每个reg_duty_cycle_lsch2周期的占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH2:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道2的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH2:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道2的输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH2  0x01FFFFFF
#define LEDC_DUTY_LSCH2_M  ((LEDC_DUTY_LSCH2_V)<<(LEDC_DUTY_LSCH2_S))
#define LEDC_DUTY_LSCH2_V  0x1FFFFFF
#define LEDC_DUTY_LSCH2_S  0
...
/* LEDC_PARA_UP_LSCH3:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：此位用于更新低速通道3的寄存器LEDC_LSCH_3_HPOINT和LEDC_LSH3_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH3:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制低速通道3关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH3:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道3的输出启用控制位。*/
...
/* 发光二极管计时器SEL_LSCH3:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速定时器，这两个位用于为低速信道选择其中一个。2'b00:seletc lstimer0.2'b01:select lstimer1。2'b10:select lstimer2。2'b11:select lstimer3。*/
...
/* LEDC_HPOINT_LSCH3:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当低速通道3选择的lstimerx（x=[0 3]）达到reg_hpoint_lsch3[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH3:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道3选择的lstimerx（x=[03]）达到reg_lpoint_lsch3时，输出信号变为低。reg_lpoint_lsch3=（reg_hpoint_lsch3[19:0]+reg_duty_lsch3[24:4]）（1）reg_lpoint_lsch3=*/
...
/* LEDC_DUTY_START_LSCH3:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch3 reg_duty-cycle_hsch3和reg_duty_scale_hsch3时。这些寄存器在设置regdutystarthsch3之前不会生效。硬件会自动清除此位。*/
...
/* LEDC_DUTY_INC_LSCH3:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道3的输出信号的工作比。*/
...
/* LEDC_DUTY_NUM_LSCH3:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道3的增加或减少次数。*/
...
/* 指示灯DUTY_CYCLE_LSCH3:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少低速通道3的每个reg_duty_cycle_lsch3周期的占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH3:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道3的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH3:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道3输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH3  0x01FFFFFF
#define LEDC_DUTY_LSCH3_M  ((LEDC_DUTY_LSCH3_V)<<(LEDC_DUTY_LSCH3_S))
#define LEDC_DUTY_LSCH3_V  0x1FFFFFF
#define LEDC_DUTY_LSCH3_S  0
...
/* LEDC_PARA_UP_LSCH4:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：此位用于更新低速通道4的寄存器LEDC_LSCH_4_HPOINT和LEDC_LSH4_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH4:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制低速通道4关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH4:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道4的输出启用控制位。*/
...
/* 发光二极管计时器SEL_LSCH4:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速定时器，这两个位用于为低速信道选择其中一个。2'b00:seletc lstimer0.2'b01:select lstimer1。2'b10:select lstimer2。2'b11:select lstimer3。*/
...
/* LEDC_HPOINT_LSCH4:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当低速通道4选择的lstimerx（x=[03]）达到reg_hpoint_lsch4[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH4:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道4选择的lstimerx（x=[03]）达到reg_lpoint_lsch4时，输出信号变为低。reg_lpoint_lsch4=（reg_hpoint_lsch4[19:0]+reg_duty_lsch4[24:4]）（1）reg_lpoint_lsch4=*/
...
/* LEDC_DUTY_START_LSCH4:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch4 reg_duty-cycle_hsch4和reg_duty_scale_hsch4时。这些寄存器在设置regdutystarthsch4之前不会生效。硬件会自动清除此位。*/
...
/* LEDC_DUTY_INC_LSCH4:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道4的输出信号的工作比。*/
...
/* LEDC_DUTY_NUM_LSCH4:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道4的增加或减少次数。*/
...
/* 指示灯DUTY_CYCLE_LSCH4:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少低速通道4的每个reg_duty_cycle_lsch4周期的占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH4:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道4的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH4:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道4的输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH4  0x01FFFFFF
#define LEDC_DUTY_LSCH4_M  ((LEDC_DUTY_LSCH4_V)<<(LEDC_DUTY_LSCH4_S))
#define LEDC_DUTY_LSCH4_V  0x1FFFFFF
#define LEDC_DUTY_LSCH4_S  0
...
/* LEDC_PARA_UP_LSCH5:R/W；位位置：[4]；默认值：1’b0；*/
/*description:此位用于更新低速通道5的寄存器LEDC_LSCH_5_HPOINT和LEDC_LSH5_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH5:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制低速通道5关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH5:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道5的输出启用控制位。*/
...
/* 发光二极管计时器SEL_LSCH5:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速定时器，这两个位用于为低速信道选择其中一个。5。2’b00：seletc lstimer0。2’b01：选择lstimer1。2’b10：选择lstimer2。2’b11：选择lsimer3。*/
...
/* LEDC_HPOINT_LSCH5:R/W；比特位置：[19:0]；默认值：20'00；*/
/*description:当低速通道5选择的lstimerx（x=[03]）达到reg_hpoint_lsch5[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH5:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道5选择的lstimerx（x=[03]）达到reg_lpoint_lsch5时，输出信号变为低。reg_lpoint_lsch5=（reg_hpoint_lsch5[19:0]+reg_duty_lsh5[24:4]）（1）reg_lpoint_lsch5=*/
...
/* LEDC_DUTY_START_LSCH5:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch4 reg_duty-cycle_hsch4和reg_duty_scale_hsch4时。这些寄存器在设置regdutystarthsch4之前不会生效。硬件会自动清除此位。*/
...
/* LEDC_DUTY_INC_lsh5:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道5的输出信号的工作比。*/
...
/* LEDC_DUTY_NUM_LSCH5:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道5的增加或减少次数。*/
...
/* 发光二极管DUTY_CYCLE_LSCH5:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于在低速通道4的每个reg_duty_cycle_lsch5周期增加或减少占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH5:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道5的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH5:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道5的输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH5  0x01FFFFFF
#define LEDC_DUTY_LSCH5_M  ((LEDC_DUTY_LSCH5_V)<<(LEDC_DUTY_LSCH5_S))
#define LEDC_DUTY_LSCH5_V  0x1FFFFFF
#define LEDC_DUTY_LSCH5_S  0
...
/* LEDC_PARA_UP_LSCH6:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：此位用于更新低速通道6的寄存器LEDC_LSCH6_POINT和LEDC_LSH6_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH6:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制低速通道6关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH6:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道6的输出启用控制位。*/
...
/* 发光二极管计时器SEL_LSCH6:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速定时器，这两个位用于为低速信道选择其中一个。6。2’b00：seletc lstimer0。2’b01：选择lstimer1。2’b10：选择lstimer2。2’b11：选择lsimer3。*/
...
/* LEDC_HPOINT_LSCH6:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当低速通道6选择的lstimerx（x=[03]）达到reg_hpoint_lsch6[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH6:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道6选择的lstimerx（x=[03]）达到reg_lpoint_lsch6时，输出信号变为低。reg_lpoint_lsch6=（reg_hpoint_lsch6[19:0]+reg_duty_lsch6[24:4]）（1）reg_lpoint_lsch6=*/
...
/* LEDC_DUTY_START_LSCH6:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch6 reg_duty-cycle_hsch6和reg_duty_scale_hsch6时。这些寄存器在设置regdutystarthsch6之前不会生效。硬件会自动清除此位。*/
...
/* LEDC_DUTY_INC_LSCH6:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道6的输出信号的工作比。*/
...
/* LEDC_DUTY_NUM_LSCH6:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道6的增加或减少次数。*/
...
/* 指示灯DUTY_CYCLE_LSCH6:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于在低速通道6的每个reg_duty_cycle_lsch6周期增加或减少占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH6:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道6的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH6:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道6的输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH6  0x01FFFFFF
#define LEDC_DUTY_LSCH6_M  ((LEDC_DUTY_LSCH6_V)<<(LEDC_DUTY_LSCH6_S))
#define LEDC_DUTY_LSCH6_V  0x1FFFFFF
#define LEDC_DUTY_LSCH6_S  0
...
/* LEDC_PARA_UP_LSCH7:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：此位用于更新低速通道7的寄存器LEDC_LSCH7_POINT和LEDC_LSH7_DUTY。*/
...
/* LEDC_IDLE_LV_LSCH7:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：此位用于控制低速通道7关闭时的输出值。*/
...
/* 发光二极管SIG_OUT_EN_LSCH7:R/W；位位置：[2]；默认值：1’b0；*/
/*description:这是低速通道7的输出启用控制位。*/
...
/* 发光二极管计时器SEL_LSCH7:R/W；位位置：[1:0]；默认值：2'd0；*/
/*描述：有四个低速定时器，这两个位用于为低速信道选择其中一个定时器7.2'b00:seletc lstimer0.2'b01:select lstimer1.2'b10:select lstimer2.2'b11:select lstimer3。*/
...
/* LEDC_HPOINT_LSCH7:R/W；比特位置：[19:0]；默认值：20'00；*/
/*描述：当低速通道7选择的lstimerx（x=[03]）达到reg_hpoint_lsch7[19:0]时，输出值变为高*/
...
/* LEDC_DUTY_LSCH7:R/W；位位置：[24:0]；默认值：25'0；*/
/*description:寄存器用于控制输出占空比。当低速通道7选择的lstimerx（x=[03]）达到reg_lpoint_lsch7时，输出信号变为低。reg_lpoint_lsch7=（reg_hpoint_lsch7[19:0]+reg_duty_lsch7[24:4]）（1）reg_lpoint_lsch7=*/
...
/* LEDC_DUTY_START_LSCH7:R/W；位位置：[31]；默认值：1’b0；*/
/*description:配置reg_duty_num_hsch4 reg_duty-cycle_hsch4和reg_duty_scale_hsch4时。这些寄存器在设置regdutystarthsch4之前不会生效。硬件会自动清除此位。*/
...
/* LEDC_DUTY_INC_LSCH7:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：此寄存器用于增加输出信号的占空比或降低低速通道4的输出信号的工作比。*/
...
/* LEDC_DUTY_NUM_LSCH7:R/W；位位置：[29:20]；默认值：10'0；*/
/*描述：此寄存器用于控制低速通道4的增加或减少次数。*/
...
/* 指示灯DUTY_CYCLE_LSCH7:R/W；比特位置：[19:10]；默认值：10'0；*/
/*description:此寄存器用于增加或减少低速通道7的每个reg_duty_cycle_lsch7周期的占空比。*/
...
/* LEDC_DUTY_SCALE_LSCH7:R/W；位位置：[9:0]；默认值：10'0；*/
/*描述：此寄存器控制低速通道7的增加或减少步长。*/
...
/* LEDC_DUTY_LSCH7:RO；位位置：[24:0]；默认值：25'0；*/
/*描述：此寄存器表示低速通道7的输出信号的当前占空比。*/
#define LEDC_DUTY_LSCH7  0x01FFFFFF
#define LEDC_DUTY_LSCH7_M  ((LEDC_DUTY_LSCH7_V)<<(LEDC_DUTY_LSCH7_S))
#define LEDC_DUTY_LSCH7_V  0x1FFFFFF
#define LEDC_DUTY_LSCH7_S  0
...
/* LEDC_TICK_SEL_HSTIMER0:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为高速时间r0.1’b1:apb_clk 0:ref_tick选择apb_clk或ref_tick*/
...
/* LEDC_HSTIMER0_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*description:此位用于重置高速计时器r0，重置后计数器将为0。*/
...
/* LEDC_HSTIMER0_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在高速计时器r0中暂停计数器*/
...
/* 指示灯DIV_NUM_HSTIMER0:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置高速计时器r0中除法器的参数，最低有效的八位表示小数部分。*/
...
/* LEDC_HSTIMER0_LIM：R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制高速计时器r0中计数器的范围。计数器范围为[0 2*reg_hstimer0_lim]，计数器的最大位宽为20。*/
...
/* LEDC_HSTIMER0_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器以获取高速计时器r0中的当前计数器值*/
...
/* LEDC_TICK_SEL_HSTIMER1:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为高速计时器r1选择apb_clk或ref_tick。1’b1:apb_clk 0:ref_tick*/
...
/* LEDC_HSTIMER1_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*description:此位用于重置高速计时器1，重置后计数器将为0。*/
...
/* LEDC_HSTIMER1_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在高速计时器1中暂停计数器*/
...
/* 指示灯DIV_NUM_HSTIMER1:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置高速计时器1中除法器的参数，最低有效8位表示小数部分。*/
...
/* LEDC_HSTIMER1_LIM:R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制高速计时器1中计数器的范围。计数器范围为[0 2*reg_hstimer1_lim]，计数器的最大位宽为20。*/
...
/* LEDC_HSTIMER1_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器以获取高速计时器1中的当前计数器值。*/
...
/* LEDC_TICK_SEL_HSTIMER2:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为高速时间2选择apb_clk或ref_tick。1’b1:apb_clk 0:ref_tick*/
...
/* LEDC_HSTIMER2_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*description:此位用于重置高速计时器2，重置后计数器将为0。*/
...
/* LEDC_HSTIMER2_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在高速计时器2中暂停计数器*/
...
/* 指示灯DIV_NUM_HSTIMER2:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置高速计时器中除法器的参数2，最低有效8位表示小数部分。*/
...
/* LEDC_HSTIMER2_LIM:R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制高速计时器2中计数器的范围。计数器范围为[0 2*reg_hstimer2_lim]，计数器的最大位宽为20。*/
...
/* LEDC_HSTIMER2_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器，以获得高速计时器2的当前计数器值*/
...
/* LEDC_TICK_SEL_HSTIMER3:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为高速计时器r3选择apb_clk或ref_tick。1’b1:apb_clk 0:ref_tick*/
...
/* LEDC_HSTIMER3_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*description:此位用于重置高速计时器3，重置后计数器将为0。*/
...
/* LEDC_HSTIMER3_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在高速计时器r3中暂停计数器*/
...
/* 指示灯DIV_NUM_HSTIMER3:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置高速计时器3中除法器的参数，最低有效8位表示小数部分。*/
...
/* LEDC_HSTIMER3_LIM:R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制高速计时器r3中计数器的范围。计数器范围为[0 2*reg_hstimer3_lim]，计数器的最大位宽为20。*/
...
/* LEDC_HSTIMER3_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器以获取高速计时器r3中的当前计数器值*/
...
/* LEDC_LSTIMER0_PARA_UP:R/W；位位置：[26]；默认值：1'0；*/
/*description:设置此位以更新reg_div_num_lstime0和reg_lstimer0_lim。*/
...
/* LEDC_TICK_SEL_LSTIMER0:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为低速计时器r0选择slow_clk或ref_tick。1’b1：slow_clk 0：ref_tick*/
...
/* LEDC_LSTIMER0_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*description:此位用于重置低速计时器r0，重置后计数器将为0。*/
...
/* LEDC_LSTIMER0_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在低速计时器r0中暂停计数器。*/
...
/* 发光二极管DIV_NUM_LSTIMER0:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置低速时间r0中除法器的参数，最低有效位表示小数部分。*/
...
/* LEDC_LSTIMER0_LIM：R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制低速计时器r0中计数器的范围。计数器范围为[0 2*reg_lstimer0_lim]，计数器的最大位宽为20。*/
...
/* LEDC_LSTIMER0_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器以获得低速计时器r0中的当前计数器值。*/
...
/* 发光二极管LSTIMER1_PARA_UP:R/W；位位置：[26]；默认值：1'0；*/
/*description:设置此位以更新reg_div_num_lstime1和reg_lstimer1_lim。*/
...
/* LEDC_TICK_SEL_LSTIMER1:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为低速计时器1选择slow_clk或ref_tick。1’b1:slow_clk 0:ref_tick*/
...
/* LEDC_LSTIMER1_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*description:此位用于重置低速计时器1，重置后计数器将为0。*/
...
/* LEDC_LSTIMER1_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在低速计时器1中暂停计数器。*/
...
/* 发光二极管DIV_NUM_LSTIMER1:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置低速计时器1中除法器的参数，最低有效8位表示小数部分。*/
...
/* LEDC_LSTIMER1_LIM:R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制低速计时器1中计数器的范围。计数器范围为[0 2*reg_lstimer1_lim]，计数器的最大位宽为20。*/
...
/* LEDC_LSTIMER1_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器以获得低速计时器1中的当前计数器值。*/
...
/* LEDC_LSTIMER2_PARA_UP:R/W；位位置：[26]；默认值：1'0；*/
/*description:设置此位以更新reg_div_num_lstime2和reg_lstimer2_lim。*/
...
/* LEDC_TICK_SEL_LSTIMER2:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为低速时间2选择slow_clk或ref_tick。1’b1：slow_clk 0：ref_tick*/
...
/* LEDC_LSTIMER2_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*description:此位用于重置低速计时器2，重置后计数器将为0。*/
...
/* LEDC_LSTIMER2_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在低速计时器2中暂停计数器。*/
...
/* 发光二极管DIV_NUM_LSTIMER2:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置低速时间2分频器的参数，最低有效8位表示小数部分。*/
...
/* LEDC_LSTIMER2_LIM:R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制低速计时器2中计数器的范围。计数器范围为[0 2*reg_lstimer2_lim]，计数器的最大位宽为20。*/
...
/* LEDC_LSTIMER2_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器以获得低速计时器2的当前计数器值。*/
...
/* LEDC_LSTIMER3_PARA_UP:R/W；位位置：[26]；默认值：1'0；*/
/*description:设置此位以更新reg_div_num_lstime3和reg_lstimer3_lim。*/
...
/* LEDC_TICK_SEL_LSTIMER3:R/W；位位置：[25]；默认值：1’b0；*/
/*description:此位用于为低速时间r3选择slow_clk或ref_tick。1’b1:slow_clk 0:ref_tick*/
...
/* LEDC_LSTIMER3_RST:R/W；位位置：[24]；默认值：1’b1；*/
/*描述：此位用于重置低速计时器3，重置后计数器将为0。*/
...
/* LEDC_LSTIMER3_PAUSE：R/W；位位置：[23]；默认值：1’b0；*/
/*description:此位用于在低速计时器r3中暂停计数器。*/
...
/* 发光二极管DIV_NUM_LSTIMER3:R/W；比特位置：[22:5]；默认值：18'0；*/
/*描述：此寄存器用于配置低速计时器3中除法器的参数，最低有效8位表示小数部分。*/
...
/* LEDC_LSTIMER3_LIM:R/W；位位置：[4:0]；默认值：5'h0；*/
/*描述：此寄存器控制低速计时器r3中计数器的范围。计数器范围为[0 2*reg_lstimer3_lim]，计数器的最大位宽为20。*/
...
/* LEDC_LSTIMER3_CNT:RO；比特位置：[19:0]；默认值：20'b0；*/
/*描述：软件可以读取此寄存器以获取低速计时器r3中的当前计数器值。*/
...
/* LEDC_DUTY-CHNG_END_LSCH7_INT_RAW:RO；位位置：[23]；默认值：1’b0；*/
/*描述：低速通道7的中断原始位占空比更改完成。*/
...
/* LEDC_DUTY-CHNG_END_LSCH6_INT_RAW:RO；位位置：[22]；默认值：1’b0；*/
/*描述：低速通道6的中断原始位占空比更改完成。*/
...
/* LEDC_DUTY-CHNG_END_LSCH5_INT_RAW:RO；位位置：[21]；默认值：1’b0；*/
/*描述：低速通道5的中断原始位占空比更改完成。*/
...
/* LEDC_DUTY-CHNG_END_LSCH4_INT_RAW:RO；位位置：[20]；默认值：1’b0；*/
/*描述：完成低速通道4占空比更改的中断原始位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH3_INT_RAW:RO；位位置：[19]；默认值：1’b0；*/
/*描述：低速通道3的中断原始位占空比更改完成。*/
...
/* LEDC_DUTY-CHNG_END_LSCH2_INT_RAW:RO；位位置：[18]；默认值：1’b0；*/
/*描述：低速通道2占空比更改的中断原始位已完成。*/
...
/* LEDC_DUTY-CHNG_END_LSCH1_INT_RAW:RO；位位置：[17]；默认值：1’b0；*/
/*描述：低速通道1占空比更改的中断原始位已完成。*/
...
/* LEDC_DUTY-CHNG_END_LSCH0_INT_RAW:RO；位位置：[16]；默认值：1’b0；*/
/*描述：低速通道0占空比更改的中断原始位已完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH7_INT_RAW:RO；位位置：[15]；默认值：1’b0；*/
/*描述：高速通道7的中断原始位占空比更改完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH6_INT_RAW:RO；位位置：[14]；默认值：1’b0；*/
/*描述：高速通道6的中断原始位占空比更改完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH5_INT_RAW:RO；位位置：[13]；默认值：1’b0；*/
/*描述：高速通道5的中断原始位占空比更改完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH4_INT_RAW:RO；位位置：[12]；默认值：1’b0；*/
/*描述：高速通道4占空比更改的中断原始位已完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH3_INT_RAW:RO；位位置：[11]；默认值：1’b0；*/
/*描述：高速通道3占空比更改的中断原始位已完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH2_INT_RAW:RO；位位置：[10]；默认值：1’b0；*/
/*描述：高速通道2占空比更改的中断原始位已完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH1_INT_RAW:RO；位位置：[9]；默认值：1’b0；*/
/*描述：高速通道1占空比更改的中断原始位已完成。*/
...
/* LEDC_DUTY-CHNG_END_HSCH0_INT_RAW:RO；位位置：[8]；默认值：1’b0；*/
/*描述：高速通道0占空比更改的中断原始位已完成。*/
...
/* LEDC_LSTIMER3_OVF_INT_RAW:RO；位位置：[7]；默认值：1’b0；*/
/*description:低速通道3计数器溢出的中断原始位。*/
...
/* LEDC_LSTIMER2_OVF_INT_RAW:RO；位位置：[6]；默认值：1’b0；*/
/*description:低速通道2计数器溢出的中断原始位。*/
...
/* LEDC_LSTIMER1_OVF_INT_RAW:RO；位位置：[5]；默认值：1’b0；*/
/*description:低速通道1计数器溢出的中断原始位。*/
...
/* LEDC_LSTIMER0_off_INT_RAW:RO；位位置：[4]；默认值：1’b0；*/
/*description:低速通道0计数器溢出的中断原始位。*/
...
/* LEDC_HSTIMER3_OVF_INT_RAW:RO；位位置：[3]；默认值：1’b0；*/
/*description:高速通道3计数器溢出的中断原始位。*/
...
/* LEDC_HSTIMER2_OVF_INT_RAW:RO；位位置：[2]；默认值：1’b0；*/
/*description:高速通道2计数器溢出的中断原始位。*/
...
/* LEDC_HSTIMER1_OVF_INT_RAW:RO；位位置：[1]；默认值：1’b0；*/
/*description:高速通道1计数器溢出的中断原始位。*/
...
/* LEDC_HSTIMER0_off_INT_RAW:RO；位位置：[0]；默认值：1’b0；*/
/*description:高速通道0计数器溢出的中断原始位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH7_INT_ST:RO；位位置：[23]；默认值：1'0；*/
/*description:低速通道7占空比改变完成事件的中断状态位*/
...
/* LEDC_DUTY-CHNG_END_LSCH6_INT_ST:RO；位位置：[22]；默认值：1’b0；*/
/*描述：低速通道6占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH5_INT_ST:RO；位位置：[21]；默认值：1’b0；*/
/*description:低速通道5占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH4_INT_ST:RO；位位置：[20]；默认值：1’b0；*/
/*描述：低速通道4占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH3_INT_ST:RO；位位置：[19]；默认值：1’b0；*/
/*描述：低速通道3占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH2_INT_ST:RO；位位置：[18]；默认值：1’b0；*/
/*描述：低速通道2占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH1_INT_ST:RO；位位置：[17]；默认值：1’b0；*/
/*description:低速通道1占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH0_INT_ST:RO；位位置：[16]；默认值：1’b0；*/
/*description:低速通道0占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH7_INT_ST:RO；位位置：[15]；默认值：1’b0；*/
/*description:高速通道7占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH6_INT_ST:RO；位位置：[14]；默认值：1’b0；*/
/*描述：高速通道6占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH5_INT_ST:RO；位位置：[13]；默认值：1’b0；*/
/*description:高速通道5占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH4_INT_ST:RO；位位置：[12]；默认值：1’b0；*/
/*description:高速通道4占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH3_INT_ST:RO；位位置：[11]；默认值：1’b0；*/
/*description:高速通道3占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH2_INT_ST:RO；位位置：[10]；默认值：1’b0；*/
/*description:高速通道2占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH1_INT_ST:RO；位位置：[9]；默认值：1’b0；*/
/*description:高速通道1占空比改变完成事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH0_INT_ST:RO；位位置：[8]；默认值：1’b0；*/
/*description:高速通道0占空比改变完成事件的中断状态位。*/
...
/* led第一时间r3_OVF_INT_ST:RO；位位置：[7]；默认值：1’b0；*/
/*description:低速通道3计数器溢出事件的中断状态位。*/
...
/* 发光二极管LSTIMER2_OVF_INT_ST:RO；位位置：[6]；默认值：1’b0；*/
/*description:低速通道2计数器溢出事件的中断状态位。*/
...
/* 发光二极管_第一时间_第二时间_第三时间：RO；位位置：[5]；默认值：1’b0；*/
/*description:低速通道1计数器溢出事件的中断状态位。*/
...
/* LEDC_LSTIMER0_off_INT_ST:RO；位位置：[4]；默认值：1’b0；*/
/*description:低速通道0计数器溢出事件的中断状态位。*/
...
/* 指示灯HSTIMER3_OVF_INT_ST:RO；位位置：[3]；默认值：1’b0；*/
/*description:高速通道3计数器溢出事件的中断状态位。*/
...
/* 指示灯HSTIMER2_OVF_INT_ST:RO；位位置：[2]；默认值：1’b0；*/
/*description:高速通道2计数器溢出事件的中断状态位。*/
...
/* 指示灯HSTIMER1_OVF_INT_ST:RO；位位置：[1]；默认值：1’b0；*/
/*description:高速通道1计数器溢出事件的中断状态位。*/
...
/* LEDC_HSTIMER0_off_INT_ST:RO；位位置：[0]；默认值：1’b0；*/
/*description:高速通道0计数器溢出事件的中断状态位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH7_INT_ENA:R/W；位位置：[23]；默认值：1'0；*/
/*描述：低速通道7占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH6_INT_ENA:R/W；位位置：[22]；默认值：1’b0；*/
/*描述：低速通道6占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY_chg_END_LSCH5_INT_ENA:R/W；位位置：[21]；默认值：1’b0；*/
/*描述：低速通道5占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH4_INT_ENA:R/W；位位置：[20]；默认值：1’b0；*/
/*描述：低速通道4占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH3_INT_ENA:R/W；位位置：[19]；默认值：1’b0；*/
/*描述：低速通道3占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH2_INT_ENA:R/W；位位置：[18]；默认值：1’b0；*/
/*描述：低速通道2占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH1_INT_ENA:R/W；位位置：[17]；默认值：1’b0；*/
/*描述：低速通道1占空比改变完成中断的中断启用位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH0_INT_ENA:R/W；位位置：[16]；默认值：1’b0；*/
/*描述：低速通道0占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH7_INT_ENA:R/W；位位置：[15]；默认值：1’b0；*/
/*描述：高速通道7占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH6_INT_ENA:R/W；位位置：[14]；默认值：1’b0；*/
/*描述：高速通道6占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY_chg_END_HSCH5_INT_ENA:R/W；位位置：[13]；默认值：1’b0；*/
/*描述：高速通道5占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH4_INT_ENA:R/W；位位置：[12]；默认值：1’b0；*/
/*描述：高速通道4占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH3_INT_ENA:R/W；位位置：[11]；默认值：1’b0；*/
/*描述：高速通道3占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH2_INT_ENA:R/W；位位置：[10]；默认值：1’b0；*/
/*描述：高速通道2占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH1_INT_ENA:R/W；位位置：[9]；默认值：1’b0；*/
/*描述：高速通道1占空比改变完成中断的中断使能位。*/
...
/* LEDC_DUTY-CHNG_END_HSCH0_INT_ENA:R/W；位位置：[8]；默认值：1’b0；*/
/*描述：高速通道0占空比改变完成中断的中断使能位。*/
...
/* 指示灯LSTIMER3_OVF_INT_ENA：R/W；位位置：[7]；默认值：1’b0；*/
/*description:低速通道3计数器溢出中断的中断启用位。*/
...
/* 指示灯LSTIMER2_OVF_INT_ENA：R/W；位位置：[6]；默认值：1’b0；*/
/*description:低速通道2计数器溢出中断的中断启用位。*/
...
/* 发光二极管LSTIMER1_OVF_INT_ENA：R/W；位位置：[5]；默认值：1’b0；*/
/*description:低速通道1计数器溢出中断的中断启用位。*/
...
/* LEDC_LSTIMER0_off_INT_ENA:R/W；位位置：[4]；默认值：1’b0；*/
/*description:低速通道0计数器溢出中断的中断启用位。*/
...
/* 指示灯HSTIMER3_OVF_INT_ENA：R/W；位位置：[3]；默认值：1’b0；*/
/*description:高速通道3计数器溢出中断的中断启用位。*/
...
/* 指示灯HSTIMER2_OVF_INT_ENA：R/W；位位置：[2]；默认值：1’b0；*/
/*description:高速通道2计数器溢出中断的中断启用位。*/
...
/* 指示灯HSTIMER1_OVF_INT_ENA：R/W；位位置：[1]；默认值：1’b0；*/
/*description:高速通道1计数器溢出中断的中断启用位。*/
...
/* LEDC_HSTIMER0_off_INT_ENA:R/W；位位置：[0]；默认值：1’b0；*/
/*description:高速通道0计数器溢出中断的中断启用位。*/
...
/* LEDC_DUTY-CHNG_END_LSCH7_INT_CLR:WO；位位置：[23]；默认值：1'0；*/
/*description:设置此位以清除低速通道7占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_LSCH6_INT_CLR:WO；位位置：[22]；默认值：1’b0；*/
/*description:设置此位以清除低速通道6占空比改变完成中断。*/
...
/* LEDC_DUTY_chg_END_LSCH5_INT_CLR:WO；位位置：[21]；默认值：1’b0；*/
/*description:设置此位以清除低速通道5占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_LSCH4_INT_CLR:WO；位位置：[20]；默认值：1’b0；*/
/*description:设置此位以清除低速通道4占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_LSCH3_INT_CLR:WO；位位置：[19]；默认值：1’b0；*/
/*description:设置此位以清除低速通道3占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_LSCH2_INT_CLR:WO；位位置：[18]；默认值：1’b0；*/
/*description:设置此位以清除低速通道2占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_LSCH1_INT_CLR:WO；位位置：[17]；默认值：1’b0；*/
/*description:设置此位以清除低速通道1占空比改变完成中断。*/
...
/* LEDC_DUTY_chg_END_LSCH0_INT_CLR:WO；位位置：[16]；默认值：1’b0；*/
/*description:设置此位以清除低速通道0占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_HSCH7_INT_CLR:WO；位位置：[15]；默认值：1’b0；*/
/*description:设置此位以清除高速通道7占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_HSCH6_INT_CLR:WO；位位置：[14]；默认值：1’b0；*/
/*description:设置此位以清除高速通道6占空比改变完成中断。*/
...
/* LEDC_DUTY_chg_END_HSCH5_INT_CLR:WO；位位置：[13]；默认值：1’b0；*/
/*description:设置此位以清除高速通道5占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_HSCH4_INT_CLR:WO；位位置：[12]；默认值：1’b0；*/
/*description:设置此位以清除高速通道4占空比改变完成中断。*/
...
/* LEDC_DUTY_chg_END_HSCH3_INT_CLR:WO；位位置：[11]；默认值：1’b0；*/
/*description:设置此位以清除高速通道3占空比改变完成中断。*/
...
/* LEDC_DUTY-CHNG_END_HSCH2_INT_CLR:WO；位位置：[10]；默认值：1’b0；*/
/*description:设置此位以清除高速通道2占空比改变完成中断。*/
...
/* LEDC_DUTY_chg_END_HSCH1_INT_CLR:WO；位位置：[9]；默认值：1’b0；*/
/*description:设置此位以清除高速通道1占空比改变完成中断。*/
...
/* LEDC_DUTY_chg_END_HSCH0_INT_CLR:WO；位位置：[8]；默认值：1’b0；*/
/*description:设置此位以清除高速通道0占空比改变完成中断。*/
...
/* 发光二极管时间r3_OVF_INT_CLR:WO；位位置：[7]；默认值：1’b0；*/
/*description:设置此位以清除低速通道3计数器溢出中断。*/
...
/* 发光二极管_第一时间_第二时间_第三时间：WO；位位置：[6]；默认值：1’b0；*/
/*description:设置此位以清除低速通道2计数器溢出中断。*/
...
/* 发光二极管_第一时间_第二时间_第三时间：WO；位位置：[5]；默认值：1’b0；*/
/*description:设置此位以清除低速通道1计数器溢出中断。*/
...
/* LEDC_LSTIMER0_off_INT_CLR:WO；位位置：[4]；默认值：1’b0；*/
/*description:设置此位以清除低速通道0计数器溢出中断。*/
...
/* led时间r3_OVF_INT_CLR:WO；位位置：[3]；默认值：1’b0；*/
/*description:设置此位以清除高速通道3计数器溢出中断。*/
...
/* 发光二极管HSTIMER2_OVF_INT_CLR:WO；位位置：[2]；默认值：1’b0；*/
/*description:设置此位以清除高速通道2计数器溢出中断。*/
...
/* 发光二极管HSTIMER1_OVF_INT_CLR:WO；位位置：[1]；默认值：1’b0；*/
/*description:设置此位以清除高速通道1计数器溢出中断。*/
...
/* LEDC_HSTIMER0_off_INT_CLR:WO；位位置：[0]；默认值：1’b0；*/
/*description:设置此位以清除高速通道0计数器溢出中断。*/
...
/* 发光二极管APB_CLK_SEL:R/W；位位置：[0]；默认值：1’b0；*/
/*description:此位用于设置slow_clk的频率。1’b1:80mhz 1’b0:8mhz*/
...
/* led日期：R/W；位位置：[31:0]；默认值：32'h16031700；*/
/*description:此寄存器表示版本。*/
