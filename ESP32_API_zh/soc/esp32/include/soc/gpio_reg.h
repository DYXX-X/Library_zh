...
/* GPIO_BT_SEL:R/W；位位置：[31:0]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_OUT_DATA:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31输出值*/
...
/* GPIO_OUT_DATA_W1TS:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31输出值写入1设置*/
...
/* GPIO_OUT_DATA_W1TC:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31输出值写1清零*/
...
/* GPIO_OUT1_DATA:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39输出值*/
...
/* GPIO_OUT1_DATA_W1TS:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39输出值写入1设置*/
...
/* GPIO_OUT1_DATA_W1TC:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39输出值写1清零*/
...
/* GPIO_SDIO_SEL：R/W；位位置：[7:0]；默认值：x；*/
/*描述：SDIO PADS从外部打开/关闭控制*/
...
/* GPIO_ENABLE_DATA:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31输出使能*/
...
/* GPIO_ENABLE_DATA_W1TS:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31输出使能write 1 to set*/
...
/* GPIO_ENABLE_DATA_W1TC:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31输出使写1清零*/
...
/* GPIO_ENABLE1_DATA:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39输出使能*/
...
/* GPIO_ENABLE1_DATA_W1TS:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39输出使能write 1 to set*/
...
/* GPIO_ENABLE1_DATA_W1TC:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39输出使写1清零*/
...
/* GPIO_STRAPPING：RO；比特位置：[15:0]；默认值：；*/
/*描述：｛10'b0，MTDI，GPIO0，GPIO2，GPIO4，MTDO，GPIO5｝*/
...
/* GPIO_IN_DATA:RO；位位置：[31:0]；默认值：；*/
/*description:GPIO0~31输入值*/
...
/* GPIO_IN1_DATA:RO；位位置：[7:0]；默认值：；*/
/*description:GPIO32~39输入值*/
...
/* GPIO_STATUS_INT:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31中断状态*/
...
/* GPIO_STATUS_INT_W1TS:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31中断状态写入1设置*/
...
/* GPIO_STATUS_INT_W1TC:R/W；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31中断状态写1清除*/
...
/* GPIO_STATUS1_INT:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39中断状态*/
...
/* GPIO_STATUS1_INT_W1TS:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39中断状态写入1设置*/
...
/* GPIO_STATUS1_INT_W1TC:R/W；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39中断状态写1清除*/
...
/* GPIO_APPCPU_INT:RO；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31 APP CPU中断状态*/
...
/* GPIO_APPCPU_NMI_INT:RO；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31 APP CPU不可屏蔽中断状态*/
...
/* GPIO_PROCPU_INT:RO；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31 PRO CPU中断状态*/
...
/* GPIO_PROCPU_NMI_INT:RO；位位置：[31:0]；默认值：x；*/
/*description:GPIO0~31 PRO CPU不可屏蔽中断状态*/
...
/* GPIO_SDIO_INT:RO；位位置：[31:0]；默认值：x；*/
/*描述：SDIO的扩展GPIO0~31中断*/
...
/* GPIO_APPCPU_INT_H:RO；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39 APP CPU中断状态*/
...
/* GPIO_APPCPU_NMI_INT_H:RO；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39 APP CPU不可屏蔽中断状态*/
...
/* GPIO_PROCPU_INT_H:RO；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39 PRO CPU中断状态*/
...
/* GPIO_PROCPU_NMI_INT_H:RO；位位置：[7:0]；默认值：x；*/
/*description:GPIO32~39 PRO CPU不可屏蔽中断状态*/
...
/* GPIO_SDIO_INT-H:RO；位位置：[7:0]；默认值：x；*/
/*描述：SDIO的扩展GPIO32~39中断*/
...
/* GPIO_PIN0_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN0_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN0_awakeup_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN0_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
...
/* GPIO_PIN0_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
...
/* GPIO_PIN1_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_pin_配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_pin_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_pin_INT_TYPE：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_pin_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN2_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN2_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN2_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN3_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN3_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN3_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN4_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN4_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN4_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN4_INT类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN4_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN5_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN5_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN5_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN5_INT类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN5_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN6_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN6_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN6_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN6_INT类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN6_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN7_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN7配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN7_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN7类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN7_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN8_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN8配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN8_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN8_INT_TYPE：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN8_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN9_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN9配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN9_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN9_INT_TYPE：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN9_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN10_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN10_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN10唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN10_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN10_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN11_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN11配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN11唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN11_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN11_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN12_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN12配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN12唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN12_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN12-PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN13_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN13配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN13唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN13_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN13焊盘驱动程序：R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN14_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN14配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN14唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN14_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN14焊盘驱动程序：R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN15_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN15配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN15唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN15_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_pin15pad_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN16_INT_ENA：R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN16配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN16_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN16类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN16_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN17_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN17配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN17 _唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN17类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN17_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_peight_INT_ENA：R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_peight_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_p-188_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_p-188_INT_TYPE：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_peight_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_peing_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_p-19_INT_TYPE：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_p1919_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN20_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU非屏蔽中断启用位3：PRO CPU中断启用比特4：PRO CPU无屏蔽中断启用比特5：SDIO的范围中断启用*/
...
/* GPIO_PIN20_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN20_ewakeup_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN20_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN20_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN21_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN21_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN21_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN21_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN21_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN22_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*说明：*/
...
/* GPIO_PIN22_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_pin2_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN22_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN22_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*说明：*/
...
/* GPIO_PIN23_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN23_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN23唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN23_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN23_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN24_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN24_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN24唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN24_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN24_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN25_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN25_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN25唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN25_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN25_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN26_INT_ENA：R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN26_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN26_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN26_INT_TYPE：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN26_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN27_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN27配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN27_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN27类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN27_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN28_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN28配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN28_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN28类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN28_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN29_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN29配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN29_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN29类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN29_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN30_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN30_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN30_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN30_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN30_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN31_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN31_CONFIG:R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN31_唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN31_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN31_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN32_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN32配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN32唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN32_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN32_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_pin3_INT类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_pin3_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN34_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN34配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN34唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN34_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN34_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN35_INT_ENA:R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN35配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN35唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN35_INT_TYPE:R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_pin35pad_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN36_INT_ENA：R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN36配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN36_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN36类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN36_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN37_INT_ENA：R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN37配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN37 _唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN37类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN37_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN38_INT_ENA：R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN38配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN38_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN38类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN38_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_PIN39_INT_ENA：R/W；比特位置：[17:13]；默认值：x；*/
/*description:bit0：APP CPU中断启用位1：APP CPU不可屏蔽中断启用位3：PRO CPU中断启用位数4：PRO CPU不可掩码中断启用位5：SDIO的范围中断启用*/
...
/* GPIO_PIN39配置：R/W；比特位置：[12:11]；默认值：x；*/
/*说明：不适用*/
...
/* GPIO_PIN39 _唤醒启用：R/W；位位置：[10]；默认值：x；*/
/*描述：GPIO唤醒启用仅在浅睡眠时可用*/
...
/* GPIO_PIN39类型：R/W；比特位置：[9:7]；默认值：x；*/
/*描述：如果设置为0：GPIO中断禁用如果设置为1：上升沿触发如果设置为2：下降沿触发如果如果设置为3：任何边缘触发如果设置设置为4：低电平触发如果设置成5：高电平触发*/
...
/* GPIO_PIN39_PAD_DRIVER:R/W；位位置：[2]；默认值：x；*/
/*描述：如果设置为0：正常输出如果设置为1：漏极开路*/
...
/* GPIO_CALI_RDY_SYNC2:RO；位位置：[31]；默认值：；*/
/*说明：*/
...
/* GPIO_CALI_RDY_REAL:RO；位位置：[30]；默认值：；*/
/*说明：*/
...
/* GPIO_CALI_VALUE_SYNC2:RO；比特位置：[19:0]；默认值：；*/
/*说明：*/
...
/* GPIO_SIG0_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
#define GPIO_SIG0_IN_SEL  (BIT(7))
#define GPIO_SIG0_IN_SEL_M  (BIT(7))
#define GPIO_SIG0_IN_SEL_V  0x1
#define GPIO_SIG0_IN_SEL_S  7
/* GPIO_FUNC0_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC0_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC1_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC2_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC3_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC4_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC5_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC6_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC7_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC8_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC9_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC10_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC11_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC12_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC13_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC14_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC15_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC16_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC17_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC18_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC19_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC20_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC21_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC22_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC23_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC24_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC25_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC26_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC27_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC28_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC29_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC30_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC31_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC32_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC33_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC34_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC35_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC36_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC37_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC38_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC39_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC40_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC41_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC42_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC43_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC44_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC45_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC46_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC47_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC48_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC49_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC50_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC51_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC52_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC53_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC54_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC55_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC56_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC57_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC58_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC59_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC60_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC61_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC62_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC63_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC64_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC65_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC66_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC67_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC68_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC69_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC70_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC71_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC72_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC73_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC74_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC75_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC76_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC77_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC78_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC79_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC80_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC81_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC82_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC83_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC84_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC85_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC86_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC87_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC88_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC89_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC90_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC91_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC92_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC93_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC94_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC95_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC96_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC97_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC98_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC99_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG100_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC100_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC100_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG101_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC101_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC101_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG102_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC102_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC102_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG103_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC103_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC103_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG104_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC104_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC104_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG105_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC105_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC105_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG106_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC106_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC106_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG107_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC107_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC107_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG108_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC108_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC108_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG109_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC109_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC109_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG110_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC110_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC110_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG111_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC111_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC111_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG112_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC112_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC112_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG113_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC113_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC113_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG114_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC114_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC114_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG115_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC115_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC115_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG116_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC116_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC116_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG117_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC117_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC117_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG118_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC118_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC118_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG119_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC119_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC119_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG120_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC120_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC120_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG121_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC121_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC121_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG122_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC122_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC122_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG123_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC123_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC123_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG124_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC124_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC124_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG125_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC125_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC125_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG126_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC126_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC126_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG127_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC127_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC127_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG128_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC128_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC128_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG129_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC129_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC129_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG130_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC130_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC130_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG131_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC131_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC131_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG132_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC132_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC132_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG133_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC133_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC133_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG134_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC134_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC134_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG135_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC135_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC135_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG136_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC136_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC136_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG137_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC137_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC137_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG138_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC138_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC138_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG139_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC139_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC139_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG140_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC140_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC140_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG141_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC141_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC141_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG142_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC142_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC142_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG143_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC143_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC143_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG144_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC144_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC144_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG145_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC145_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC145_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG146_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC146_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC146_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG147_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC147_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC147_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG148_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC148_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC148_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG149_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC149_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC149_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG150_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC150_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC150_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG151_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC151_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC151_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG152_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC152_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC152_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG153_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC153_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC153_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG154_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC154_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC154_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG155_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC155_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC155_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG156_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC156_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC156_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG157_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC157_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC157_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG158_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC158_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC158_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG159_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC159_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC159_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG160_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC160_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC160_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG161_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC161_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC161_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG162_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC162_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC162_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG163_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC163_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC163_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG164_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC164_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC164_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG165_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC165_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC165_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG166_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC166_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC166_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG167_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC167_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC167_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG168_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC168_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC168_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG169_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC169_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC169_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG170_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC170_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC170_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG171_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC171_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC171_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG172_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC172_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC172_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG173_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC173_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC173_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG174_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC174_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC174_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG175_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC175_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC175_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG176_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC176_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC176_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG177_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC177_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC177_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG178_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC178_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC178_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG179_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC179_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC179_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG180_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC180_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC180_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG181_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC181_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC181_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG182_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC182_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC182_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG183_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC183_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC183_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG184_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC184_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC184_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG185_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC185_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC185_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG186_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC186_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC186_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG187_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC187_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC187_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG188_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC188_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC188_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG189_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC189_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC189_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG190_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC190_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC190_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG191_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC191_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC191_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG192_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC192_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC192_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG193_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC193_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC193_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG194_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC194_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC194_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG195_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC195_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC195_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG196_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC196_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC196_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG197_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC197_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC197_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG198_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC198_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC198_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG199_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC199_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC199_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG200_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC200_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC200_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG201_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC201_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC201_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_sig02_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC202_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC202_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG203_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC203_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC203_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG204_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC204_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC204_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG205_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC205_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC205_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG206_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC206_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC206_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG207_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC207_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC207_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG208_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC208_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC208_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG209_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC209_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC209_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG210_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC210_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC210_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG211_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC211_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC211_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG212_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC212_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC212_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG213_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC213_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC213_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG214_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC214_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC214_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG215_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC215_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC215_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG216_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC216_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC216_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG217_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC217_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC217_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG218_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC218_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC218_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG219_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC219_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC219_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG220_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC220_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC220_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC221_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC221_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG222_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC222_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC222_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG223_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC223_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC223_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG224_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC224_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC224_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG225_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC225_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC225_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG226_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC226_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC226_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG227_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC227_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC227_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC228_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC228_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG229_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC229_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC229_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG230_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC230_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC230_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG231_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC231_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC231_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG232_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC232_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC232_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG233_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC233_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC233_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG234_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC234_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC234_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG235_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC235_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC235_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG236_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC236_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC236_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG237_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC237_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC237_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG238_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC238_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC238_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG239_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC239_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC239_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG240_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC240_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC240_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG241_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC241_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC241_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG242_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC242_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC242_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG243_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC243_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC243_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG244_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC244_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC244_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG245_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC245_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC245_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG246_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC246_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC246_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG247_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC247_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC247_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG248_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC248_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC248_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG249_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC249_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC249_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG250_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC250_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC250_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG251_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC251_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC251_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG252_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC252_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC252_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG253_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC253_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC253_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG254_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC254_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC254_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_SIG255_IN_SEL:R/W；位位置：[7]；默认值：x；*/
/*描述：如果要将值设置为1，则慢信号是否绕过io矩阵*/
...
/* GPIO_FUNC255_IN_INV_SEL:R/W；位位置：[6]；默认值：x；*/
/*description:还原输入值如果要还原，请将值设置为1*/
...
/* GPIO_FUNC255_IN_SEL:R/W；比特位置：[5:0]；默认值：x；*/
/*description:从256个输入中选择一个*/
...
/* GPIO_FUNC0_on_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC0_on_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC0_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC0_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC1_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC1_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC1_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC1_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC2_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC2_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC2_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC2_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC3_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC3_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC3_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC3_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC4_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC4_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC4_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC4_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC5_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC5_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC5_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC5_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC6_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC6_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC6_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC6_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC7_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC7_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC7_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC7_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC8_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC8_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC8_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC8_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC9_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC9_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC9_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC9_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC10_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC10_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC10_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC10_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC11_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC11_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC11_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC11_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC12_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC12_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC12_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC12_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC13_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC13_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC13_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC13_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC14_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC14_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC14_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC14_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC15_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC15_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC15_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC15_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC16_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC16_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC16_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC16_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC17_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC17_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC17_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC17_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC18_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC18_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC18_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC18_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC19_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC19_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC19_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC19_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC20_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC20_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC20_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC20_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC21_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC21_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC21_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC21_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC22_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC22_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC22_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC22_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC23_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC23_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC23_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC23_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC24_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC24_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC24_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC24_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC25_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC25_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC25_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC25_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC26_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC26_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC26_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC26_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC27_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC27_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC27_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC27_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC28_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC28_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC28_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC28_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC29_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC29_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC29_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC29_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC30_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC30_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC30_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC30_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC31_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC31_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC31_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC31_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC32_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC32_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC32_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC32_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC33_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC33_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC33_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC33_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC34_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC34_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC34_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC34_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC35_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC35_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC35_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC35_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC36_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC36_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC36_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC36_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC37_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC37_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC37_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC37_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC38_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC38_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC38_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC38_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
...
/* GPIO_FUNC39_OEN_INV_SEL:R/W；位位置：[11]；默认值：x；*/
/*描述：如果要将输出启用值设置为1，则反转输出启用值*/
...
/* GPIO_FUNC39_OEN_SEL:R/W；位位置：[10]；默认值：x；*/
/*描述：天气使用逻辑oen信号或不使用寄存器设置的值*/
...
/* GPIO_FUNC39_OUT_INV_SEL:R/W；位位置：[9]；默认值：x；*/
/*描述：如果要将输出值设置为1，则反转输出值*/
...
/* GPIO_FUNC39_OUT_SEL:R/W；位位置：[8:0]；默认值：x；*/
/*description:从256个输出中选择一个输出到40个GPIO*/
