...
/*描述：1:sar_sel将由16位输出数据的MSB编码，在这种情况下，解不应大于11位。。*/
...
/*description:0:SAR1，1:SAR2，仅适用于单SAR模式。*/
...
/*描述：1:DIG ADC2 CTRL的数据被反转，否则不反转。*/
...
/*描述：1:DIG ADC1 CTRL的数据被反转，否则不反转。*/
...
/* APB_SARADC_FILTER_FACTOR0:R/W；位位置：[31:29]；默认值：3'd0；*/
/*描述：。*/
...
/* APB_SARADC_FILTER_FACTOR1:R/W；位位置：[28:26]；默认值：3'd0；*/
/*描述：。*/
...
/* APB_SARADC_SAR1_PATT_TAB1:R/W；比特位置：[23:0]；默认值：24小时；*/
/*描述：模式表1的项目0~3（每个项目一个字节）。*/
...
/* APB_SARADC_SAR1_PATT_TAB2:R/W；比特位置：[23:0]；默认值：24小时；*/
...
/* APB_SARADC_SAR1_PATT_TAB3:R/W；比特位置：[23:0]；默认值：24小时；*/
...
/* APB_SARADC_SAR1_PATT_TAB4:R/W；比特位置：[23:0]；默认值：24小时；*/
...
/* APB_SARADC_SAR2_PATT_TAB1:R/W；比特位置：[23:0]；默认值：24小时；*/
/*描述：模式表2的项目0~3（每个项目一个字节）。*/
...
/* APB_SARADC_SAR2_PATT_TAB2:R/W；比特位置：[23:0]；默认值：24小时；*/
...
/* APB_SARADC_SAR2_PATT_TAB3:R/W；比特位置：[23:0]；默认值：24小时；*/
...
/* APB_SARADC_SAR2_PATT_TAB4:R/W；比特位置：[23:0]；默认值：24小时；*/
...
/* APB_SARADC_FILTER_RESET:R/W；位位置：[31]；默认值：1’b0；*/
...
/* APB_SARADC_FILTER_CHANNEL0:R/W；比特位置：[23:19]；默认值：5’hd；*/
...
/* APB_SARADC_FILTER_CHANNEL1:R/W；比特位置：[18:14]；默认值：5’hd；*/
/*描述：。*/
...
/* APB_SARADC_add1_DATA:RO；位位置：[16:0]；默认值：17'd0；*/
/*描述：。*/
...
/* APB_SARADC_threes0_LOW:R/W；比特位置：[30:18]；默认值：13'd0；*/
/*描述：saradc1的thres0监视器thres。*/
...
/* APB_SARADC_threes0_高：R/W；比特位置：[17:5]；默认值：13'h1ff；*/
/*描述：saradc1的thres0监视器thres。*/
...
/* APB_SARADC_threes0_通道：R/W；位位置：[4:0]；默认值：5'd13；*/
/*描述：。*/
...
/* APB_SARADC_threes1_LOW:R/W；比特位置：[30:18]；默认值：13'd0；*/
/*描述：saradc1的thres0监视器thres。*/
...
/* APB_SARADC_threes1_HIGH:R/W；比特位置：[17:5]；默认值：13'h1ff；*/
/*描述：saradc1的thres0监视器thres。*/
...
/* APB_SARADC_threes1_CHANNEL:R/W；位位置：[4:0]；默认值：5'd13；*/
/*描述：。*/
...
/* APB_SARADC_threes0_EN:R/W；位位置：[31]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes1_EN:R/W；位位置：[30]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes2_EN:R/W；位位置：[29]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes3_EN:R/W；位位置：[28]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes_ALL_EN:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_HIGH_INT_ENA:R/W；位位置：[29]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_HIGH_INT_ENA:R/W；位位置：[28]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_LOW_INT_ENA:R/W；位位置：[27]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes_1_LOW_INT_ENA:R/W；位位置：[26]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_HIGH_INT_RAW:RO；位位置：[29]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes1_HIGH_INT_RAW:RO；位位置：[28]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes_LOW_INT_RAW:RO；位位置：[27]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes1_LOW_INT_RAW:RO；位位置：[26]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_HIGH_INT_ST:RO；位位置：[29]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes1_HIGH_INT_ST:RO；位位置：[28]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes0_LOW_INT_ST:RO；位位置：[27]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_LOW_INT_ST:RO；位位置：[26]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_HIGH_INT_CLR:WO；位位置：[29]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_HIGH_INT_CLR:WO；位位置：[28]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_threes0_LOW_INT_CLR:WO；位位置：[27]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_thresholds_LOW_INT_CLR:WO；位位置：[26]；默认值：1’b0；*/
/*描述：。*/
...
/* APB_SARADC_CLK_EN:R/W；位位置：[20]；默认值：1'd0；*/
/*描述：。*/
...
/* APB_sarac_ADC2_DATA:RO；位位置：[16:0]；默认值：17'd0；*/
/*描述：。*/
...
/* APB_sarac_APB_CTRL_DATE:R/W；位位置：[31:0]；默认值：32'h02101180；*/
/*描述：。*/
