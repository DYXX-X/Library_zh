...
typedef volatile struct gpio_dev_s {
    ...
    uint32_t pcpu_int;                                            /*GPIO0~31 PRO&APP CPU中断状态*/
    uint32_t pcpu_nmi_int;                                        /*GPIO0~31 PRO&APP CPU不可屏蔽中断状态*/
    uint32_t cpusdio_int;
    union {
        struct {
            uint32_t intr                          :    22;       /*GPIO32-48 PRO&APP CPU中断状态*/
            uint32_t reserved22                    :    10;
        };
        uint32_t val;
    } pcpu_int1;
    union {
        struct {
            uint32_t intr                          :    22;       /*GPIO32-48 PRO&APP CPU不可屏蔽中断状态*/
            uint32_t reserved22                    :    10;
        };
        uint32_t val;
    } pcpu_nmi_int1;
