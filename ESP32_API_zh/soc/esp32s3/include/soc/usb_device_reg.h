...
/* USB_DEVICE_RDWR_BYTE:R/W；位位置：[7:0]；默认值：8'0；*/
/*description:通过此字段向UART Tx/Rx FIFO写入和读取字节数据。当设置了USB_DEVICE_SERIAL_IN_EMPTY_INT时，用户可以将数据（最多64字节）写入UART Tx FIFO。当设置了USB_DEVICE_SERIAL_OUT_RECV_PKT_INT时，用户可以检查USB_DEVICE-OUT_EP1_WR_ADDR USB_DEVICE_OUT_EP0_RD_ADDR以了解接收到多少数据，然后从UART Rx FIFO读取数据。。*/
...
/* USB_DEVICE_SERIAL_OUT_EP_DATA_AVAIL:RO；位位置：[2]；默认值：1’b0；*/
...
/* USB_DEVICE_SERIAL_IN_EP_DATA_FREE：RO；位位置：[1]；默认值：1’b1；*/
/*description:1’b1：表示UART Tx FIFO未满，可以将数据写入。写入USB_DEVICE_WR_DONE后，该位将为0，直到USB主机读取UART Tx FIFO中的数据。。*/
...
/* USB_DEVICE_WR_DONE:WT；位位置：[0]；默认值：1’b0；*/
...
/* USB_DEVICE_OUT_EP2_ZERO_paiload_INT_RAW:R/WTC/SS；位位置：[11]；默认值：1’b0；*/
...
/* USB_DEVICE_OUT_EP1_ZERO_paiload_INT_RAW:R/WTC/SS；位位置：[10]；默认值：1’b0；*/
...
/* USB_DEVICE_USB_BUS_RESET_INT_RAW:R/WTC/SS；位位置：[9]；默认值：1’b0；*/
...
/* USB_DEVICE_IN_TOKEN_REC_IN_EP1_INT_RAW:R/WTC/SS；位位置：[8]；默认值：1’b0；*/
...
/* USB_DEVICE_STUFF_ERR_INT_RAW:R/WTC/SS；位位置：[7]；默认值：1’b0；*/
...
/* USB_DEVICE_CRC16_ERR_INT_RAW:R/WTC/SS；位位置：[6]；默认值：1’b0；*/
...
/* USB_DEVICE_CRC5_ERR_INT_RAW:R/WTC/SS；位位置：[5]；默认值：1’b0；*/
...
/* USB_DEVICE_PID_ERR_INT_RAW:R/WTC/SS；位位置：[4]；默认值：1’b0；*/
...
/* USB_DEVICE_SERIAL_IN_EMPTY_INT_RAW:R/WTC/SS；位位置：[3]；默认值：1’b1；*/
...
/* USB_DEVICE_SERIAL_OUT_RECV_PKT_INT_RAW:R/WTC/SS；位位置：[2]；默认值：1’b0；*/
...
/* USB_DEVICE_SOF_INT_RAW:R/WTC/SS；位位置：[1]；默认值：1’b0；*/
...
/* USB_DEVICE_JTAG_IN_FLUSH_INT_RAW:R/WTC/SS；位位置：[0]；默认值：1’b0；*/
...
/* USB_DEVICE_OUT_EP2_ZERO_paiload_INT_ST:RO；位位置：[11]；默认值：1’b0；*/
/*description:USB_DEVICE_OUT_EP2_ZERO_PAYLOAD_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_OUT_EP1_ZERO_paiload_INT_ST:RO；位位置：[10]；默认值：1’b0；*/
/*description:USB_DEVICE_OUT_EP1_ZERO_PAYLOAD_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_USB_BUS_RESET_INT_ST:RO；位位置：[9]；默认值：1’b0；*/
/*description:USB_DEVICE_USB_BUS_RESET_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_IN_TOKEN_REC_IN_EP1_INT_ST:RO；位位置：[8]；默认值：1’b0；*/
/*description:USB_DEVICE_IN_TOKEN_REC_IN_EP1_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_STUFF_ERR_INT_ST:RO；位位置：[7]；默认值：1’b0；*/
/*description:USB_DEVICE_STUFF_ERROR_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_CRC16_ERR_INT_ST:RO；位位置：[6]；默认值：1’b0；*/
/*description:USB_DEVICE_CRC16_ERROR_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_CRC5_ERR_INT_ST:RO；位位置：[5]；默认值：1’b0；*/
/*description:USB_DEVICE_CRC5_ERR_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_PID_ERR_INT_ST:RO；位位置：[4]；默认值：1’b0；*/
/*description:USB_DEVICE_PID_ERR_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_SERIAL_IN_EMPTY_INT_ST:RO；位位置：[3]；默认值：1’b0；*/
/*description:USB_DEVICE_SERIAL_IN_EMPTY_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_SERIAL_OUT_RECV_PKT_INT_ST:RO；位位置：[2]；默认值：1’b0；*/
/*description:USB_DEVICE_SERIAL_OUT_RECV_PKT_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_SOF_INT_ST:RO；位位置：[1]；默认值：1’b0；*/
/*description:USB_DEVICE_SOF_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_JTAG_IN_FLUSH_INT_ST:RO；位位置：[0]；默认值：1’b0；*/
/*description:USB_DEVICE_JTAG_IN_FLUSH_INT中断的原始中断状态位。。*/
...
/* USB_DEVICE_OUT_EP2_ZERO_paiload_INT_ENA:R/W；位位置：[11]；默认值：1’b0；*/
/*description:USB_DEVICE_OUT_EP2_ZERO_PAYLOAD_INT中断的中断启用位。。*/
...
/* USB_DEVICE_OUT_EP1_ZERO_paiload_INT_ENA:R/W；位位置：[10]；默认值：1’b0；*/
/*description:USB_DEVICE_OUT_EP1_ZERO_PAYLOAD_INT中断的中断启用位。。*/
...
/* USB_DEVICE_USB_BUS_RESET_INT_ENA:R/W；位位置：[9]；默认值：1’b0；*/
/*description:USB_DEVICE_USB_BUS_RESET_INT中断的中断启用位。。*/
...
/* USB_DEVICE_IN_TOKEN_REC_IN_EP1_INT_ENA:R/W；位位置：[8]；默认值：1’b0；*/
/*description:USB_DEVICE_IN_TOKEN_REC_IN_EP1_INT中断的中断启用位。。*/
...
/* USB_DEVICE_STUFF_ERR_INT_ENA:R/W；位位置：[7]；默认值：1’b0；*/
/*description:USB_DEVICE_STUFF_ERROR_INT中断的中断启用位。。*/
...
/* USB_DEVICE_CRC16_ERR_INT_ENA:R/W；位位置：[6]；默认值：1’b0；*/
/*description:USB_DEVICE_CRC16_ERROR_INT中断的中断启用位。。*/
...
/* USB_DEVICE_CRC5_ERR_INT_ENA：R/W；位位置：[5]；默认值：1’b0；*/
/*description:USB_DEVICE_CRC5_ERR_INT中断的中断启用位。。*/
...
/* USB_DEVICE_PID_ERR_INT_ENA:R/W；位位置：[4]；默认值：1’b0；*/
/*description:USB_DEVICE_PID_ERR_INT中断的中断启用位。。*/
...
/* USB_DEVICE_SERIAL_IN_EMPTY_INT_ENA:R/W；位位置：[3]；默认值：1’b0；*/
/*description:USB_DEVICE_SERIAL_IN_EMPTY_INT中断的中断启用位。。*/
...
/* USB_DEVICE_SERIAL_OUT_RECV_PKT_INT_ENA:R/W；位位置：[2]；默认值：1’b0；*/
/*description:USB_DEVICE_SERIAL_OUT_RECV_PKT_INT中断的中断启用位。。*/
...
/* USB_DEVICE_SOF_INT_ENA：R/W；位位置：[1]；默认值：1’b0；*/
/*description:USB_DEVICE_SOF_INT中断的中断启用位。。*/
...
/* USB_DEVICE_JTAG_IN_FLUSH_INT_ENA:R/W；位位置：[0]；默认值：1’b0；*/
/*description:USB_DEVICE_JTAG_IN_FLUSH_INT中断的中断启用位。。*/
...
/* USB_DEVICE_OUT_EP2_ZERO_paiload_INT_CLR:WT；位位置：[11]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_OUT_EP2_ZERO_PAYLOAD_INT中断。。*/
...
/* USB_DEVICE_OUT_EP1_ZERO_paiload_INT_CLR:WT；位位置：[10]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_OUT_EP1_ZERO_PAYLOAD_INT中断。。*/
...
/* USB_DEVICE_USB_BUS_RESET_INT_CLR:WT；位位置：[9]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_USB_BUS_RESET_INT中断。。*/
...
/* USB_DEVICE_IN_TOKEN_REC_IN_EP1_INT_CLR:WT；位位置：[8]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_IN_TOKEN_IN_EP1_INT中断。。*/
...
/* USB_DEVICE_STUFF_ERR_INT_CLR:WT；位位置：[7]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_STUFF_ERROR_INT中断。。*/
...
/* USB_DEVICE_CRC16_ERR_INT_CLR:WT；位位置：[6]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_CRC16_ERROR_INT中断。。*/
...
/* USB_DEVICE_CRC5_ERR_INT_CLR:WT；位位置：[5]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_CRC5_ERR_INT中断。。*/
...
/* USB_DEVICE_PID_ERR_INT_CLR:WT；位位置：[4]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_PID_ERR_INT中断。。*/
...
/* USB_DEVICE_SERIAL_IN_EMPTY_INT_CLR:WT；位位置：[3]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_SERIAL_IN_EMPTY_INT中断。。*/
...
/* USB_DEVICE_SERIAL_OUT_RECV_PKT_INT_CLR:WT；位位置：[2]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_SERIAL_OUT_RECV_PKT_INT中断。。*/
...
/* USB_DEVICE_SOF_INT_CLR:WT；位位置：[1]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_JTAG_SOF_INT中断。。*/
...
/* USB_DEVICE_JTAG_IN_FLUSH_INT_CLR:WT；位位置：[0]；默认值：1’b0；*/
/*description:设置此位以清除USB_DEVICE_JTAG_IN_FLUSH_INT中断。。*/
...
/* USB_DEVICE_PHY_TX_EDGE_SEL:R/W；位位置：[15]；默认值：1’b0；*/
...
/* USB_DEVICE_USB_PAD_ENABLE:R/W；位位置：[14]；默认值：1’b1；*/
...
/* USB_DEVICE_PULLUP_VALUE:R/W；位位置：[13]；默认值：1’b0；*/
/*description:控制上拉值。。*/
...
/* USB_DEVICE_DM_PULLDOWN:R/W；位位置：[12]；默认值：1’b0；*/
...
/* USB_DEVICE_DM_PULLUP:R/W；位位置：[11]；默认值：1’b0；*/
...
/* USB_DEVICE_DP_PULLDOWN:R/W；位位置：[10]；默认值：1’b0；*/
/*description:控制USB D+下拉。。*/
...
/* USB_DEVICE_DP_PULLUP:R/W；位位置：[9]；默认值：1’b1；*/
/*description:控制USB D+上拉。。*/
...
/* USB_DEVICE_PAD_PULL_OVERRIDE:R/W；位位置：[8]；默认值：1’b0；*/
...
/* USB_DEVICE_VREF_OVERRIDE:R/W；位位置：[7]；默认值：1’b0；*/
...
/* USB_DEVICE_VREFL:R/W；比特位置：[6:5]；默认值：2’b0；*/
...
/* USB_DEVICE_VREFH:R/W；位位置：[4:3]；默认值：2’b0；*/
...
/* USB_DEVICE_EXCHG_PINS：R/W；位位置：[2]；默认值：1’b0；*/
/*描述：USB D+D-交换。*/
...
/* USB_DEVICE_EXCHG_PINS_OVERRIDE:R/W；位位置：[1]；默认值：1’b0；*/
...
/* USB_DEVICE_PHY_SEL:R/W；位位置：[0]；默认值：1’b0；*/
...
/* USB_DEVICE_TEST_RX_DM:RO；位位置：[6]；默认值：1’b0；*/
...
/* USB_DEVICE_TEST_RX_DP:RO；位位置：[5]；默认值：1’b0；*/
/*描述：测试中的USB D+rx值。*/
...
/* USB_DEVICE_TEST_RX_RCV:RO；位位置：[4]；默认值：1’b0；*/
/*描述：测试中的USB差分rx值。*/
...
/* USB_DEVICE_TEST_TX_DM:R/W；位位置：[3]；默认值：1’b0；*/
...
/* USB_DEVICE_TEST_TX_DP:R/W；位位置：[2]；默认值：1’b0；*/
/*description:测试中的USB D+tx值。*/
...
/* USB_DEVICE_TEST_USB_OE:R/W；位位置：[1]；默认值：1’b0；*/
/*描述：USB pad正在测试中。*/
...
/* USB_DEVICE_TEST_ENABLE:R/W；位位置：[0]；默认值：1’b0；*/
...
/* USB_DEVICE_OUT_FIFO_RESET:R/W；位位置：[9]；默认值：1’b0；*/
...
/* USB_DEVICE_IN_FIFO_RESET:R/W；位位置：[8]；默认值：1’b0；*/
...
/* USB_DEVICE_OUT_FIFO_FULL:RO；位位置：[7]；默认值：1’b0；*/
/*描述：1:JTAG输出fifo已满。。*/
...
/* USB_DEVICE_OUT_FIFO_EMPTY:RO；位位置：[6]；默认值：1’b1；*/
...
/* USB_DEVICE_OUT_FIFO_CNT:RO；比特位置：[5:4]；默认值：2'd0；*/
...
/* USB_DEVICE_IN_FIFO_FULL:RO；位位置：[3]；默认值：1’b0；*/
/*描述：1:fifo中的JTAG已满。。*/
...
/* USB_DEVICE_IN_FIFO_EMPTY:RO；位位置：[2]；默认值：1’b1；*/
...
/* USB_DEVICE_IN_FIFO_CNT:RO；位位置：[1:0]；默认值：2'd0；*/
...
/* USB_DEVICE_SOF_FRAME_INDEX:RO；位位置：[10:0]；默认值：11'd0；*/
...
/* USB_DEVICE_IN_EP0_RD_ADDR:RO；比特位置：[15:9]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP0_WR_ADDR:RO；比特位置：[8:2]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP0_STATE:RO；位位置：[1:0]；默认值：2'b1；*/
...
/* USB_DEVICE_IN_EP1_RD_ADDR:RO；比特位置：[15:9]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP1_WR_ADDR:RO；比特位置：[8:2]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP1_STATE:RO；位位置：[1:0]；默认值：2'b1；*/
...
/* USB_DEVICE_IN_EP2_RD_ADDR:RO；比特位置：[15:9]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP2_WR_ADDR:RO；比特位置：[8:2]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP2_STATE:RO；位位置：[1:0]；默认值：2'b1；*/
...
/* USB_DEVICE_IN_EP3_RD_ADDR:RO；比特位置：[15:9]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP3_WR_ADDR:RO；比特位置：[8:2]；默认值：7'd0；*/
...
/* USB_DEVICE_IN_EP3_STATE:RO；位位置：[1:0]；默认值：2'b1；*/
...
/* USB_DEVICE_OUT_EP0_RD_ADDR:RO；比特位置：[15:9]；默认值：7'd0；*/
...
/* USB_DEVICE_OUT_EP0_WR_ADDR:RO；比特位置：[8:2]；默认值：7'd0；*/
/*description:写入OUT端点0的数据地址。当检测到USB_DEVICE_SERIAL_OUT_RECV_PKT_INT时，OUT EP0中有USB_DEVICE-OUT_EP0_WR_ADDR-2字节数据。。*/
...
/* USB_DEVICE_OUT_EP0_STATE:RO；位位置：[1:0]；默认值：2’b0；*/
...
/* USB_DEVICE_OUT_EP1_REC_DATA_CNT:RO；比特位置：[22:16]；默认值：7'd0；*/
...
/* USB_DEVICE_OUT_EP1_RD_ADDR:RO；比特位置：[15:9]；默认值：7'd0；*/
...
/* USB_DEVICE_OUT_EP1_WR_ADDR:RO；比特位置：[8:2]；默认值：7'd0；*/
/*description:写入OUT端点1的数据地址。当检测到USB_DEVICE_SERIAL_OUT_RECV_PKT_INT时，OUT EP1中有USB_DEVICE-OUT_EP1_WR_ADDR-2字节数据。。*/
...
/* USB_DEVICE_OUT_EP1_STATE:RO；位位置：[1:0]；默认值：2’b0；*/
...
/* USB_DEVICE_OUT_EP2_RD_ADDR:RO；比特位置：[15:9]；默认值：7'd0；*/
...
/* USB_DEVICE_OUT_EP2_WR_ADDR:RO；比特位置：[8:2]；默认值：7'd0；*/
/*description:写入OUT端点2的数据地址。当检测到USB_DEVICE_SERIAL_OUT_RECV_PKT_INT时，OUT EP2中有USB_DEVICE-OUT_EP2_WR_ADDR-2字节数据。。*/
...
/* USB_DEVICE_OUT_EP2_STATE:RO；位位置：[1:0]；默认值：2’b0；*/
...
/* USB_DEVICE_CLK_EN:R/W；位位置：[0]；默认值：1’b0；*/
...
/* USB_DEVICE_USB_MEM_CLK_EN:R/W；位位置：[1]；默认值：1’b1；*/
...
/* USB_DEVICE_USB_MEM_PD:R/W；位位置：[0]；默认值：1’b0；*/
/*描述：1：关闭usb内存。。*/
...
/* USB_DEVICE_DATE:R/W；位位置：[31:0]；默认值：32'h201190；*/
/*description:注册版本。。*/
