...
/* RTC_GPIO_OUT_DATA:R/W；比特位置：[31:10]；默认值：0；*/
/*description:RTC GPIO 0~21输出数据。*/
...
/* RTC_GPIO_OUT_DATA_W1TS:WO；比特位置：[31:10]；默认值：0；*/
/*描述：RTC GPIO 0~21输出数据写入1设置。*/
...
/* RTC_GPIO_OUT_DATA_W1TC:WO；比特位置：[31:10]；默认值：0；*/
/*描述：RTC GPIO 0~21输出数据写入1清除。*/
...
/* RTC_GPIO_ENABLE:R/W；比特位置：[31:10]；默认值：0；*/
/*description:RTC GPIO 0~21使能。*/
...
/* RTC_GPIO_ENABLE_W1TS:WO；比特位置：[31:10]；默认值：0；*/
/*description:RTC GPIO 0~21启用write 1设置。*/
...
/* RTC_GPIO_ENABLE_W1TC:WO；比特位置：[31:10]；默认值：0；*/
/*description:RTC GPIO 0~21使写1清零。*/
...
/* RTC_GPIO_STATUS_INT:R/W；比特位置：[31:10]；默认值：0；*/
/*description:RTC GPIO 0~21中断状态。*/
...
/* RTC_GPIO_STATUS_INT_W1TS:WO；比特位置：[31:10]；默认值：0；*/
/*description:RTC GPIO 0~21中断状态写入1设置。*/
...
/* RTC_GPIO_STATUS_INT_W1TC:WO；比特位置：[31:10]；默认值：0；*/
/*description:RTC GPIO 0~21中断状态写1清除。*/
...
/* RTC_GPIO_IN_NEXT：RO；比特位置：[31:10]；默认值：；*/
/*description:RTC GPIO输入数据。*/
...
/*描述：如果设置为0：GPIO中断禁用，如果设置为1：上升沿触发，如果设置设置为2：下降沿触发，若设置为3：任何边缘触发，若设为4：低电平触发，若设定为5：高电平触发。*/
...
/* RTC_GPIO_p-188_唤醒启用：R/W；位位置：[10]；默认值：0；*/
/*description:RTC GPIO唤醒启用位。*/
...
/* RTC_GPIO_p-188_INT_TYPE：R/W；比特位置：[9:7]；默认值：0；*/
/*描述：如果设置为0：GPIO中断禁用，如果设置为1：上升沿触发，如果设置设置为2：下降沿触发，若设置为3：任何边缘触发，若设为4：低电平触发，若设定为5：高电平触发。*/
...
/* RTC_GPIO_p-188_PAD_DRIVER:R/W；位位置：[2]；默认值：0；*/
/*描述：如果设置为0：正常输出，如果设置为1：漏极开路。*/
...
/* RTC_GPIO_pin_WAKEUP_ENABLE:R/W；位位置：[10]；默认值：0；*/
/*description:RTC GPIO唤醒启用位。*/
...
/* RTC_GPIO_p1919_PAD_DRIVER:R/W；位位置：[2]；默认值：0；*/
/*描述：如果设置为0：正常输出，如果设置为1：漏极开路。*/
...
/* RTC_GPIO_PIN20_唤醒启用：R/W；位位置：[10]；默认值：0；*/
/*description:RTC GPIO唤醒启用位。*/
...
/* RTC_GPIO_PIN20_INT_TYPE:R/W；比特位置：[9:7]；默认值：0；*/
/*描述：如果设置为0：GPIO中断禁用，如果设置为1：上升沿触发，如果设置设置为2：下降沿触发，若设置为3：任何边缘触发，若设为4：低电平触发，若设定为5：高电平触发。*/
...
/* RTC_GPIO_PIN20_PAD_DRIVER:R/W；位位置：[2]；默认值：0；*/
/*描述：如果设置为0：正常输出，如果设置为1：漏极开路。*/
...
/* RTC_GPIO_PIN21_唤醒启用：R/W；位位置：[10]；默认值：0；*/
/*description:RTC GPIO唤醒启用位。*/
...
/* RTC_GPIO_PIN21_INT_TYPE:R/W；比特位置：[9:7]；默认值：0；*/
/*描述：如果设置为0：GPIO中断禁用，如果设置为1：上升沿触发，如果设置设置为2：下降沿触发，若设置为3：任何边缘触发，若设为4：低电平触发，若设定为5：高电平触发。*/
...
/* RTC_GPIO_PIN21_PAD_DRIVER:R/W；位位置：[2]；默认值：0；*/
/*描述：如果设置为0：正常输出，如果设置为1：漏极开路。*/
...
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD8_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_TOUCH_PAD8_RDE:R/W；位位置：[28]；默认值：1'd0；*/
/*description:RDE。*/
...
/* RTC_IO_TOUCH_PAD8_RUE:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：RUE。*/
...
/* RTC_IO_TOUCH_PAD8_MUX_SEL:R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD8_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_TOUCH_PAD8_SLP_SEL:R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_TOUCH_PAD8_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD8_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_TOUCH_PAD8_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD9_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_TOUCH_PAD9_RDE:R/W；位位置：[28]；默认值：1'd0；*/
/*description:RDE。*/
...
/* RTC_IO_TOUCH_PAD9_RUE:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：RUE。*/
...
/* RTC_IO_TOUCH_PAD9_MUX_SEL:R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD9_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_TOUCH_PAD9_SLP_SEL:R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_TOUCH_PAD9_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD9_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_TOUCH_PAD9_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD10_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_TOUCH_PAD10_red:R/W；位位置：[28]；默认值：1'd0；*/
/*description:RDE。*/
...
/* RTC_IO_TOUCH_pad10rue:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：RUE。*/
...
/* RTC_IO_TOUCH_PAD10_START:R/W；位位置：[22]；默认值：1'd0；*/
/*description:TOUCH_START。*/
...
/* RTC_IO_TOUCH_PAD10_TIE_OPT:R/W；位位置：[21]；默认值：1'd0；*/
/*description:TOUCH_TIE_OPT。*/
...
/* RTC_IO_TOUCH_PAD10_XPD：R/W；位位置：[20]；默认值：1'd0；*/
/*description:TOUCH_XPD。*/
...
/* RTC_IO_TOUCH_PAD10_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD10_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_TOUCH_PAD10_SLP_SEL:R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_TOUCH_PAD10_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD10_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_TOUCH_PAD10_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD11_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_TOUCH_PAD11_RDE:R/W；位位置：[28]；默认值：1'd0；*/
/*description:RDE。*/
...
/* RTC_IO_TOUCH_PAD11_RUE:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：RUE。*/
...
/* RTC_IO_TOUCH_PAD11_START：R/W；位位置：[22]；默认值：1'd0；*/
/*description:TOUCH_START。*/
...
/* RTC_IO_TOUCH_PAD11_TIE_OPT:R/W；位位置：[21]；默认值：1'd0；*/
/*description:TOUCH_TIE_OPT。*/
...
/* RTC_IO_TOUCH_PAD11_XPD:R/W；位位置：[20]；默认值：1'd0；*/
/*description:TOUCH_XPD。*/
...
/* RTC_IO_TOUCH_PAD11_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD11_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_TOUCH_PAD11_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_TOUCH_PAD11_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD11_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_TOUCH_PAD11_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD12_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_TOUCH_PAD12_RDE:R/W；位位置：[28]；默认值：1'd0；*/
/*description:RDE。*/
...
/* RTC_IO_TOUCH_PAD12_RUE:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：RUE。*/
...
/* RTC_IO_TOUCH_PAD12_START：R/W；位位置：[22]；默认值：1'd0；*/
/*description:TOUCH_START。*/
...
/* RTC_IO_TOUCH_PAD12_TIE_OPT:R/W；位位置：[21]；默认值：1'd0；*/
/*description:TOUCH_TIE_OPT。*/
...
/* RTC_IO_TOUCH_PAD12_XPD:R/W；位位置：[20]；默认值：1'd0；*/
/*description:TOUCH_XPD。*/
...
/* RTC_IO_TOUCH_PAD12_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD12_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_TOUCH_PAD12_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_TOUCH_PAD12_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD12_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_TOUCH_PAD12_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD13_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_TOUCH_PAD13_rd:R/W；位位置：[28]；默认值：1'd0；*/
/*description:RDE。*/
...
/* RTC_IO_TOUCH_PAD13_RUE:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：RUE。*/
...
/* RTC_IO_TOUCH_PAD13_START：R/W；位位置：[22]；默认值：1'd0；*/
/*description:TOUCH_START。*/
...
/* RTC_IO_TOUCH_PAD13_TIE_OPT:R/W；位位置：[21]；默认值：1'd0；*/
/*description:TOUCH_TIE_OPT。*/
...
/* RTC_IO_TOUCH_PAD13_XPD:R/W；位位置：[20]；默认值：1'd0；*/
/*description:TOUCH_XPD。*/
...
/* RTC_IO_TOUCH_PAD13_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD13_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_TOUCH_PAD13_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_TOUCH_PAD13_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD13_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_TOUCH_PAD13_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD14_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_TOUCH_PAD14_RDE:R/W；位位置：[28]；默认值：1'd0；*/
/*description:RDE。*/
...
/* RTC_IO_TOUCH_PAD14_RUE:R/W；位位置：[27]；默认值：1'd0；*/
/*描述：RUE。*/
...
/* RTC_IO_TOUCH_PAD14_START：R/W；位位置：[22]；默认值：1'd0；*/
/*description:TOUCH_START。*/
...
/* RTC_IO_TOUCH_PAD14_TIE_OPT:R/W；位位置：[21]；默认值：1'd0；*/
/*description:TOUCH_TIE_OPT。*/
...
/* RTC_IO_TOUCH_PAD14_XPD:R/W；位位置：[20]；默认值：1'd0；*/
/*description:TOUCH_XPD。*/
...
/* RTC_IO_TOUCH_PAD14_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_TOUCH_PAD14_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_TOUCH_PAD14_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_TOUCH_PAD14_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_TOUCH_PAD14_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_TOUCH_PAD14_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_X32P_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_X32P_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_X32P_SLP_SEL:R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_X32P_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_X32P_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_X32P_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_X32N_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_X32N_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_X32N_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_X32N_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_X32N_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_X32N_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_X32N_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_PDAC1_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
...
/* RTC_IO_PDAC1_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_PDAC1_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:PDAC1功能选择。*/
...
/* RTC_IO_PDAC1_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_PDAC1_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_PDAC1_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_PDAC1_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_PDAC1_DAC_XPD_FORCE:R/W；位位置：[12]；默认值：1'd0；*/
/*描述：1：使用reg_pdac1_xpd_dac控制pdac1_xpd_dac，0：使用SAR ADC FSM控制PDAC2_xpd_dac。*/
...
/* RTC_IO_PDAC1_XPD_DAC:R/W；位位置：[11]；默认值：1'd0；*/
...
/* RTC_IO_PDAC1_DAC:R/W；比特位置：[10:3]；默认值：8'd0；*/
/*描述：PDAC1_DAC。*/
...
/* RTC_IO_PDAC2_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
...
/* RTC_IO_PDAC2_MUX_SEL：R/W；位位置：[19]；默认值：1'd0；*/
/*description:1：使用RTC GPIO，0：使用数字GPIO。*/
...
/* RTC_IO_PDAC2_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:PDAC1功能选择。*/
...
/* RTC_IO_PDAC2_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_PDAC2_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_PDAC2_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_PDAC2_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_PDAC2_DAC_XPD_FORCE:R/W；位位置：[12]；默认值：1'd0；*/
/*描述：1：使用reg_pdac2_xpd_dac控制pdac2_xpd_dac，0：使用SAR ADC FSM控制pdac2_xpd_dac。*/
...
/* RTC_IO_PDAC2_XPD_DAC:R/W；位位置：[11]；默认值：1'd0；*/
...
/* RTC_IO_PDAC2_DAC:R/W；比特位置：[10:3]；默认值：8'd0；*/
...
/* RTC_IO_PAD19_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_PAD19_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_PAD19_SLP_SEL:R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_PAD19_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_PAD19_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_PAD19_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_PAD20_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_PAD20_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_PAD20_SLP_SEL:R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_PAD20_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_PAD20_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_PAD20_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/* RTC_IO_PAD21_DRV:R/W；位位置：[30:29]；默认值：2'd2；*/
/*描述：DRV。*/
...
/* RTC_IO_PAD21_FUN_SEL:R/W；比特位置：[18:17]；默认值：2'd0；*/
/*description:功能选择。*/
...
/* RTC_IO_PAD21_SLP_SEL：R/W；位位置：[16]；默认值：1'd0；*/
/*描述：1：在睡眠期间启用睡眠模式，0：无睡眠模式。*/
...
/* RTC_IO_PAD21_SLP_IE:R/W；位位置：[15]；默认值：1'd0；*/
/*描述：睡眠模式下的输入启用。*/
...
/* RTC_IO_PAD21_SLP_OE:R/W；位位置：[14]；默认值：1'd0；*/
/*描述：在睡眠模式下启用输出。*/
...
/* RTC_IO_PAD21_FUN_IE:R/W；位位置：[13]；默认值：1'd0；*/
/*description:工作模式下的输入启用。*/
...
/*description:选择RTC GPIO 0~17控制XTAL。*/
...
/* RTC_IO_IO_TOUCH_BUFMODE:R/W；位位置：[4]；默认值：1'd0；*/
/*description:BUF_MODE当触摸工作时没有fsm。*/
...
/* RTC_IO_IO_TOUCH_BUFSEL：R/W；位位置：[3:0]；默认值：4'd0；*/
/*description:BUF_SEL当触摸工作时没有fsm。*/
...
/* RTC_IO_DATE:R/W；位位置：[27:0]；默认值：28'h2101180；*/
/*描述：。*/
