...
typedef struct {
    volatile usb_hcchar_reg_t hcchar_reg;    //0x00位
    uint32_t reserved_0x04_0x08[1]; //0x04
    volatile usb_hcint_reg_t hcint_reg;      //0x08
    volatile usb_hcintmsk_reg_t hcintmsk_reg;    //0x0c
    volatile usb_hctsiz_reg_t hctsiz_reg;    //0x10像素
    volatile usb_hcdma_reg_t hcdma_reg;      //0x14像素
    uint32_t reserved_0x14_0x14[1]; //0x18像素*
    volatile usb_hcdmab_reg_t hcdmab_reg;    //0x1c像素
} usb_host_chan_regs_t;

typedef struct {
    volatile usb_diepctl_reg_t diepctl_reg;  //0x00位
    uint32_t reserved_0x04_0x08[1]; //0x04
    ...
    volatile usb_diepdma_reg_t diepdma_reg;  //0x14像素
    volatile usb_dtxfsts_reg_t dtxfsts_reg;  //0x18像素
    volatile usb_diepdmab_reg_t diepdmab_reg;    //0x1c像素
} usb_in_ep_regs_t;

typedef struct {
    volatile usb_doepctl_reg_t doepctl_reg;  //0x00位
    uint32_t reserved_0x04_0x08[1]; //0x04
    volatile usb_doepint_reg_t doepint_reg;  //0x08
    uint32_t reserved_0x0c_0x10[1]; //0x0c
    volatile usb_doeptsiz_reg_t doeptsiz_reg;    //0x10像素
    volatile usb_doepdma_reg_t doepdma_reg;  //0x14像素
    uint32_t reserved_0x18_0x1c[1]; //0x18像素
    volatile usb_doepdmab_reg_t doepdmab_reg;    //0x1c像素
} usb_out_ep_regs_t;
...
typedef struct {
    //全局寄存器
    volatile usb_gotgctl_reg_t gotgctl_reg;             //00万
    volatile usb_gotgint_reg_t gotgint_reg;             //0x0004年
    volatile usb_gahbcfg_reg_t gahbcfg_reg;             //2008年9月
    volatile usb_gusbcfg_reg_t gusbcfg_reg;             //0x000c
    volatile usb_grstctl_reg_t grstctl_reg;             //0x0010位
    volatile usb_gintsts_reg_t gintsts_reg;             //2014年4月
    volatile usb_gintmsk_reg_t gintmsk_reg;             //0x0018年
    volatile usb_grxstsr_reg_t grxstsr_reg;             //0x001c
    volatile usb_grxstsp_reg_t grxstsp_reg;             //0x0020位
    volatile usb_grxfsiz_reg_t grxfsiz_reg;             //0x0024位
    volatile usb_gnptxfsiz_reg_t gnptxfsiz_reg;         //0x0028年
    volatile usb_gnptxsts_reg_t gnptxsts_reg;           //0x002c
    uint32_t reserved_0x0030_0x0040[4];                 //0x0030到0x0040
    volatile usb_gsnpsid_reg_t gsnpsid_reg;             //0x0040位
    volatile usb_ghwcfg1_reg_t ghwcfg1_reg;             //0x0044位
    volatile usb_ghwcfg2_reg_t ghwcfg2_reg;             //0x0048位
    volatile usb_ghwcfg3_reg_t ghwcfg3_reg;             //0x004c
    volatile usb_ghwcfg4_reg_t ghwcfg4_reg;             //0x0050位
    ...
    volatile usb_dieptxfi_reg_t dieptxfi_regs[4];       //0x0104至0x0114
    usb_dieptxfi_reg_t reserved_0x0114_0x0140[11];      //0x0114至0x0140
    uint32_t reserved_0x140_0x400[176];                 //0x0140至0x0400

    //主机模式寄存器
    volatile usb_hcfg_reg_t hcfg_reg;                   //0x0400
    volatile usb_hfir_reg_t hfir_reg;                   //0x0404
    volatile usb_hfnum_reg_t hfnum_reg;                 //0x0408
    uint32_t reserved_0x40c_0x410[1];                   //0x040c到0x0410
    ...
    uint32_t reserved_0x420_0x440[8];                   //0x0420至0x0440
    volatile usb_hprt_reg_t hprt_reg;                   //0x0440
    uint32_t reserved_0x0444_0x0500[47];                //0x0444到0x0500
    usb_host_chan_regs_t host_chans[8];                 //0x0500至0x0600
    usb_host_chan_regs_t reserved_0x0600_0x0700[8];     //0x0600至0x0700
    ...
    uint32_t reserved_0x080c_0x0810[1];                 //0x080c至0x0810

    //设备模式寄存器
    volatile usb_diepmsk_reg_t diepmsk_reg;             //0x810倍
    ...
    //设计：在EP0仓库
    volatile usb_diepctl0_reg_t diepctl0_reg;           //0x0900个
    uint32_t reserved_0x0904_0x0908[1];                 //0x0904至0x0908
    volatile usb_diepint0_reg_t diepint0_reg;           //0x0908
    uint32_t reserved_0x090c_0x0910[1];                 //0x090c至0x0910
    ...
    //Deivce:IN EP寄存器
    usb_in_ep_regs_t in_eps[6];                         //0x0920至0x09e0
    usb_in_ep_regs_t reserved_0x09e0_0x0b00[9];         //0x09e0到0x0b00

    //设备：OUT EP0货仓
    volatile usb_doepctl0_reg_t doepctl0_reg;           //0x0b00
    uint32_t reserved_0x0b04_0x0b08[1];                 //0x0b04至0x0b08
    volatile usb_doepint0_reg_t doepint0_reg;           //0年08月
    uint32_t reserved_0x0b0c_0x0b10[1];                 //0x0b0c到0x0b10
    volatile usb_doeptsiz0_reg_t doeptsiz0_reg;         //0x0b10
    volatile usb_doepdma0_reg_t doepdma0_reg;           //0x0b14
    uint32_t reserved_0x0b18_0x0b1c[1];                 //0x0b18至0x0b1c
    volatile usb_doepdmab0_reg_t doepdmab0_reg;         //0x0b1c

    //Deivce:OUT EP寄存器
    usb_out_ep_regs_t out_eps[6];                       //0xb1c
    usb_out_ep_regs_t reserved_0x0be0_0x0d00[9];        //0x0be0到0x0d00
    uint32_t reserved_0x0d00_0x0e00[64];                //0x0d00到0x0e00
    volatile usb_pcgcctl_reg_t pcgcctl_reg;             //0x0e00
    uint32_t reserved_0x0e04_0x0e08[1];                 //0x0d00到0x0e00
} usbh_dev_t;
