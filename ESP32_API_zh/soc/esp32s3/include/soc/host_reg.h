...
/* HOST_GPIO_dio_INT1:RO；比特位置：[21:0]；默认值：22'b0；*/
/*描述：。*/
...
/* HOST_GPIO_SDIO_IN1:RO；比特位置：[21:0]；默认值：22'b0；*/
/*描述：。*/
...
/* HOST_SLCHOST_WIN_CMD:R/W；比特位置：[15:0]；默认值：16'b0；*/
/*描述：。*/
#define HOST_SLCHOST_WIN_CMD    0x0000FFFF
#define HOST_SLCHOST_WIN_CMD_M  ((HOST_SLCHOST_WIN_CMD_V)<<(HOST_SLCHOST_WIN_CMD_S))
#define HOST_SLCHOST_WIN_CMD_V  0xFFFF
#define HOST_SLCHOST_WIN_CMD_S  0
...
/* HOST_HOSTSLC0_LEN0_CHECK:RO；位位置：[31:20]；默认值：12'0；*/
/*描述：。*/
#define HOST_HOSTSLC0_LEN0_CHECK    0x00000FFF
#define HOST_HOSTSLC0_LEN0_CHECK_M  ((HOST_HOSTSLC0_LEN0_CHECK_V)<<(HOST_HOSTSLC0_LEN0_CHECK_S))
#define HOST_HOSTSLC0_LEN0_CHECK_V  0xFFF
#define HOST_HOSTSLC0_LEN0_CHECK_S  20
...
/* HOST_HOSTSLC0_LEN1_CHECK:RO；位位置：[31:20]；默认值：10'0；*/
/*描述：。*/
#define HOST_HOSTSLC0_LEN1_CHECK    0x00000FFF
#define HOST_HOSTSLC0_LEN1_CHECK_M  ((HOST_HOSTSLC0_LEN1_CHECK_V)<<(HOST_HOSTSLC0_LEN1_CHECK_S))
#define HOST_HOSTSLC0_LEN1_CHECK_V  0xFFF
#define HOST_HOSTSLC0_LEN1_CHECK_S  20
...
/* HOST_HOSTSLC0_LEN2_CHECK:RO；位位置：[31:20]；默认值：10'0；*/
/*描述：。*/
#define HOST_HOSTSLC0_LEN2_CHECK    0x00000FFF
#define HOST_HOSTSLC0_LEN2_CHECK_M  ((HOST_HOSTSLC0_LEN2_CHECK_V)<<(HOST_HOSTSLC0_LEN2_CHECK_S))
#define HOST_HOSTSLC0_LEN2_CHECK_V  0xFFF
#define HOST_HOSTSLC0_LEN2_CHECK_S  20
...
/* 主机_SLC_APBWIN_BUS:R/W；位位置：[30]；默认值：1’b0；*/
/*描述：。*/
...
/* 主机_主机_日期：R/W；位位置：[31:0]；默认值：32'h108007000；*/
/*描述：。*/
