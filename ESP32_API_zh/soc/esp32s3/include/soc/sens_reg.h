...
#define SENS_SAR_READER1_STATUS_REG          (DR_REG_SENS_BASE + 0x4)
...
#define SENS_SAR_MEAS1_CTRL1_REG          (DR_REG_SENS_BASE + 0x8)
...
#define SENS_SAR_MEAS1_CTRL2_REG          (DR_REG_SENS_BASE + 0xC)
/* SENS_SAR1_EN_PAD_FORCE:R/W；位位置：[31]；默认值：1’b0；*/
/*描述：1:SAR ADC1极板启用位图由SW控制。*/
...
#define SENS_SAR_MEAS1_MUX_REG          (DR_REG_SENS_BASE + 0x10)
...
#define SENS_SAR_ATTEN1_REG          (DR_REG_SENS_BASE + 0x14)
...
#define SENS_SAR_AMP_CTRL1_REG          (DR_REG_SENS_BASE + 0x18)
...
#define SENS_SAR_AMP_CTRL2_REG          (DR_REG_SENS_BASE + 0x1C)
...
#define SENS_SAR_AMP_CTRL3_REG          (DR_REG_SENS_BASE + 0x20)
...
#define SENS_SAR_READER2_CTRL_REG          (DR_REG_SENS_BASE + 0x24)
/* SENS_SAR2_INT_EN:R/W；位位置：[30]；默认值：1’b1；*/
/*description:使saradc2发出中断。*/
...
#define SENS_SAR_READER2_STATUS_REG          (DR_REG_SENS_BASE + 0x28)
...
#define SENS_SAR_MEAS2_CTRL1_REG          (DR_REG_SENS_BASE + 0x2C)
...
#define SENS_SAR_MEAS2_CTRL2_REG          (DR_REG_SENS_BASE + 0x30)
/* SENS_SAR2_EN_PAD_FORCE:R/W；位位置：[31]；默认值：1’b0；*/
/*描述：1:SAR ADC2极板启用位图由SW控制。*/
...
#define SENS_SAR_MEAS2_MUX_REG          (DR_REG_SENS_BASE + 0x34)
/* SENS_SAR2_RTC_FORCE:R/W；位位置：[31]；默认值：1’b0；*/
/*描述：在睡眠中，强制使用rtc控制ADC。*/
...
#define SENS_SAR_SLAVE_ADDR1_REG          (DR_REG_SENS_BASE + 0x40)
/* SENS_SARADC_MEAS_STATUS:RO；位位置：[29:22]；默认值：8'0；*/
/*描述：。*/
...
#define SENS_SAR_SLAVE_ADDR2_REG          (DR_REG_SENS_BASE + 0x44)
...
#define SENS_SAR_SLAVE_ADDR3_REG          (DR_REG_SENS_BASE + 0x48)
...
#define SENS_SAR_SLAVE_ADDR4_REG          (DR_REG_SENS_BASE + 0x4C)
...
#define SENS_SAR_TSENS_CTRL2_REG          (DR_REG_SENS_BASE + 0x54)
...
#define SENS_SAR_I2C_CTRL_REG          (DR_REG_SENS_BASE + 0x58)
...
#define SENS_SAR_TOUCH_CONF_REG          (DR_REG_SENS_BASE + 0x5C)
...
/* SENS_TOUCH_OUTEN:R/W；位位置：[14:0]；默认值：15'7fff；*/
/*描述：触摸控制器输出启用。*/
...
#define SENS_SAR_TOUCH_DENOISE_REG          (DR_REG_SENS_BASE + 0x60)
/* SENS_TOUCH_DENOISE数据：RO；比特位置：[21:0]；默认值：22'b0；*/
/*描述：。*/
...
#define SENS_SAR_TOUCH_THRES1_REG          (DR_REG_SENS_BASE + 0x64)
...
#define SENS_SAR_TOUCH_THRES2_REG          (DR_REG_SENS_BASE + 0x68)
...
#define SENS_SAR_TOUCH_THRES3_REG          (DR_REG_SENS_BASE + 0x6C)
...
#define SENS_SAR_TOUCH_THRES4_REG          (DR_REG_SENS_BASE + 0x70)
...
#define SENS_SAR_TOUCH_THRES5_REG          (DR_REG_SENS_BASE + 0x74)
...
#define SENS_SAR_TOUCH_THRES6_REG          (DR_REG_SENS_BASE + 0x78)
...
#define SENS_SAR_TOUCH_THRES7_REG          (DR_REG_SENS_BASE + 0x7C)
...
#define SENS_SAR_TOUCH_THRES8_REG          (DR_REG_SENS_BASE + 0x80)
...
#define SENS_SAR_TOUCH_THRES9_REG          (DR_REG_SENS_BASE + 0x84)
...
#define SENS_SAR_TOUCH_THRES10_REG          (DR_REG_SENS_BASE + 0x88)
...
#define SENS_SAR_TOUCH_THRES11_REG          (DR_REG_SENS_BASE + 0x8C)
...
#define SENS_SAR_TOUCH_THRES12_REG          (DR_REG_SENS_BASE + 0x90)
...
#define SENS_SAR_TOUCH_THRES13_REG          (DR_REG_SENS_BASE + 0x94)
/* SENS_TOUCH_OUT_TH13:R/W；比特位置：[21:0]；默认值：22'h0；*/
/*description:触摸板13的手指阈值。*/
...
#define SENS_SAR_TOUCH_THRES14_REG          (DR_REG_SENS_BASE + 0x98)
...
#define SENS_SAR_TOUCH_CHN_ST_REG          (DR_REG_SENS_BASE + 0x9C)
...
#define SENS_SAR_TOUCH_STATUS0_REG          (DR_REG_SENS_BASE + 0xA0)
...
#define SENS_SAR_TOUCH_STATUS1_REG          (DR_REG_SENS_BASE + 0xA4)
...
#define SENS_SAR_TOUCH_STATUS2_REG          (DR_REG_SENS_BASE + 0xA8)
...
#define SENS_SAR_TOUCH_STATUS3_REG          (DR_REG_SENS_BASE + 0xAC)
...
#define SENS_SAR_TOUCH_STATUS4_REG          (DR_REG_SENS_BASE + 0xB0)
...
#define SENS_SAR_TOUCH_STATUS5_REG          (DR_REG_SENS_BASE + 0xB4)
...
#define SENS_SAR_TOUCH_STATUS6_REG          (DR_REG_SENS_BASE + 0xB8)
...
#define SENS_SAR_TOUCH_STATUS7_REG          (DR_REG_SENS_BASE + 0xBC)
...
#define SENS_SAR_TOUCH_STATUS8_REG          (DR_REG_SENS_BASE + 0xC0)
...
#define SENS_SAR_TOUCH_STATUS9_REG          (DR_REG_SENS_BASE + 0xC4)
...
#define SENS_SAR_TOUCH_STATUS10_REG          (DR_REG_SENS_BASE + 0xC8)
...
#define SENS_SAR_TOUCH_STATUS11_REG          (DR_REG_SENS_BASE + 0xCC)
...
#define SENS_SAR_TOUCH_STATUS12_REG          (DR_REG_SENS_BASE + 0xD0)
...
#define SENS_SAR_TOUCH_STATUS13_REG          (DR_REG_SENS_BASE + 0xD4)
...
#define SENS_SAR_TOUCH_STATUS14_REG          (DR_REG_SENS_BASE + 0xD8)
...
#define SENS_SAR_TOUCH_SLP_STATUS_REG          (DR_REG_SENS_BASE + 0xDC)
...
#define SENS_SAR_TOUCH_APPR_STATUS_REG          (DR_REG_SENS_BASE + 0xE0)
...
#define SENS_SAR_COCPU_STATE_REG          (DR_REG_SENS_BASE + 0xE4)
/* SENS_COCPU_break:RO；位位置：[30]；默认值：1’b0；*/
/*描述：检查cocpu是否在ebreak中。*/
...
/* SENS_COCPU_CLK_EN_ST:RO；位位置：[26]；默认值：1’b0；*/
/*描述：检查cocpu是否打开clk。*/
#define SENS_COCPU_CLK_EN_ST    (BIT(26))
#define SENS_COCPU_CLK_EN_ST_M  (BIT(26))
#define SENS_COCPU_CLK_EN_ST_V  0x1
#define SENS_COCPU_CLK_EN_ST_S  26
...
#define SENS_SAR_COCPU_INT_RAW_REG          (DR_REG_SENS_BASE + 0xE8)
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_RAW:RO；位位置：[11]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_RAW    (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_RAW_M  (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_RAW_V  0x1
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_RAW_S  11
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_RAW:RO；位位置：[10]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_RAW    (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_RAW_M  (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_RAW_V  0x1
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_RAW_S  10
/* SENS_COCPU_TOUCH_TIMEOUT_INT_RAW:RO；位位置：[9]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_TIMEOUT_INT_RAW    (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_RAW_M  (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_RAW_V  0x1
#define SENS_COCPU_TOUCH_TIMEOUT_INT_RAW_S  9
...
/* SENS_COCPU_SARADC2_INT_RAW:RO；位位置：[4]；默认值：1’b0；*/
/*description:来自saradc2的int。*/
#define SENS_COCPU_SARADC2_INT_RAW    (BIT(4))
#define SENS_COCPU_SARADC2_INT_RAW_M  (BIT(4))
#define SENS_COCPU_SARADC2_INT_RAW_V  0x1
#define SENS_COCPU_SARADC2_INT_RAW_S  4
/* SENS_COCPU_SARADC1_INT_RAW:RO；位位置：[3]；默认值：1’b0；*/
/*description:来自saradc1的int。*/
#define SENS_COCPU_SARADC1_INT_RAW    (BIT(3))
#define SENS_COCPU_SARADC1_INT_RAW_M  (BIT(3))
#define SENS_COCPU_SARADC1_INT_RAW_V  0x1
#define SENS_COCPU_SARADC1_INT_RAW_S  3
/* SENS_COCPU_TOUCH_ACTIVE_INT_RAW:RO；位位置：[2]；默认值：1’b0；*/
/*description:来自触摸激活的int。*/
...
#define SENS_SAR_COCPU_INT_ENA_REG          (DR_REG_SENS_BASE + 0xEC)
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA:R/W；位位置：[11]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA    (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_M  (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_V  0x1
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_S  11
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA:R/W；位位置：[10]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA    (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_M  (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_V  0x1
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_S  10
/* SENS_COCPU_TOUCH_TIMEOUT_INT_ENA：R/W；位位置：[9]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA    (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_M  (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_V  0x1
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_S  9
...
/* SENS_COCPU_SARADC2_INT_ENA:R/W；位位置：[4]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC2_INT_ENA    (BIT(4))
#define SENS_COCPU_SARADC2_INT_ENA_M  (BIT(4))
#define SENS_COCPU_SARADC2_INT_ENA_V  0x1
#define SENS_COCPU_SARADC2_INT_ENA_S  4
/* SENS_COCPU_SARADC1_INT_ENA:R/W；位位置：[3]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC1_INT_ENA    (BIT(3))
#define SENS_COCPU_SARADC1_INT_ENA_M  (BIT(3))
#define SENS_COCPU_SARADC1_INT_ENA_V  0x1
#define SENS_COCPU_SARADC1_INT_ENA_S  3
...
#define SENS_SAR_COCPU_INT_ST_REG          (DR_REG_SENS_BASE + 0xF0)
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_ST:RO；位位置：[11]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ST    (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ST_M  (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ST_V  0x1
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ST_S  11
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST:RO；位位置：[10]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST    (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST_M  (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST_V  0x1
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ST_S  10
/* SENS_COCPU_TOUCH_TIMEOUT_INT_ST:RO；位位置：[9]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ST    (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ST_M  (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ST_V  0x1
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ST_S  9
...
/* SENS_COCPU_SARADC2_INT_ST:RO；位位置：[4]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC2_INT_ST    (BIT(4))
#define SENS_COCPU_SARADC2_INT_ST_M  (BIT(4))
#define SENS_COCPU_SARADC2_INT_ST_V  0x1
#define SENS_COCPU_SARADC2_INT_ST_S  4
/* SENS_COCPU_SARADC1_INT_ST:RO；位位置：[3]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC1_INT_ST    (BIT(3))
#define SENS_COCPU_SARADC1_INT_ST_M  (BIT(3))
#define SENS_COCPU_SARADC1_INT_ST_V  0x1
#define SENS_COCPU_SARADC1_INT_ST_S  3
...
#define SENS_SAR_COCPU_INT_CLR_REG          (DR_REG_SENS_BASE + 0xF4)
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_CLR:WO；位位置：[11]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_CLR    (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_CLR_M  (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_CLR_V  0x1
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_CLR_S  11
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_CLR:WO；位位置：[10]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_CLR    (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_CLR_M  (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_CLR_V  0x1
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_CLR_S  10
/* SENS_COCPU_TOUCH_TIMEOUT_INT_CLR:WO；位位置：[9]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_TIMEOUT_INT_CLR    (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_CLR_M  (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_CLR_V  0x1
#define SENS_COCPU_TOUCH_TIMEOUT_INT_CLR_S  9
...
/* SENS_COCPU_SARADC2_INT_CLR:WO；位位置：[4]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC2_INT_CLR    (BIT(4))
#define SENS_COCPU_SARADC2_INT_CLR_M  (BIT(4))
#define SENS_COCPU_SARADC2_INT_CLR_V  0x1
#define SENS_COCPU_SARADC2_INT_CLR_S  4
/* SENS_COCPU_SARADC1_INT_CLR:WO；位位置：[3]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC1_INT_CLR    (BIT(3))
#define SENS_COCPU_SARADC1_INT_CLR_M  (BIT(3))
#define SENS_COCPU_SARADC1_INT_CLR_V  0x1
#define SENS_COCPU_SARADC1_INT_CLR_S  3
...
#define SENS_SAR_COCPU_DEBUG_REG          (DR_REG_SENS_BASE + 0xF8)
...
/* SENS_IOMUX_CLK_EN:R/W；位位置：[31]；默认值：1'd0；*/
/*描述：。*/
#define SENS_IOMUX_CLK_EN    (BIT(31))
#define SENS_IOMUX_CLK_EN_M  (BIT(31))
#define SENS_IOMUX_CLK_EN_V  0x1
#define SENS_IOMUX_CLK_EN_S  31
/* SENS_SARADC_CLK_EN:R/W；位位置：[30]；默认值：1’b0；*/
/*描述：。*/
#define SENS_SARADC_CLK_EN    (BIT(30))
#define SENS_SARADC_CLK_EN_M  (BIT(30))
#define SENS_SARADC_CLK_EN_V  0x1
#define SENS_SARADC_CLK_EN_S  30
/* SENS_TSENS_CLK_EN:R/W；位位置：[29]；默认值：1’b0；*/
/*描述：。*/
#define SENS_TSENS_CLK_EN    (BIT(29))
#define SENS_TSENS_CLK_EN_M  (BIT(29))
#define SENS_TSENS_CLK_EN_V  0x1
#define SENS_TSENS_CLK_EN_S  29
/* SENS_RTC_I2C_CLK_EN:R/W；位位置：[27]；默认值：1’b0；*/
/*描述：。*/
#define SENS_RTC_I2C_CLK_EN    (BIT(27))
#define SENS_RTC_I2C_CLK_EN_M  (BIT(27))
#define SENS_RTC_I2C_CLK_EN_V  0x1
#define SENS_RTC_I2C_CLK_EN_S  27

#define SENS_SAR_PERI_RESET_CONF_REG          (DR_REG_SENS_BASE + 0x108)
/* SENS_SARADC_RESET:R/W；位位置：[30]；默认值：1’b0；*/
/*描述：。*/
#define SENS_SARADC_RESET    (BIT(30))
#define SENS_SARADC_RESET_M  (BIT(30))
#define SENS_SARADC_RESET_V  0x1
#define SENS_SARADC_RESET_S  30
/* SENS_TSENS_RESET:R/W；位位置：[29]；默认值：1’b0；*/
/*描述：。*/
#define SENS_TSENS_RESET    (BIT(29))
#define SENS_TSENS_RESET_M  (BIT(29))
#define SENS_TSENS_RESET_V  0x1
#define SENS_TSENS_RESET_S  29
/* SENS_RTC_I2C_RESET:R/W；位位置：[27]；默认值：1’b0；*/
/*描述：。*/
#define SENS_RTC_I2C_RESET    (BIT(27))
#define SENS_RTC_I2C_RESET_M  (BIT(27))
#define SENS_RTC_I2C_RESET_V  0x1
#define SENS_RTC_I2C_RESET_S  27
/* SENS_COCPU_RESET:R/W；位位置：[25]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_RESET    (BIT(25))
#define SENS_COCPU_RESET_M  (BIT(25))
#define SENS_COCPU_RESET_V  0x1
#define SENS_COCPU_RESET_S  25

#define SENS_SAR_COCPU_INT_ENA_W1TS_REG          (DR_REG_SENS_BASE + 0x10C)
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TS:WO；位位置：[11]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TS    (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TS_M  (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TS_S  11
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS:WO；位位置：[10]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS    (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS_M  (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TS_S  10
/* SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TS:WO；位位置：[9]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TS    (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TS_M  (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TS_S  9
/* SENS_COCPU_SWD_INT_ENA_W1TS:WO；位位置：[8]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SWD_INT_ENA_W1TS    (BIT(8))
#define SENS_COCPU_SWD_INT_ENA_W1TS_M  (BIT(8))
#define SENS_COCPU_SWD_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_SWD_INT_ENA_W1TS_S  8
/* SENS_COCPU_SW_INT_ENA_W1TS:WO；位位置：[7]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SW_INT_ENA_W1TS    (BIT(7))
#define SENS_COCPU_SW_INT_ENA_W1TS_M  (BIT(7))
#define SENS_COCPU_SW_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_SW_INT_ENA_W1TS_S  7
/* SENS_COCPU_START_INT_ENA_W1TS:WO；位位置：[6]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_START_INT_ENA_W1TS    (BIT(6))
#define SENS_COCPU_START_INT_ENA_W1TS_M  (BIT(6))
#define SENS_COCPU_START_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_START_INT_ENA_W1TS_S  6
/* SENS_COCPU_SENS_INT_ENA_W1TS:WO；位位置：[5]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TSENS_INT_ENA_W1TS    (BIT(5))
#define SENS_COCPU_TSENS_INT_ENA_W1TS_M  (BIT(5))
#define SENS_COCPU_TSENS_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_TSENS_INT_ENA_W1TS_S  5
/* SENS_COCPU_SARADC2_INT_ENA_W1TS:WO；位位置：[4]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC2_INT_ENA_W1TS    (BIT(4))
#define SENS_COCPU_SARADC2_INT_ENA_W1TS_M  (BIT(4))
#define SENS_COCPU_SARADC2_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_SARADC2_INT_ENA_W1TS_S  4
/* SENS_COCPU_SARADC1_INT_ENA_W1TS:WO；位位置：[3]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC1_INT_ENA_W1TS    (BIT(3))
#define SENS_COCPU_SARADC1_INT_ENA_W1TS_M  (BIT(3))
#define SENS_COCPU_SARADC1_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_SARADC1_INT_ENA_W1TS_S  3
/* SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TS:WO；位位置：[2]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TS    (BIT(2))
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TS_M  (BIT(2))
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TS_S  2
/* SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TS:WO；位位置：[1]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TS    (BIT(1))
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TS_M  (BIT(1))
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TS_S  1
/* SENS_COCPU_TOUCH_DONE_INT_ENA_W1TS:WO；位位置：[0]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_DONE_INT_ENA_W1TS    (BIT(0))
#define SENS_COCPU_TOUCH_DONE_INT_ENA_W1TS_M  (BIT(0))
#define SENS_COCPU_TOUCH_DONE_INT_ENA_W1TS_V  0x1
#define SENS_COCPU_TOUCH_DONE_INT_ENA_W1TS_S  0

#define SENS_SAR_COCPU_INT_ENA_W1TC_REG          (DR_REG_SENS_BASE + 0x110)
/* SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TC:WO；位位置：[11]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TC    (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TC_M  (BIT(11))
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_TOUCH_SCAN_DONE_INT_ENA_W1TC_S  11
/* SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC:WO；位位置：[10]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC    (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC_M  (BIT(10))
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_TOUCH_APPROACH_LOOP_DONE_INT_ENA_W1TC_S  10
/* SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TC:WO；位位置：[9]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TC    (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TC_M  (BIT(9))
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_TOUCH_TIMEOUT_INT_ENA_W1TC_S  9
/* SENS_COCPU_SWD_INT_ENA_W1TC:WO；位位置：[8]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SWD_INT_ENA_W1TC    (BIT(8))
#define SENS_COCPU_SWD_INT_ENA_W1TC_M  (BIT(8))
#define SENS_COCPU_SWD_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_SWD_INT_ENA_W1TC_S  8
/* SENS_COCPU_SW_INT_ENA_W1TC:WO；位位置：[7]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SW_INT_ENA_W1TC    (BIT(7))
#define SENS_COCPU_SW_INT_ENA_W1TC_M  (BIT(7))
#define SENS_COCPU_SW_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_SW_INT_ENA_W1TC_S  7
/* SENS_COCPU_START_INT_ENA_W1TC:WO；位位置：[6]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_START_INT_ENA_W1TC    (BIT(6))
#define SENS_COCPU_START_INT_ENA_W1TC_M  (BIT(6))
#define SENS_COCPU_START_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_START_INT_ENA_W1TC_S  6
/* SENS_COCPU_SENS_INT_ENA_W1TC:WO；位位置：[5]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TSENS_INT_ENA_W1TC    (BIT(5))
#define SENS_COCPU_TSENS_INT_ENA_W1TC_M  (BIT(5))
#define SENS_COCPU_TSENS_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_TSENS_INT_ENA_W1TC_S  5
/* SENS_COCPU_SARADC2_INT_ENA_W1TC:WO；位位置：[4]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC2_INT_ENA_W1TC    (BIT(4))
#define SENS_COCPU_SARADC2_INT_ENA_W1TC_M  (BIT(4))
#define SENS_COCPU_SARADC2_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_SARADC2_INT_ENA_W1TC_S  4
/* SENS_COCPU_SARADC1_INT_ENA_W1TC:WO；位位置：[3]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_SARADC1_INT_ENA_W1TC    (BIT(3))
#define SENS_COCPU_SARADC1_INT_ENA_W1TC_M  (BIT(3))
#define SENS_COCPU_SARADC1_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_SARADC1_INT_ENA_W1TC_S  3
/* SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TC:WO；位位置：[2]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TC    (BIT(2))
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TC_M  (BIT(2))
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_TOUCH_ACTIVE_INT_ENA_W1TC_S  2
/* SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TC:WO；位位置：[1]；默认值：1’b0；*/
/*描述：。*/
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TC    (BIT(1))
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TC_M  (BIT(1))
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TC_V  0x1
#define SENS_COCPU_TOUCH_INACTIVE_INT_ENA_W1TC_S  1
/* SENS_COCPU_TOUCH_DONE_INT_ENA_W1TC:WO；位位置：[0]；默认值：1’b0；*/
/*描述：。*/
...
/* SENS_DEBUG_BIT_SEL:R/W；位位置：[4:0]；默认值：5’b0；*/
/*描述：。*/
...
#define SENS_DEBUG_BIT_SEL_S  0

#define SENS_SARDATE_REG          (DR_REG_SENS_BASE + 0x1FC)
/* SENS_SAR_DATE:R/W；位位置：[27:0]；默认值：28'h2101180；*/
/*描述：。*/
