...
typedef volatile struct rtc_io_dev_s {
    ...
    union {
        struct {
            ...
            uint32_t slp_sel:            1;             /*1： 在睡眠期间启用睡眠模式0：无睡眠模式*/
    ...
    union {
        struct {
            ...
            uint32_t x32p_slp_sel: 1;                   /*1： 在睡眠期间启用睡眠模式0：无睡眠模式*/
    ...
    union {
        struct {
            ...
            uint32_t x32n_slp_sel: 1;                   /*1： 在睡眠期间启用睡眠模式0：无睡眠模式*/
    ...
    union {
        struct {
            ...
            uint32_t rtc_pad19_slp_sel: 1;              /*1： 在睡眠期间启用睡眠模式0：无睡眠模式*/
    ...
    union {
        struct {
            ...
            uint32_t rtc_pad20_slp_sel: 1;              /*1： 在睡眠期间启用睡眠模式0：无睡眠模式*/
    ...
    union {
        struct {
            ...
            uint32_t rtc_pad21_slp_sel: 1;              /*1： 在睡眠期间启用睡眠模式0：无睡眠模式*/
