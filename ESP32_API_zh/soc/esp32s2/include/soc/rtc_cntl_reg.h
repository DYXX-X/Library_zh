...
/* RTC_CNTL_DG_DCDC_power_TIMER:R/W；位位置：[31:25]；默认值：7'h8；*/
/*说明：*/
...
/* RTC_CNTL_DG_DCDC_WAIT_TIMER:R/W；比特位置：[24:16]；默认值：9'h20；*/
/*说明：*/
...
/* RTC_CNTL_SAR_I2C_FORCE_PU:R/W；位位置：[22]；默认值：1’b0；*/
/*描述：PLLA强制加电*/
...
/* RTC_CNTL_SAR_I2C_FORCE_PD:R/W；位位置：[21]；默认值：1’b1；*/
/*描述：PLLA强制断电*/
...
/*description:XTAL_32K选择。0：外部XTAL_32K 1：来自RTC焊盘X32P_C的CLK*/
...
/* RTC_CNTL_SLEEP_project_ENA:R/W；比特位置：[29:13]；默认值：16'd0；*/
/*描述：睡眠拒绝启用*/
...
#define RTC_CNTL_CK8M_DFREQ_DEFAULT 172 //TODO可能会在芯片7.2.3中发生变化
...
/*描述：用于同步reg_ck8m_div_sel总线。在设置reg_ck8m_div_sel之前清除vld，然后设置vld以实际切换clk*/
...
/*description:用于同步div总线。在设置reg_rtc_ana_clk_div之前清除vld，然后设置vld以实际切换clk*/
...
/*描述：将电阻从ldo输出端接地。0：无分辨率1:6k 2:4k 3:2k*/
...
/*description:Tieh=1模式驱动能力。最初设置为0，以限制充电电流设置为3。*/
...
/* RTC_CNTL_DG_DCDC_PD_EN:R/W；位位置：[23]；默认值：0；*/
/*描述：在休眠状态下启用断电数字dcdc*/
...
/* RTC_CNTL_DG_DCDC_FORCE_PU:R/W；位位置：[22]；默认值：1'd1；*/
/*描述：数字dcdc强制加电*/
...
/* RTC_CNTL_DG_DCDC_FORCE_PD:R/W；位位置：[21]；默认值：1’b0；*/
/*描述：数字dcdc强制断电*/
...
/* RTC_CNTL_BROWN_OUT_INT_WAIT:R/W；比特位置：[13:4]；默认值：10'hff；*/
/*描述：棕色中断等待周期*/
...
/* RTC_CNTL_BROWN_OUT2_ENA:R/W；位位置：[0]；默认值：1’b1；*/
/*描述：启用brown_out2启动芯片重置*/
...
/*description:如果在这段时间内没有检测到时钟32k，则视为无效*/
...
/*description:1:TOUCH_START&TOUCH_XPD由触摸fsm控制*/
...
/*description:去噪分辨率：12/10/8/4 bit*/
...
/* RTC_CNTL拒绝原因：RO；位位置：[16:0]；默认值：17'd0；*/
/*description:睡眠拒绝原因*/
...
/* RTC_CNTL_CNTL_DATE:R/W；位位置：[27:0]；默认值：28'h1908130；*/
/*说明：*/
