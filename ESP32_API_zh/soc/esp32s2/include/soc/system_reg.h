...
/* DPORT_ROM_FO:R/W；位位置：[1:0]；默认值：~2'b0；*/
/*说明：*/
...
/* DPORT_ROM_FORCE_PU:R/W；位位置：[3:2]；默认值：2'b11；*/
/*说明：*/
...
/* DPORT_ROM_FORCE_PD:R/W；位位置：[1:0]；默认值：2’b0；*/
/*说明：*/
...
/* DPORT_SRAM_FO:R/W；比特位置：[21:0]；默认值：~22’b0；*/
/*说明：*/
...
/* DPORT_SRAM_FORCE_PD:R/W；比特位置：[21:0]；默认值：22'b0；*/
/*说明：*/
...
/* DPORT_CLK_EN_DEDICATED_GPIO:R/W；位位置：[7]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_CLK_EN_ASSIST_DEBUG：R/W；位位置：[6]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_RST_EN_DEDICATED_GPIO:R/W；位位置：[7]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_RST_EN_ASSIST_DEBUG：R/W；位位置：[6]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CPU_WAITI_DELAY_NUM:R/W；位位置：[7:4]；默认值：4'0；*/
/*说明：*/
...
/* DPORT_CPU_WAIT_MODE_FORCE_ON:R/W；位位置：[3]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_PLL_FREQ_SEL:R/W；位位置：[2]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_0:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_1:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_2:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_3:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_4:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_5:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_6:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_CANCEL_EFUSE_DISABLE_JTAG_TEMPORARY_7:WOR；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_ADC2_ARB_CLK_EN:R/W；位位置：[30]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_SYSTIMER_CLK_EN:R/W；位位置：[29]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_APB_SARADC_CLK_EN:R/W；位位置：[28]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_SPI3_DMA_CLK_EN:R/W；位位置：[27]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_PWM3_CLK_EN:R/W；位位置：[26]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_PWM2_CLK_EN:R/W；位位置：[25]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_UART_MEM_CLK_EN:R/W；位位置：[24]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_I2S1_CLK_EN:R/W；位位置：[21]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_PWM1_CLK_EN:R/W；位位置：[20]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_TWAI_CLK_EN:R/W；位位置：[19]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_I2C_EXT1_CLK_EN:R/W；位位置：[18]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_PWM0_CLK_EN:R/W；位位置：[17]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_SPI3_CLK_EN:R/W；位位置：[16]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_TIMERGROUP1_CLK_EN:R/W；位位置：[15]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_EFUSE_CLK_EN:R/W；位位置：[14]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_TIMERGROUP_CLK_EN:R/W；位位置：[13]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_UHCI1_CLK_EN:R/W；位位置：[12]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_LEDC_CLK_EN:R/W；位位置：[11]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_PCNT_CLK_EN:R/W；位位置：[10]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_I2C_EXT0_CLK_EN:R/W；位位置：[7]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_TIMERS_CLK_EN:R/W；位位置：[0]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CRYPTO_DMA_CLK_EN:R/W；位位置：[6]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_CRYPTO_HMAC_CLK_EN:R/W；位位置：[5]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_CRYPTO_DS_CLK_EN:R/W；位位置：[4]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_CRYPTO_RSA_CLK_EN:R/W；位位置：[3]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_CRYPTO_SHA_CLK_EN:R/W；位位置：[2]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_CRYPTO_AES_CLK_EN:R/W；位位置：[1]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_ADC2_ARB_RST:R/W；位位置：[30]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_SYSTIMER_RST:R/W；位位置：[29]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_APB_SARADC_RST:R/W；位位置：[28]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_SPI3_DMA_RST:R/W；位位置：[27]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_CRYPTO_DMA_RST:R/W；位位置：[6]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CRYPTO_HMAC_RST:R/W；位位置：[5]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CRYPTO_DS_RST:R/W；位位置：[4]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CRYPTO_RSA_RST:R/W；位位置：[3]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CRYPTO_SHA_RST:R/W；位位置：[2]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_CRYPTO_AES_RST:R/W；位位置：[1]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_LPCLK_RTC_EN:R/W；位位置：[28]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_RSA_MEM_FORCE_PD:R/W；位位置：[2]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_RSA_MEM_FORCE_PU:R/W；位位置：[1]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_RSA_MEM_PD:R/W；位位置：[0]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_bustomextmem_ENA:R/W；位位置：[0]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_PRO_che_RESET:R/W；位位置：[2]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_PRO_DCACHE_CLK_ON:R/W；位位置：[1]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_PRO_cache_CLK_ON:R/W；位位置：[0]；默认值：1’b1；*/
/*说明：*/
...
/* DPORT_ENABLE_DOWNLOAD_MANUAL_ENCRYPT:R/W；位位置：[3]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_ENABLE_DOWNLOAD_G0CB_DECRYPT:R/W；位位置：[2]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_ENABLE_DOWNLOAD_DB_ENCRYPT：R/W；位位置：[1]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_ENABLE_SPI_MANUAL_ENCRYPT:R/W；位位置：[0]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_RTC_MEM_CRC_FINISH:RO；位位置：[31]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_RTC_MEM_CRC_LEN:R/W；位位置：[30:20]；默认值：11'7ff；*/
/*说明：*/
...
/* DPORT_RTC_MEM_CRC_ADDR:R/W；比特位置：[19:9]；默认值：11'0；*/
/*说明：*/
...
/* DPORT_RTC_MEM_CRC_START:R/W；位位置：[8]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_RTC_MEM_CRC_RES:RO；位位置：[31:0]；默认值：32'b0；*/
/*说明：*/
...
/* DPORT_REDUNDANT_ecoresult:RO；位位置：[1]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_REDUNDANT_ECO-DRIVE:R/W；位位置：[0]；默认值：1’b0；*/
/*说明：*/
...
/* DPORT_SRAM_FORCE_PU:R/W；比特位置：[21:0]；默认值：22'h3ffff；*/
/*说明：*/
...
/* DPORT_SOC_CLK_SEL:R/W；比特位置：[11:10]；默认值：2'd0；*/
/*说明：*/
...
/* DPORT_PRE_DIV_CNT：R/W；位位置：[9:0]；默认值：10'h1；*/
/*说明：*/
...
/* 系统日期：R/W；位位置：[27:0]；默认值：28'h11908020；*/
/*说明：*/
