/* 此文件是为Doxygen自动文档生成而准备的。*/
/*! \文件ndis。小时***************************************************************
 *
 * \brief此文件包含USB可能的外部配置。
 *
 * \添加组usbstick
 *
 *
...
/**
 \inggroup usbstick\defgroup RNDIS RNDIS支持
 @{
 */
 ...
 * ndis公司。小时
 * 
 * Modified by Colin O'Flynn <coflynn@newae.com> ntddndis。h由Benedikt Spranger修改<b.spranger@pengutronix.de>
 * 
 * 感谢cygwin开发团队，特别是Casper S.Hornstop<chorns@users.sourceforge.net>
 * 
 * THIS SOFTWARE IS NOT COPYRIGHTED
 *
 * 此源代码提供用于公共领域。您可以自由使用、修改或分发。
 *
 * 分发此代码是希望它有用，但没有任何保证。特此放弃所有明示或暗示的保证。这包括但不限于对适销性或特定用途适用性的保证。
 *
 */
...
/* 来自drivers/net/sk98lin/h/skgepnmi。小时*/
...
/*
结构NDIS_PNP_CAPABILITIES｛__le32标志；结构NDIS_PM_WAKE_UP_CAPABILITIES唤醒能力；｝；

结构NDIS_PM_PACKET_PARTTERN｛__le32优先级；__le32保留；__le32MaskSize；__le32-PatternOffset；__le32.PatternSize；__le32-PatternFlags；｝；
*/
