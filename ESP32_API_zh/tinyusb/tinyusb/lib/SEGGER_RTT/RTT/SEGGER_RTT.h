...
*                                                                    *
**********************************************************************
---------------------------标题结束------------------------------文件：SEGGER_RTT。h目的：实现SEGGER实时传输，允许在CPU运行时在支持调试器内存访问的目标上进行实时通信。版本：$Rev:17697$
----------------------------------------------------------------------
*/
...
*/
#ifndef RTT_USE_ASM
  #if (defined __SES_ARM)                       // SEGGER嵌入式工作室
    #define _CC_HAS_RTT_ASM_SUPPORT 1
  #elif (defined __CROSSWORKS_ARM)              // 罗利交叉路口
    #define _CC_HAS_RTT_ASM_SUPPORT 1
  #elif (defined __GNUC__)                      // GCC
    #define _CC_HAS_RTT_ASM_SUPPORT 1
  #elif (defined __clang__)                     // Clang编译器
    #define _CC_HAS_RTT_ASM_SUPPORT 1
  #elif (defined __IASMARM__)                   // IAR汇编程序
    #define _CC_HAS_RTT_ASM_SUPPORT 1
