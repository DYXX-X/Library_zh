...
/**
  ...
  */
  ...
  #define EXTERNAL_CLOCK_VALUE       12288000U        /*!< 内部振荡器的值（Hz）*/
...
#define ETH_RXBUFNB                       5U       /* 5个大小为ETH_Rx_BUF_size的Rx缓冲区*/
#define ETH_TXBUFNB                       5U       /* 5个大小为ETH_Tx_BUF_size的Tx缓冲区*/
