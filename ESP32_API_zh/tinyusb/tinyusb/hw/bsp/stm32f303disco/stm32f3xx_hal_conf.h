...
/* #定义HAL_PWR_MODULE_ENABLED*/
#define HAL_RCC_MODULE_ENABLED 
/* #定义HAL_RTC_MODULE_ENABLED*/
/* #定义HAL_SDADC_MODULE_ENABLED*/
...
/**
  ...
  *        -通过EVAL 303上的外部PLL组件生成的外部时钟（基于MCO或晶体）
  *        -EVAL 373上未生成外部时钟
  */
#if !defined  (EXTERNAL_CLOCK_VALUE)
  #define EXTERNAL_CLOCK_VALUE    (8000000U) /*!< 外部振荡器的值（Hz）*/
...
#define  USE_HAL_SDADC_REGISTER_CALLBACKS       0U /* SDADC寄存器回调已禁用*/
...
#define  USE_HAL_OPAMP_REGISTER_CALLBACKS       0U /* OPAMP寄存器回调已禁用*/
...
#endif /* __STM32F33xx_HAL_CONF_H钢*/
