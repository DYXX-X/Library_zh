...
/** 易失性密钥标识符的范围。
 *
 *  密钥标识符的实现范围的最后#MBEDTLS_PSA_KEY_SLOT_COUNT标识符为易失性密钥标识符保留。易失密钥标识符等于#PSA_key_ID_volatile_MIN加上包含易失密钥定义的密钥槽的索引。
 */
 ...
 *
 * \retval#PSA_SUCCESS\retval#PSTA_ERROR_NOT_SUPPORTED密钥是持久的，但不支持持久密钥。
 */
