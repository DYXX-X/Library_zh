...
/* 如果请求的任何块模式没有关联的硬件辅助，请定义PSA_have_SOFT_block_MODE以检查块密码密钥类型。*/
...
/* 如果选择了任何软件块密码，请定义PSA_HAVE_SOFT_block_CIPHER，该密码可用于任何这些情况。*/
#if defined(PSA_HAVE_SOFT_KEY_TYPE_AES) || \
...
/*
 * Curve448尚未通过Mbed TLS中的PSA API得到支持(https://github.com/ARMmbed/mbedtls/issues/4249).
 */
...
/*
 * SECP224K1通过Mbed TLS中的PSA API存在漏洞(https://github.com/ARMmbed/mbedtls/issues/3541).
 */
...
/* 尚未通过PSA API支持Curve448(https://github.com/ARMmbed/mbedtls/issues/4249) */
...
/* SECP224K1通过PSA API存在漏洞(https://github.com/ARMmbed/mbedtls/issues/3541) */
