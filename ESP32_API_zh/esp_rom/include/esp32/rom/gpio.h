...
/**
  ...
  *
  * @param uint32_t gpio:gpio编号，0~0x27 gpio==0x30，输入0到信号gpio==0x34？？？gpio==0x38，信号输入1
  *
...
/**
  ...
  *
  * @param uint32_t gpio:gpio编号，0~0x27
  *
  * @param uint32_t signal_idx：信号索引。signal_idx==0x100，取消输入gpio的输出
  *
  * @param bool out_inv：信号输出是否为inv
  *
  * @param bool oen_inv：信号输出使能是否为inv
  *
  * @return 没有一个
  */
...
/**
  ...
  *
  * @param uint32_t gpio_num:gpio编号，0~0x27
  *
  * @return 没有一个
  */
