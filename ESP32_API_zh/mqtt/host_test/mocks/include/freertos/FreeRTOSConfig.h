/*
    FreeRTOS V8.2.0-版权所有（C）2015 Real Time Engineers Ltd.保留所有权利
...
#define configMINIMAL_STACK_SIZE ((unsigned short)256) /* 如果需要，可以将其缩小。*/
...
#define configCHECK_FOR_STACK_OVERFLOW 0 /* 请勿在PC端口上使用此选项。*/
...
#define INCLUDE_uxTaskGetStackHighWaterMark 0 /* 请勿在PC端口上使用此选项。*/

/* 本演示使用了一个或多个示例统计数据格式化函数。以上将uxTaskGetSystemState（）函数提供的原始数据转换为可读的ASCII格式。请参阅在FreeRTOS/Source/tasks中实现vTaskList（）的注释。c限制。*/
