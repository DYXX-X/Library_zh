...
// md5_摘要表614c862c2cfa8ccda3a79183ce767255
// 此文件是从文件esp_efuse_table.csv生成的。不要手动更改此文件。
// 如果要更改某些字段，则需要更改esp_efuse_table。csv文件
// 然后运行“efusecommontable”或“efusecustom_table”命令，它将生成此文件。
// 要显示efuse_table，请运行命令“show_efuse_table”。
