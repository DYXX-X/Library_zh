...
/**
  ...
  * @param hw 外围GPIO硬件实例地址。
  * @param gpio_num GPIO编号
  * @return 如果GPIO GPIO_num的FUN_PU为真
  */
...
/**
  ...
  * @param hw 外围GPIO硬件实例地址。
  * @param gpio_num GPIO编号
  * @return 如果GPIO GPIO_num的FUN_PD为真
  */
...
/**
  ...
  * @param hw 外围GPIO硬件实例地址。
  * @param gpio_num GPIO编号
  * @return 如果GPIO GPIO_num的SLP_SEL为真
  */
...
/**
  * @brief 返回GPIO上的slp上拉状态。
  *
  * @param hw 外围GPIO硬件实例地址。
  * @param gpio_num GPIO编号
  * @return 如果GPIO GPIO_num的SLP_PU为真
  */
...
/**
  * @brief 返回GPIO上的slp下拉状态。
  *
  * @param hw 外围GPIO硬件实例地址。
  * @param gpio_num GPIO编号
  * @return 如果GPIO GPIO_num的SLP_PD为真
  */
...
{
    if (core_id == 0) {
        hw->pin[gpio_num].int_ena = GPIO_LL_PRO_CPU_INTR_ENA;     //启用pro cpu intr
    } else {
        hw->pin[gpio_num].int_ena = GPIO_LL_APP_CPU_INTR_ENA;     //启用pro cpu intr
    }
}
