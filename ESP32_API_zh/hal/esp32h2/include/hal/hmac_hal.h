 ...
 *
 * @param config HMAC的目标。可能的目标在\chmac_hal_output_t中描述。有关详细信息，请参阅ESP32H2 TRM。
 ...
 *
 * 消息长度不得超过一个块（512位），并且在写入之前必须由软件应用填充。填充必须能够适应消息后面的块。有关HMAC填充的更多信息，请参阅ESP32H2 TRM。
 */
