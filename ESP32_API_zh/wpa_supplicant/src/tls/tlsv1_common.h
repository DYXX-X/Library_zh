/*
 * TLSv1通用定义版权所有（c）2006-2011，Jouni Malinen<j@w1.fi>
 *
...
#define TLS_VERSION_1 0x0301 /* TLSv1型*/
...
#define TLS_EXT_PAC_OPAQUE TLS_EXT_SESSION_TICKET /* EAP-FAST术语*/
