/*
 * hostapd和wpa_supplicant之间共享的DPP功能版权所有（c）2017，Qualcomm Atheros，Inc.版权所有（c）2018-2019，The Linux Foundation
 *
...
#define DPP_HDR_LEN (4 + 2) /* OUI、OUI类型、加密套件、DPP帧类型*/
...
struct dpp_bootstrap_info {
	...
	unsigned int pkex_t; /* dpp_pkex实例化之前的失败数*/
};
...
struct dpp_authentication {
	...
	const struct wpabuf *conf_resp; /* 由GAS服务器拥有*/
	...
	struct dpp_config_obj {
		char *connector; /* 已收到signedConnect*/
