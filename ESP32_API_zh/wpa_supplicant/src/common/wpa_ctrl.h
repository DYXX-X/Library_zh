/*
 * wpa_suppliant/hostapd控制接口库版权所有（c）2004-2006，Jouni Malinen<j@w1.fi>
 *
...
/**添加了一个新的BSS条目（后跟BSS条目id和BSSID）*/
#define WPA_EVENT_BSS_ADDED "CTRL-EVENT-BSS-ADDED "
/**已删除BSS条目（后跟BSS条目id和BSSID）*/
...
/**与指定对等方完成RSN IBSS 4路握手*/
#define IBSS_RSN_COMPLETED "IBSS-RSN-COMPLETED "

/**在PBC模式下检测到WPS重叠*/
#define WPS_EVENT_OVERLAP "WPS-OVERLAP-DETECTED "
/**扫描结果中发现具有活动PBC的可用WPS AP*/
#define WPS_EVENT_AP_AVAILABLE_PBC "WPS-AP-AVAILABLE-PBC "
/**扫描结果中授权的可用WPS AP地址*/
#define WPS_EVENT_AP_AVAILABLE_AUTH "WPS-AP-AVAILABLE-AUTH "
/** 在扫描结果中找到最近选择的PIN注册器的可用WPS AP
 */
...
/* 参数：＜freq＞＜src addr＞＜dialog token＞＜update indicator＞＜TLV＞*/
#define P2P_EVENT_SERV_DISC_REQ "P2P-SERV-DISC-REQ "
/* 参数：＜src addr＞＜update indicator＞＜TLV＞*/
...
/* 参数：＜PMF enabled＞＜timeout in ms＞＜Session Information URL＞*/
