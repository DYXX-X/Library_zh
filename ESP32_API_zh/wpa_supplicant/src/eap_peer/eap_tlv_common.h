/*
 * EAP-TLV定义（draft-josefsson-pppext-EAP-tls-EAP-10.txt）版权所有（c）2004-2008，Jouni Malinen<j@w1.fi>
 *
...
/* EAP-TLV TLV（draft-josefsson-ppext-EAP-tls-EAP-10.txt）*/
#define EAP_TLV_RESULT_TLV 3 /* 已确认结果*/
...
#define EAP_TLV_PAC_TLV 11 /* RFC 5422，第4.2节*/
