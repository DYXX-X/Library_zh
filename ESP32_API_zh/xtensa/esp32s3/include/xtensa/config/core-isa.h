...
/* Xtensa处理器核心配置信息。
   ...
   客户ID=15128；内部版本=0x90f1f；版权所有（c）1999-221 Tensilica Inc。
...
#define XCHAL_MAX_INSTRUCTION_SIZE	4	/* 最大instr字节（3..8）*/
...
#define XCHAL_HAVE_EXCLUSIVE            0	/* L32EX/S32EX说明*/
...
#define XCHAL_HAVE_HIFI5		0	/* HiFi5音频引擎软件包*/
#define XCHAL_HAVE_HIFI5_NN_MAC		0	/* HiFi5音频引擎NN-MAC选项*/
#define XCHAL_HAVE_HIFI5_VFPU		0	/* HiFi5音频引擎单精度VFPU选项*/
#define XCHAL_HAVE_HIFI5_HP_VFPU	0	/* HiFi5音频引擎半精度VFPU选项*/
...
#define XCHAL_HAVE_HIFI3Z		0	/* HiFi3Z音频引擎pkg*/
#define XCHAL_HAVE_HIFI3Z_VFPU	0	/* HiFi3Z音频引擎VFPU选项*/
...
#define XCHAL_HAVE_VECTORFPU2005	0	/* 矢量浮点pkg*/
#define XCHAL_HAVE_USER_DPFPU		0       /* 用户DP浮点pkg*/
#define XCHAL_HAVE_USER_SPFPU		0       /* 用户SP浮点pkg*/
...
#define XCHAL_HAVE_DFP_ACCEL		0	/* 双精度FP加速度pkg*/
...
#define XCHAL_HAVE_FUSIONG		0    /* 融合G*/
#define XCHAL_HAVE_FUSIONG3		0    /* 融合G3*/
#define XCHAL_HAVE_FUSIONG6		0    /* 融合G6*/
#define XCHAL_HAVE_FUSIONG_SP_VFPU	0    /* FusionG上的sp_vfpu选项*/
#define XCHAL_HAVE_FUSIONG_DP_VFPU	0    /* FusionG上的dp_vfpu选项*/
#define XCHAL_FUSIONG_SIMD32		0    /* FusionG的simd32*/

#define XCHAL_HAVE_PDX			0    /* PDX */
#define XCHAL_PDX_SIMD32		0    /* PDX的simd32*/
...
#define XCHAL_HAVE_BBENEP_SP_VFPU	0      /* BBE-EP上的sp_vfpu选项*/
...
#define XCHAL_HAVE_GRIVPEP		0	/* IVPEP的一般发布*/
#define XCHAL_HAVE_GRIVPEP_HISTOGRAM	0       /* GRIVPEP上的直方图选项*/

#define XCHAL_HAVE_VISION	        0     /* 愿景P5/P6*/
#define XCHAL_VISION_SIMD16             0     /* 视觉P5/P6的simd16*/
#define XCHAL_VISION_TYPE               0     /* 愿景P5、P6或P3*/
#define XCHAL_VISION_QUAD_MAC_TYPE      0     /* Vision P6上的quad_mac选项*/
#define XCHAL_HAVE_VISION_HISTOGRAM     0     /* Vision P5/P6上的直方图选项*/
#define XCHAL_HAVE_VISION_SP_VFPU       0     /* Vision P5/P6上的sp_vfpu选项*/
#define XCHAL_HAVE_VISION_HP_VFPU       0     /* Vision P6上的hp_vfpu选项*/

#define XCHAL_HAVE_VISIONC	        0     /* 愿景C*/
...
#define XCHAL_DATA_WIDTH		16	/* 数据宽度（字节）*/
#define XCHAL_DATA_PIPE_DELAY		1	/* d侧管道延迟（1=5级，2=7级）*/
...
#define XCHAL_SW_VERSION		1200012	/* 此标头的sw版本*/

#define XCHAL_CORE_ID			"LX7_ESP32_S3_MP"	/* Xtensa处理器生成器中设置的字母数字核心名称（CoreID）*/

#define XCHAL_BUILD_UNIQUE_ID		0x00090F1F	/* 22位软件版本ID*/

/*
 *  这些定义描述了该软件的目标硬件。
 */
#define XCHAL_HW_CONFIGID0		0xC2F0FFFE	/* ConfigID高32位*/
#define XCHAL_HW_CONFIGID1		0x23090F1F	/* ConfigID低32位*/
#define XCHAL_HW_VERSION_NAME		"LX7.0.12"	/* 完整版本名称*/
#define XCHAL_HW_VERSION_MAJOR		2700	/* 目标硬件的主要版本号*/
#define XCHAL_HW_VERSION_MINOR		12	/* 目标硬件的次要版本号*/
#define XCHAL_HW_VERSION		270012	/* 大调*100+小调*/
#define XCHAL_HW_REL_LX7		1
#define XCHAL_HW_REL_LX7_0		1
#define XCHAL_HW_REL_LX7_0_12		1
#define XCHAL_HW_CONFIGID_RELIABLE	1
/*  如果软件以硬件版本的*范围*为目标，则以下为界限：*/
#define XCHAL_HW_MIN_VERSION_MAJOR	2700	/* 最早tgt硬件的主要v*/
#define XCHAL_HW_MIN_VERSION_MINOR	12	/* 最早tgt hw的小调v*/
#define XCHAL_HW_MIN_VERSION		270012	/* 最早的目标硬件*/
#define XCHAL_HW_MAX_VERSION_MAJOR	2700	/* 最新tgt硬件的主要版本*/
#define XCHAL_HW_MAX_VERSION_MINOR	12	/* 最新tgt硬件的次要版本*/
#define XCHAL_HW_MAX_VERSION		270012	/* 最新目标硬件*/
...
#define XCHAL_DCACHE_LINESIZE		16	/* D缓存行大小（字节）*/
#define XCHAL_ICACHE_LINEWIDTH		2	/* log2（I行大小，字节）*/
#define XCHAL_DCACHE_LINEWIDTH		4	/* log2（D行大小，字节）*/
...
#define XCHAL_HAVE_PIF			1	/* 有没有出站巴士*/

#define XCHAL_HAVE_AXI			0	/* AXI总线*/
#define XCHAL_HAVE_AXI_ECC		0	/* AXI总线上的ECC*/
#define XCHAL_HAVE_ACELITE		0	/* ACELite总线*/

#define XCHAL_HAVE_PIF_WR_RESP			0	/* pif写入响应*/
#define XCHAL_HAVE_PIF_REQ_ATTR			1	/* pif属性*/
...
内部I/O RAM/ROM和XLMI
  ----------------------------------------------------------------------*/
#define XCHAL_NUM_INSTROM		0	/* 核心指令ROM的数量*/
#define XCHAL_NUM_INSTRAM		1	/* 核心指令RAM的数量*/
#define XCHAL_NUM_DATAROM		0	/* 核心数据ROM的数量*/
#define XCHAL_NUM_DATARAM		1	/* 核心数据RAM的数量*/
#define XCHAL_NUM_URAM			0	/* 核心统一RAM的数量*/
#define XCHAL_NUM_XLMI			0	/* 核心XLMI端口数*/

/*  指令RAM 0：*/
#define XCHAL_INSTRAM0_VADDR		0x40000000	/* 虚拟地址*/
#define XCHAL_INSTRAM0_PADDR		0x40000000	/* 物理地址*/
#define XCHAL_INSTRAM0_SIZE		67108864	/* 大小（字节）*/
#define XCHAL_INSTRAM0_ECC_PARITY	0	/* ECC/奇偶校验类型，0=无*/
#define XCHAL_HAVE_INSTRAM0		1
#define XCHAL_INSTRAM0_HAVE_IDMA	0	/* 此本地内存支持的idma*/

/*  数据RAM 0：*/
#define XCHAL_DATARAM0_VADDR		0x3C000000	/* 虚拟地址*/
#define XCHAL_DATARAM0_PADDR		0x3C000000	/* 物理地址*/
#define XCHAL_DATARAM0_SIZE		67108864	/* 大小（字节）*/
#define XCHAL_DATARAM0_ECC_PARITY	0	/* ECC/奇偶校验类型，0=无*/
#define XCHAL_DATARAM0_BANKS		1	/* 银行数量*/
#define XCHAL_HAVE_DATARAM0		1
#define XCHAL_DATARAM0_HAVE_IDMA	0	/* 此本地内存支持的idma*/
...
#define XCHAL_HAVE_DEBUG_APB		0	/* APB到调试模块*/
...
#define XCHAL_TRAX_ATB_WIDTH		0	/* ATB宽度（位），0=无ATB*/
...
#define XCHAL_MPU_ALIGN_REQ		1	/* MPU要求将条目与背景地图对齐*/
#define XCHAL_MPU_BACKGROUND_ENTRIES	0	/* bg映射中的条目数*/
#define XCHAL_MPU_BG_CACHEADRDIS	0	/* bg的默认CACHEARDIS*/
