...
/* 此头文件描述了扩展基本Xtensa核心功能的特定Xtensa处理器的TIE扩展。它是根据Xtensa处理器配置定制的。
   ...
   客户ID=11657；内部版本=0x5fe96；版权所有（c）1999-2016 Cadence Design Systems Inc。
...
#define XCHAL_CP_NUM			1	/* 协处理器数量*/
#define XCHAL_CP_MAX			1	/* 最大CP ID+1（如果没有，则为0）*/
#define XCHAL_CP_MASK			0x01	/* 按ID列出的所有CP的位掩码*/
...
#define XCHAL_TOTAL_SA_SIZE		128	/* 带16字节对齐填充*/
