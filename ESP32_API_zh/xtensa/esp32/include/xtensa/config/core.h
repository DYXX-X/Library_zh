...
/*
 * 版权所有（c）2005-2014 Cadence Design Systems，Inc。
 *
...
/* 注意：常量以这种方式定义，以允许movi而不是重置代码中的l32r。*/
#define XCHAL_CACHE_MEMCTL_DEFAULT	0xFFFFFF00	/* 初始化所有可能的方式*/
#else
#define XCHAL_CACHE_MEMCTL_DEFAULT	0x00000000	/* 没什么可做的*/
#endif
...
/*
 * 错误572（发布TBD，但存在于ESP32中）禁用零开销循环缓冲区，以防止在执行零开销循环时出现罕见的非法指令异常。
 */
