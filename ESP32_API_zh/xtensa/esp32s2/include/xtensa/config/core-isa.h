...
/* Xtensa处理器核心配置信息。
   ...
   版权所有（c）1999-2018 Tensilica Inc。
...
#define XCHAL_HAVE_LOOPS		0	/* 零开销环路*/
#define XCHAL_LOOP_BUFFER_SIZE		0	/* 零电压。循环指令缓冲区大小*/
...
#define XCHAL_HAVE_S32C1I		0	/* S32C1I指令*/
...
#define XCHAL_HAVE_FP			0	/* 单预充电浮点*/
#define XCHAL_HAVE_FP_DIV		0	/* 带DIV指令的FP*/
#define XCHAL_HAVE_FP_RECIP		0	/* 带RECIP指令的FP*/
#define XCHAL_HAVE_FP_SQRT		0	/* 带SQRT指令的FP*/
#define XCHAL_HAVE_FP_RSQRT		0	/* 带RSQRT指令的FP*/
...
#define XCHAL_HAVE_DFPU_SINGLE_ONLY	0	/* DFPU协处理器，仅限单精度*/
...
#define XCHAL_CLOCK_GATING_GLOBAL	0	/* 全局时钟门控*/
#define XCHAL_CLOCK_GATING_FUNCUNIT	0	/* 函数。单位时钟门控*/
...
#define XCHAL_SW_VERSION		1200008	/* 此标头的sw版本*/

#define XCHAL_CORE_ID			"test_0731_1_TIE_GPIO_f"	/* Xtensa处理器生成器中设置的字母数字核心名称（CoreID）*/

#define XCHAL_BUILD_UNIQUE_ID		0x00075F76	/* 22位软件版本ID*/

/*
 *  这些定义描述了该软件的目标硬件。
 */
#define XCHAL_HW_CONFIGID0		0xC2ECFAFE	/* ConfigID高32位*/
#define XCHAL_HW_CONFIGID1		0x22075F76	/* ConfigID低32位*/
#define XCHAL_HW_VERSION_NAME		"LX7.0.8"	/* 完整版本名称*/
#define XCHAL_HW_VERSION_MAJOR		2700	/* 目标硬件的主要版本号*/
#define XCHAL_HW_VERSION_MINOR		8	/* 目标硬件的次要版本号*/
#define XCHAL_HW_VERSION		270008	/* 大调*100+小调*/
...
#define XCHAL_HW_MIN_VERSION_MINOR	8	/* 最早tgt hw的小调v*/
#define XCHAL_HW_MIN_VERSION		270008	/* 最早的目标硬件*/
#define XCHAL_HW_MAX_VERSION_MAJOR	2700	/* 最新tgt硬件的主要版本*/
#define XCHAL_HW_MAX_VERSION_MINOR	8	/* 最新tgt硬件的次要版本*/
#define XCHAL_HW_MAX_VERSION		270008	/* 最新目标硬件*/
...
#define XCHAL_INSTRAM1_HAVE_IDMA	0	/* 此本地内存支持的idma*/
...
#define XCHAL_DATARAM1_HAVE_IDMA	0	/* 此本地内存支持的idma*/

/*  XLMI端口0：*/
#define XCHAL_XLMI0_VADDR		0x3FE00000	/* 虚拟地址*/
#define XCHAL_XLMI0_PADDR		0x3FE00000	/* 物理地址*/
#define XCHAL_XLMI0_SIZE		1048576	/* 大小（字节）*/
