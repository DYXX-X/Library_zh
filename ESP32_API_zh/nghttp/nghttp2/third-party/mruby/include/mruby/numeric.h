...
/* ArgumentError，如果格式字符串不匹配/%（\.[0-9]+）？[aAeEfFgG]/*/
#ifndef MRB_WITHOUT_FLOAT
...
/*
//当MRB_INT64被设置//时，由于在其运行时缺少__mulodi4和类似函数，Clang 3.8和3.9在32位模式下编译mruby时遇到问题。我们需要为它们使用自定义//实现。
*/
