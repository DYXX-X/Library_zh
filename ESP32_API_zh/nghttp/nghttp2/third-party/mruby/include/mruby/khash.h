...
/* 声明结构kh_xxx和kh_xxx_funcs

   名称：哈希名称khkey_t：密钥数据类型khval_t：值数据类型kh_is_map：（0：哈希集/1：哈希映射）
*/
...
/* 定义kh_xxx_funcs
   ...
   名称：哈希名称khkey_t：密钥数据类型khval_t：值数据类型kh_is_map：（0：哈希集/1：哈希映射）__hash_func：哈希函数__hash_equal:哈希比较函数
*/
