...
/* ***************************浮点类型****************************在嵌入式世界中，目标根本不支持浮点运算或支持仅限于单精度的情况并不罕见。我们可以随时猜测整数的大小，因为整数总是至少有一种大小。另一方面，浮点有时根本不可用。正在尝试包含`float。这些平台上的“h”将导致错误。这使得手动配置成为唯一的选项。
 **************************************************************************** */
...
/* Unity使用stddef。h头包含在C标准库中，用于“NULL”宏。定义此项以禁用stddef.h的include。如果这样做，则必须确保提供自己的“NULL”定义。
 */
/* #定义UNITY_EXCLUDE_STDDEF_H*/

/* 定义此项以启用统一格式的打印宏：“TEST_PRINTF”
 */
/* #定义UNITY_INCLUDE_PRINT_FORMATED*/
